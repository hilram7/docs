...
![Active Directory Action Module Wizard Set/Reset Users Password page](/images/accessanalyzer/11.6/admin/action/activedirectory/operations/setresetpassword.webp)
