...
![File System Action Module Wizard Add Tags Parameters page](/images/accessanalyzer/11.6/admin/action/filesystem/parameters/addtags.webp)
...
![Boldon James Column on Add Tags Parameters page](/images/accessanalyzer/11.6/admin/action/filesystem/parameters/addremovetagsboldonjames.webp)
