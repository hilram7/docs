...
![New Mailbox Action Wizard Folder Conditions page](/images/accessanalyzer/11.6/admin/action/mailbox/folderconditions.webp)
...
![Folder Type Window](/images/accessanalyzer/11.6/admin/action/mailbox/foldertypewindow.webp)
...
![Folder Inclusion/Exclusion Window](/images/accessanalyzer/11.6/admin/action/mailbox/folderinclusionexclusionwindow.webp)

Include/Exclude folders using the following options:

- Click **Add** to populate a field to add a folder path

    ![New field added on Folder Inclusion/Exclusion window](/images/accessanalyzer/11.6/admin/action/mailbox/folderinclusionexclusionwindownew.webp)
