...
![Drop AWS DC Tables option on Amazon Web Services Data Collector Wizard Category page](/images/accessanalyzer/11.6/admin/datacollector/aws/droptables.webp)
