...
![Query Results window for single agent example](/images/accessanalyzer/11.6/admin/datacollector/fsaa/hostmappingsinglehostsingleagent.webp)

Single-Host Multiple-Agent Example:

![Query Results window for multiple agent example](/images/accessanalyzer/11.6/admin/datacollector/fsaa/hostmappingsinglehostmultipleagent.webp)
