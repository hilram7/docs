...
![FSAA Data Collector Wizard Default Scoping Options page Scan Settings tab](/images/accessanalyzer/11.6/admin/datacollector/fsaa/scansettings.webp)
...
![Action on failure to enable LAT preservation dropdown options](/images/accessanalyzer/11.6/admin/datacollector/fsaa/defaultscopingoptions/actionlatpreservationfailure.webp)
...
![Action on changed LAT after scan dropdown options](/images/accessanalyzer/11.6/admin/datacollector/fsaa/defaultscopingoptions/actionchangedlat.webp)
