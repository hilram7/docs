...
![Query Selection page](/images/accessanalyzer/11.6/admin/datacollector/queryselection.webp)
...
![Libraries window](/images/accessanalyzer/11.6/admin/datacollector/addqueryfromlibrary.webp)
...
![General tab of the Query Properties window](/images/accessanalyzer/11.6/admin/datacollector/querypropertiesgeneral.webp)
...
| ![Data Source tab of Query Properties for new Query](/images/accessanalyzer/11.6/admin/datacollector/querypropertiesdatasourcenew.webp) | ![Data Source tab of Query Properties for existing Query](/images/accessanalyzer/11.6/admin/datacollector/querypropertiesdatasourceexisting.webp) |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| ![Filters tab of Query Properties window](/images/accessanalyzer/11.6/admin/datacollector/querypropertiesdatafilters.webp) | ![Filters tab of Query Properties window with a new filter](/images/accessanalyzer/11.6/admin/datacollector/querypropertiesdatafilterswithfilter.webp) |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
