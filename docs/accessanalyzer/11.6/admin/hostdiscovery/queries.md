...
![Field Chooser option on context menu](/images/accessanalyzer/11.6/admin/hostdiscovery/queriesfieldchooser.webp)

**Step 2 –** Select **Field Chooser**, which opens the Customization window.

![Customization window](/images/accessanalyzer/11.6/admin/hostdiscovery/queriescustomizationwindow.webp)
