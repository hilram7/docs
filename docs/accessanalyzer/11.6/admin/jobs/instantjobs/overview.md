...
![Add Instant Job from context menu](/images/accessanalyzer/11.6/admin/jobs/instantjobs/addinstantjob.webp)
...
![Instant Job Wizard Welcome page](/images/accessanalyzer/11.6/admin/jobs/instantjobs/welcome.webp)

**Step 2 –** On the Welcome page, click **Next**.

![Instant Job page](/images/accessanalyzer/11.6/admin/jobs/instantjobs/instantjob.webp)
...
![Selected Instant Job](/images/accessanalyzer/11.6/admin/jobs/instantjobs/selectinstantjob.webp)
...
![Host Assignment page](/images/accessanalyzer/11.6/admin/jobs/instantjobs/hostassignment.webp)
...
| ![Host Lists page](/images/accessanalyzer/11.6/admin/jobs/instantjobs/hostlists.webp) |     | ![Individual Hosts page](/images/accessanalyzer/11.6/admin/jobs/instantjobs/individualhosts.webp) |
| --------------------------------------------------------------------------------------------------------------------- | --- | --------------------------------------------------------------------------------------------------------------------------------- |
...
![Summary page](/images/accessanalyzer/11.6/admin/jobs/instantjobs/summary.webp)

**Step 7 –** On the Summary page, click **Save & Exit**.

![Instant Solutions installation dialog](/images/accessanalyzer/11.6/admin/jobs/instantjobs/installationcomplete.webp)
