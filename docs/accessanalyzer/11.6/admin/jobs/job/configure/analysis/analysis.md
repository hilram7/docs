...
![Option at the top of the Analysis Section](/images/accessanalyzer/11.6/admin/jobs/job/configure/analysisbuttonstop.webp)
...
- Analysis Properties – Opens the Analysis Properties window for the selected analysis task
    - See the
      [Analysis Properties Page](/docs/accessanalyzer/11.6/admin/analysis/overview.md#analysis-properties-page)
...
![Buttons at the bottom of the Analysis Selection page](/images/accessanalyzer/11.6/admin/jobs/job/configure/analysisbuttonsbottom.webp)
...
![Analysis Selection page right-click menu](/images/accessanalyzer/11.6/admin/jobs/job/configure/analysisrightclickmenu.webp)
