...
description: "Web Services (JWT) for User Credentials"
sidebar_position: 80
---
...
![User Credentials - Web Services (JWT)](/images/accessanalyzer/11.6/admin/settings/connection/profile/webservicesjwt.webp)
