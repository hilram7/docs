...
![Host Discovery page](/images/accessanalyzer/11.6/admin/settings/hostdiscovery.webp)
...
![Log level options](/images/accessanalyzer/11.6/admin/settings/hostdiscoveryloglevels.webp)
