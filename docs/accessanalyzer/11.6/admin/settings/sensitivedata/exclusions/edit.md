...
![Edit Filter on False Positives tab](/images/accessanalyzer/11.6/admin/settings/sensitivedata/exclusions/editfilter.webp)

**Step 1 –** Click **Edit Filter** to open the Edit False Positive Exclusion Filter window.

![Edit False Positive Exclusion Filter window](/images/accessanalyzer/11.6/admin/settings/sensitivedata/exclusions/editexclusionfilterwindow.webp)
