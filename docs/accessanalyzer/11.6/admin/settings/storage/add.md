...
![Add Storage profile option](/images/accessanalyzer/11.6/admin/settings/storage/addprofile.webp)

**Step 1 –** Click **Add Storage profile** at the top of the Storage view.

![New Storage profile added](/images/accessanalyzer/11.6/admin/settings/storage/addprofilename.webp)
...
![Server Name field](/images/accessanalyzer/11.6/admin/settings/storage/addprofileservername.webp)
...
![Command timeout field](/images/accessanalyzer/11.6/admin/settings/storage/addprofiletimeout.webp)
...
![Authentication options](/images/accessanalyzer/11.6/admin/settings/storage/addprofileauthentication.webp)
...
| ![Good connection test](/images/accessanalyzer/11.6/admin/settings/storage/addprofilegoodconnection.webp) | ![Bad connection test](/images/accessanalyzer/11.6/admin/settings/storage/addprofilebadconnection.webp) |
| ----------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
...
![Database options](/images/accessanalyzer/11.6/admin/settings/storage/addprofiledatabase.webp)
...
![Connection report](/images/accessanalyzer/11.6/admin/settings/storage/connectionreport.webp)
