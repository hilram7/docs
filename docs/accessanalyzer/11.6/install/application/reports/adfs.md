...
- On the Configure URL page, do not select any options and click **Next**.
    ...
    ![Identifier added on the Configure Identifiers page](/images/accessanalyzer/11.6/install/application/reports/relyingpartytrustwizardidentifier.webp)
...
![Add an Endpoint window](/images/accessanalyzer/11.6/install/application/reports/addanendpointwindow.webp)
...
- On the Choose Rule Type page of the Add Transform Claim Rule Wizard, select **Send LDAP Attributes
  as Claims** as the Claim rule template. Click **Next**.
    ...
    ![Configure Claim Rule page](/images/accessanalyzer/11.6/install/application/reports/claimrulenameadfsconfig.webp)
...
![Configure Claim Rule SID Properties](/images/accessanalyzer/11.6/install/application/reports/claimrulenamesidproperties.webp)

**Step 6 –** Navigate to the Enterprise Auditor installation directory and open the
`WebServer.exe.config` file in a text editor.

![WebServer.exe.config file in Notepad](/images/accessanalyzer/11.6/install/application/reports/webserverexeconfigadfs.webp)
...
- `WsFederationRealm` – Replace the value text with the URL entered for the Relying Party Trust in
  Step 3:
    ...
    ![URL required for WsFederationRealm attribute](/images/accessanalyzer/11.6/install/application/reports/wsfederationrealmurl.webp)
...
- `WsFederationReply` – Replace the value text with the Trusted URL entered for the Endpoint in Step
  4:
    ...
    ![URL required for WsFederationReply attribute](/images/accessanalyzer/11.6/install/application/reports/wsfederationreplyurl.webp)
...
![Published Reports desktop shortcut properties](/images/accessanalyzer/11.6/install/application/reports/publishedreportsproperties.webp)
