...
![File System Proxy Setup Wizard Welcome page](/images/accessanalyzer/11.6/install/filesystemproxy/welcome.webp)

**Step 2 –** On the Welcome page, click **Next** to begin the installation.

![File System Proxy Setup Wizard End-User License Agreement page](/images/accessanalyzer/11.6/install/filesystemproxy/eula.webp)
...
![File System Proxy Setup Wizard Destination Folder page](/images/accessanalyzer/11.6/install/filesystemproxy/destination.webp)
...
![File System Proxy Setup Wizard Change destination folder page](/images/accessanalyzer/11.6/install/filesystemproxy/changedestination.webp)
...
![File System Proxy Setup Wizard Configure Service page](/images/accessanalyzer/11.6/install/filesystemproxy/configureservice.webp)
...
![File System Proxy Setup Wizard Ready to install page](/images/accessanalyzer/11.6/install/filesystemproxy/ready.webp)

**Step 6 –** On the Ready to install page, click **Install** to start installation.

![File System Proxy Setup Wizard Completed page](/images/accessanalyzer/11.6/install/filesystemproxy/complete.webp)
...
![Netwrix Enterprise Auditor FSAA Proxy Scanner service in the Services Management Console](/images/accessanalyzer/11.6/install/filesystemproxy/service.webp)
...
![File System Proxy ImagePath registry key in the Registry Editor](/images/accessanalyzer/11.6/install/filesystemproxy/regedit.webp)
...
![Port number on File System Access Auditor Data Collector Wizard Applet Settings page](/images/accessanalyzer/11.6/install/filesystemproxy/dcwizardportnumber.webp)
