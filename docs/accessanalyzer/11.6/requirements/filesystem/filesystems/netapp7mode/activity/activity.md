...
Checklist Item 2:
[Provision FPolicy Account](/docs/accessanalyzer/11.6/requirements/filesystem/filesystems/netapp7mode/activity/provisionactivity.md)
...
- See the
  [Enable HTTP or HTTPS](/docs/accessanalyzer/11.6/requirements/filesystem/filesystems/netapp7mode/activity/enablehttp.md)
  topic for instructions.

Checklist Item 4:
[Configure FPolicy](/docs/accessanalyzer/11.6/requirements/filesystem/filesystems/netapp7mode/activity/configurefpolicy.md)
