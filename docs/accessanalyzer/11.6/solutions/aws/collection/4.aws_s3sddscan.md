...
![Queries for the 4.AWS_S3SDDScan Job](/images/accessanalyzer/11.6/solutions/aws/collection/s3sddscanqueries.webp)
...
![AWS Data Collector Sensitive Data Settings wizard page](/images/accessanalyzer/11.6/solutions/aws/collection/s3sddsensitivedata.webp)
...
![AWS Data Collector Select DLP criteria for this scan wizard page](/images/accessanalyzer/11.6/admin/datacollector/ewsmailbox/criteria.webp)
...
- See
  the[Sensitive Data Criteria Editor](/docs/accessanalyzer/11.6/sensitivedatadiscovery/criteriaeditor/overview.md)
  topic for additional information and instructions

:::note
By default, discovered sensitive data strings are stored in the Enterprise Auditor
database.
:::
...
![Analysis Tasks for the 4.AWS_S3SDD Scan Job](/images/accessanalyzer/11.6/solutions/aws/collection/s3sddscananaylsistasks.webp)
