...
[FS_DeleteFiles Job](/docs/accessanalyzer/11.6/solutions/filesystem/cleanup/delete/fs_deletefiles.md) topic
...
![Analysis Tasks for the FS_DeleteFiles_Status Job](/images/accessanalyzer/11.6/solutions/filesystem/cleanup/delete/deletefilesstatusanalysis.webp)
