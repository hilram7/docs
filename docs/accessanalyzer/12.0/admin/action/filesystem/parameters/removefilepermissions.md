...
![File System Action Module Wizard Remove File Permissions Parameters page](/images/accessanalyzer/12.0/admin/action/filesystem/parameters/removefilepermissions.webp)
