...
![File System Action Module Wizard Remove Share Permissions Parameters page](/images/accessanalyzer/12.0/admin/action/filesystem/parameters/removesharepermissions.webp)
