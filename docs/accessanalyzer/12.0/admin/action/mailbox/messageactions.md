...
![New Mailbox Action Wizard Message Actions page](/images/accessanalyzer/12.0/admin/action/mailbox/messageactions.webp)
...
![Options Window](/images/accessanalyzer/12.0/admin/action/mailbox/optionswindow.webp)
