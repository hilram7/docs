...
![New Mailbox Action Wizard Mailbox Message Conditions page](/images/accessanalyzer/12.0/admin/action/mailbox/messageconditions.webp)
...
![MessageClasses Window](/images/accessanalyzer/12.0/admin/action/mailbox/messageclasseswindow.webp)

Modify message classes using the following options:

- Click **Add** to populate a field to add a message class

    ![New class added in MessageClasses Window](/images/accessanalyzer/12.0/admin/action/mailbox/messageclasseswindownew.webp)
...
![Data Range Selection Window](/images/accessanalyzer/12.0/admin/action/mailbox/datarangeselectionwindow.webp)
...
![Values Window](/images/accessanalyzer/12.0/admin/action/mailbox/valueswindow.webp)
