...
![Parameters tab](/images/accessanalyzer/12.0/admin/action/powershell/scriptparamters.webp)
...
![Add/Edit Variable Window](/images/accessanalyzer/12.0/admin/action/powershell/addeditvariable.webp)
