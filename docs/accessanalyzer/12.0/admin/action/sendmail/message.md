...
![Send Mail Action Module Wizard Message page](/images/accessanalyzer/12.0/admin/action/sendmail/message.webp)
...
![Messages preview window](/images/accessanalyzer/12.0/admin/action/sendmail/messagespreview.webp)
