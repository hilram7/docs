...
![Survey Action Module Wizard Questions page](/images/accessanalyzer/12.0/admin/action/survey/questions.webp)
...
![Select subjects window](/images/accessanalyzer/12.0/admin/action/survey/selectsubjects.webp)
