...
![Edit Rules window Variables tab](/images/accessanalyzer/12.0/admin/analysis/businessrules/variables.webp)
...
- To delete a variable, select it and click **Delete**
    ...
    ![JobVariables TSV file](/images/accessanalyzer/12.0/admin/analysis/businessrules/jobvariablestsv.webp)
