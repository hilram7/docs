...
![PowerShell Data Collector Wizard Edit Query page](/images/accessanalyzer/12.0/admin/datacollector/powershell/editquery.webp)
...
![Parameters Window](/images/accessanalyzer/12.0/admin/datacollector/powershell/editqueryparameters.webp)
...
![Add/Edit Variable Window](/images/accessanalyzer/12.0/admin/datacollector/powershell/editqueryvariable.webp)
...
![Edit Query page input options](/images/accessanalyzer/12.0/admin/datacollector/powershell/editqueryinput.webp)
...
![Text Box and the Columns tab populated with information](/images/accessanalyzer/12.0/admin/datacollector/powershell/editqueryinputtable.webp)
