...
![Host Discovey Wizard Source page for IP network scan](/images/accessanalyzer/12.0/admin/hostdiscovery/wizard/source_1.webp)

**Step 1 –** Open the Host Discovery Wizard. On the Source page, select the **Scan your IP network**
option. Click **Next**.

![Host Discovey Wizard Query page for IP network scan](/images/accessanalyzer/12.0/admin/hostdiscovery/wizard/query_1.webp)
...
![Host Discovey Wizard IPSweep page](/images/accessanalyzer/12.0/admin/hostdiscovery/wizard/ipsweep.webp)
...
![Host Discovey Wizard Options page for IP network scan](/images/accessanalyzer/12.0/admin/hostdiscovery/wizard/options_1.webp)
...
![Host Discovey Wizard Inventory page for IP network scan](/images/accessanalyzer/12.0/admin/hostdiscovery/wizard/inventory_1.webp)
...
![Host Discovey Wizard Summary page for IP network scan](/images/accessanalyzer/12.0/admin/hostdiscovery/wizard/summary_1.webp)
