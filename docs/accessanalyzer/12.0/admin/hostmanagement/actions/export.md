...
![Export Data option on the Activities pane](/images/accessanalyzer/12.0/admin/hostmanagement/actions/export.webp)

**Step 2 –** When the data grid contains all columns desired for export, click **Export Data**. A
Save As window opens.

![Save As window](/images/accessanalyzer/12.0/admin/hostmanagement/actions/exportsaveas.webp)
...
![Example HTML File Export](/images/accessanalyzer/12.0/admin/hostmanagement/actions/exportexamplehtml.webp)

**Example XML File Export**

![Example XML File Export](/images/accessanalyzer/12.0/admin/hostmanagement/actions/exportexamplexml.webp)
