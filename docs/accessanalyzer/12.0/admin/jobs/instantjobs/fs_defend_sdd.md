...
![FS_DEFEND_SDD job in the Jobs tree](/images/accessanalyzer/12.0/admin/jobs/instantjobs/jobstree_2.webp)
...
![Default Action Tasks for the Job](/images/accessanalyzer/12.0/admin/jobs/instantjobs/actiontasks.webp)
