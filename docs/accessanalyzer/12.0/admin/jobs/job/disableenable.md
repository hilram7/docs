...
![Disable Job from Jobs Tree](/images/accessanalyzer/12.0/admin/jobs/job/disablejob.webp)

**Step 2 –** Right-click on the job group or job and select **Disable Job(s)** from the menu.

![Disabled Job in the Jobs Tree](/images/accessanalyzer/12.0/admin/jobs/job/disabledjob.webp)
...
![Disabled Job Description page banner](/images/accessanalyzer/12.0/admin/jobs/job/disabledjob2.webp)
...
![Enable Job from Jobs Tree](/images/accessanalyzer/12.0/admin/jobs/job/enablejob.webp)
