...
![User Credentials Window - Azure Active Directory](/images/accessanalyzer/12.0/admin/settings/connection/profile/entraid.webp)
...
- Client ID – Application (client) ID of the Access Analyzer application registered with Microsoft
  Entra ID. See the
  [Identify the Client ID](/docs/accessanalyzer/12.0/requirements/entraid/entraid/access.md#identify-the-client-id) topic for
