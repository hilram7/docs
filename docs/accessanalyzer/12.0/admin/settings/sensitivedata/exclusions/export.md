...
![Select False Positive Exclusion filter file to export File Explorer window](/images/accessanalyzer/12.0/admin/settings/sensitivedata/exclusions/exportfileexplorer.webp)
