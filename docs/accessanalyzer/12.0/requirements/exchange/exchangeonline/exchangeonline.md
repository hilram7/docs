...
See the [Microsoft Entra ID Auditing Configuration](/docs/accessanalyzer/12.0/requirements/entraid/entraid/access.md) topic for
...
See the [Exchange Online Auditing Configuration](/docs/accessanalyzer/12.0/requirements/exchange/exchangeonline/access.md) topic for
additional information.
