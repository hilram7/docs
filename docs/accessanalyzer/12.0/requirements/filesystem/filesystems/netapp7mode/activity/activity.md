...
- See the [Enable HTTP or HTTPS](/docs/accessanalyzer/12.0/requirements/filesystem/filesystems/netapp7mode/activity/enablehttp.md) topic for instructions.

**Checklist Item 4: [Configure FPolicy](/docs/accessanalyzer/12.0/requirements/filesystem/filesystems/netapp7mode/activity/configurefpolicy.md)**
