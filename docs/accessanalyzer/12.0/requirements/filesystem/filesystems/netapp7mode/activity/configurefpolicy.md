...
- The Activity Monitor must register with the NetApp device as an FPolicy server. By default, it
  ...
  [Customize FPolicy Policy Name](/docs/accessanalyzer/12.0/requirements/filesystem/filesystems/netapp7mode/activity/customizefpolicy.md) section for information on using a different
  policy name.
