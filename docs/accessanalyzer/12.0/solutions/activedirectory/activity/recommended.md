...
[0.Collection > AD_ActivityCollection Job](/docs/accessanalyzer/12.0/solutions/activedirectory/activity/ad_activitycollection.md) in order to connect to either
...
[0.Collection > AD_ActivityCollection Job](/docs/accessanalyzer/12.0/solutions/activedirectory/activity/ad_activitycollection.md).
...
See the [Active Directory Solution](/docs/accessanalyzer/12.0/requirements/activedirectory/activedirectory.md) topic for
