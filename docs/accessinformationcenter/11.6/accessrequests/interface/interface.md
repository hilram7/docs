...
description: "Access Requests Interface"
sidebar_position: 10
---
...
![Access Requests interface Pending Requests tab](/images/accessinformationcenter/11.6/accessrequests/interfacepending.webp)
...
![Access Requests interface Request History tab](/images/accessinformationcenter/11.6/accessrequests/interfacehistory.webp)
...
| Button       | Description                                                                                                                                                                                                                                      |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| View Changes | Opens the Changes window to view all access changes for the selected trustee. See the [Changes Window](/docs/accessinformationcenter/11.6/accessrequests/interface/changes.md) topic for additional information. |
| View Notes   | Opens the View Notes window for the selected request. Clicking on the Notes icon in the table will also open the View Notes window. Click **OK** to close the window.                                                                            |
