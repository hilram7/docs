...
![Use the windows account running this service option on Database Configuration page](/images/accessinformationcenter/11.6/admin/additionalconfig/gmsadatabaseconfiguration.webp)
