...
![Configuration interface showing the Console Access page](/images/accessinformationcenter/11.6/admin/configuration/consoleaccess.webp)
...
- [Diagnostics Page](/docs/accessinformationcenter/11.6/admin/configuration/diagnostics.md)
  – Download logs and enable debug log level for troubleshooting
- [License Page](/docs/accessinformationcenter/11.6/admin/configuration/license.md)
