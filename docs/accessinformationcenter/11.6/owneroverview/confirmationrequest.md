...
description: "Owner Confirmation Request Email"
sidebar_position: 10
---
...
![Ownership Confirmation Request Email with Yes and No buttons for responding](/images/accessinformationcenter/11.6/resourceowners/email/confirmationrequestemail.webp)
...
![Ownership accepted browser message](/images/accessinformationcenter/11.6/resourceowners/email/emailresponseconfirmed.webp)
...
![Ownership declined browser message](/images/accessinformationcenter/11.6/resourceowners/email/emailresponsedeclined.webp)

Enter your suggestion for possible owners in the textbox, and then click **Submit** to complete the
process.

![emailresponsedeclined2](/images/accessinformationcenter/11.6/resourceowners/email/emailresponsedeclined2.webp)
