...
description: "Owner Portal Overview"
sidebar_position: 20
---
...
![Owner Portal interface with 3 sections identified](/images/accessinformationcenter/11.6/resourceowners/ownerportal/overview.webp)

The Owner portal has three sections:

- [Actions Panel](/docs/accessinformationcenter/11.6/owneroverview/ownerportal/actionspanel.md)
...
- [Assigned Resources](/docs/accessinformationcenter/11.6/owneroverview/ownerportal/assignedresources/assignedresources.md)
...
![Ownership Status donut graph](/images/accessinformationcenter/11.6/resourceowners/ownerportal/ownershipstatus.webp)
