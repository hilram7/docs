...
[User Access Request Email](/docs/accessinformationcenter/11.6/owneroverview/owners/request.md)
topic for additional information.

You can also process access requests through the Owner portal.

![Access Requests link in Owners Portal](/images/accessinformationcenter/11.6/accessrequests/owners/ownersportal.webp)
