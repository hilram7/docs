...
![Resource Reviews page showing an Access Review on 1 Make Changes tab](/images/accessinformationcenter/11.6/resourcereviews/reviewpageaccess.webp)
...
- Trustee Name — Name of the trustee with access to this resource. If the trustee is a group, click
  ...
  [Group Membership Window](/docs/accessinformationcenter/11.6/owneroverview/pendingreviews/groupmembership.md)
...
![Resource Reviews page showing an Access Review on 2 Review changes tab](/images/accessinformationcenter/11.6/resourcereviews/review/reviewpageaccess2.webp)
