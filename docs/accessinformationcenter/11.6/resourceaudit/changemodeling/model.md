...
![Select trustee on Effective Access report](/images/accessinformationcenter/11.6/resourceaudit/changemodeling/effectiveaccessreport.webp)
...
![Group Membership Changes window](/images/accessinformationcenter/11.6/resourceaudit/changemodeling/groupmembershipchanges.webp)
...
![Add Membership Change wizard Select Group page](/images/accessinformationcenter/11.6/resourceaudit/changemodeling/addmembershipchangeselectgroup.webp)

**Step 6 –** On the Select Group page, the selected group is displayed. You can search to select a
different group. Click **Next**.

![Add Membership Change wizard Change Type page](/images/accessinformationcenter/11.6/resourceaudit/changemodeling/addmembershipchangetype.webp)
...
![Add Membership Change wizard Remove Members page](/images/accessinformationcenter/11.6/resourceaudit/changemodeling/addmembershipchangeremovemembers.webp)
...
![Members selected for removal window](/images/accessinformationcenter/11.6/resourceaudit/changemodeling/membersforremoval.webp)
...
![Group Membership Changes window with changes to be modeled](/images/accessinformationcenter/11.6/resourceaudit/changemodeling/groupmembershipchangesstaged.webp)
...
![Effective access changes illustration](/images/accessinformationcenter/11.6/resourceaudit/changemodeling/modeledchanges.webp)
