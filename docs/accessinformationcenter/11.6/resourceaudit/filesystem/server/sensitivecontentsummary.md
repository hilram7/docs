...
![Sensitive Content Summary report at the server level](/images/accessinformationcenter/11.6/resourceaudit/filesystem/server/serversensitivecontentsummary.webp)
