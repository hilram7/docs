...
![Sensitive Content report at the database and table level](/images/accessinformationcenter/11.6/resourceaudit/mysql/databasetables/databasesensitivecontent.webp)
