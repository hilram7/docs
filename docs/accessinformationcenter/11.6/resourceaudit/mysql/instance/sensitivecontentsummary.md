...
![Sensitive Content Summary report at the instance level](/images/accessinformationcenter/11.6/resourceaudit/mysql/instance/instancesensitivecontentsummary.webp)
