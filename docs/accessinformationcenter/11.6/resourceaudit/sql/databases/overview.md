...
- [Activity Report](/docs/accessinformationcenter/11.6/resourceaudit/sql/databases/activity.md)
- Permissions – Displayed but not populated at the **Databases** node
- [Sensitive Content Report](/docs/accessinformationcenter/11.6/resourceaudit/sql/databases/sensitivecontent.md)
