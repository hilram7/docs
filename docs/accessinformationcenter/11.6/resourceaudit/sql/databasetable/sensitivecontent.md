...
![Sensitive Content report at the database and table levels](/images/accessinformationcenter/11.6/resourceaudit/sql/databasetable/databasesensitivecontent.webp)
