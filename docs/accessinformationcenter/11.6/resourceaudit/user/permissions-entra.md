...
description: "Permissions Report for Entra ID User"
...
![Permissions report for Entra ID](/images/accessinformationcenter/11.6/resourceaudit/user/entraid/permissionsentraid.webp)
