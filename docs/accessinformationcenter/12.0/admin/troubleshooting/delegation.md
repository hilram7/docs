...
[Commit Active Directory Changes](/docs/accessinformationcenter/12.0/admin/additionalconfig/commitchanges.md) topic for best practices for
group and resource management through the Access Information Center.

Follow the steps to apply delegation to the desired OUs.

![Active Directory Users and Computers showing right-click menu](/images/accessinformationcenter/12.0/admin/troubleshooting/delegatecontrol.webp)
...
![Delegation of Control wizard showing the Users or Groups page](/images/accessinformationcenter/12.0/admin/troubleshooting/delegatecontrolwizarduser.webp)

**Step 2 –** Navigate to the Users or Groups page. Click **Add**. Enter the Active Directory service
account. Click **Next**.

![Delegation of Control wizard showing the Tasks to Delegate page](/images/accessinformationcenter/12.0/admin/troubleshooting/delegatecontrolwizardtask.webp)
