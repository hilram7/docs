...
- [Administrator Overview](/docs/accessinformationcenter/12.0/admin/overview.md) topic and subtopics cover configuration settings,
...
- [Resource Audit Overview](/docs/accessinformationcenter/12.0/resourceaudit/overview.md) topic and subtopics cover reports on
  ...
  and groups.
- [Resource Owners Overview](/docs/accessinformationcenter/12.0/resourceowners/overview.md) topic and subtopics cover the process of
