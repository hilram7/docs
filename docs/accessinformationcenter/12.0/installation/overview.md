...
See the [Commit Active Directory Changes](/docs/accessinformationcenter/12.0/admin/additionalconfig/commitchanges.md) topic for
...
See the [Upgrade Procedure](/docs/accessinformationcenter/12.0/installation/upgrade.md) topic for additional information.
