...
- [Actions Panel](/docs/accessinformationcenter/12.0/owneroverview/ownerportal/actionspanel.md) — provides access to the Resource Reviews and Self-Service Access
...
- [Assigned Resources](/docs/accessinformationcenter/12.0/owneroverview/ownerportal/assignedresources/assignedresources.md) — A table of assigned resources with action buttons
  below
