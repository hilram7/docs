...
![Resource Reviews page showing an Access Review on 1 Make Changes tab](/images/accessinformationcenter/12.0/resourcereviews/reviewpageaccess.webp)
...
- Trustee Name — Name of the trustee with access to this resource. If the trustee is a group, click
  ...
  [Group Membership Window](/docs/accessinformationcenter/12.0/owneroverview/pendingreviews/groupmembership.md) topic for additional information.
...
![Resource Reviews page showing an Access Review on 2 Review changes tab](/images/accessinformationcenter/12.0/resourcereviews/review/reviewpageaccess2.webp)
