...
[Resource Audit Interface](/docs/accessinformationcenter/12.0/resourceaudit/navigate/resource.md) topic for additional information.
...
- Activity Statistics – Statistics reports show the count of operation events performed for the
  ...
  [Activity Statistics Report](/docs/accessinformationcenter/12.0/resourceaudit/computer/activitystatistics.md) topic for additional information.
