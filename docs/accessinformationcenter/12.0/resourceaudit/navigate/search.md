...
![Search features](/images/accessinformationcenter/12.0/resourceaudit/navigate/searchfeatures.webp)
...
the Access Analyzer database. To search for sensitive data criteria, the search string must start
...
![Recent Searches box](/images/accessinformationcenter/12.0/resourceaudit/navigate/recentsearches.webp)
