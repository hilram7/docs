...
[Review Details Page](/docs/accessinformationcenter/12.0/resourcereviews/interface/interface.md#review-details-page) of the Resource Reviews interface. It
displays all owner-recommended changes and notes for the selected resource.

![View Responses window](/images/accessinformationcenter/12.0/resourcereviews/viewresponses.webp)
...
See the [Data Collection & Automation Prerequisites](/docs/accessinformationcenter/12.0/resourcereviews/prerequisites.md) topic for additional
information.
...
![viewresponsesbuttons](/images/accessinformationcenter/12.0/resourcereviews/window/viewresponsesbuttons.webp)
