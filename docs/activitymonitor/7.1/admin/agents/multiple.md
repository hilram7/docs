...
![Specify Agent Port page - specify port that should be used by new agent](/images/activitymonitor/7.1/install/agent/portdefault.webp)
...
![Install Agents on Multiple Hosts page](/images/activitymonitor/7.1/admin/agents/add/installagentsonmultiplehosts.webp)
...
![Import Hosts from a CSV File window](/images/activitymonitor/7.1/admin/agents/add/importhostsfromacsvfilewindow.webp)
...
![clientcertificate](/images/activitymonitor/7.1/admin/agents/add/clientcertificate.webp)
...
![Agent Installation Path page](/images/activitymonitor/7.1/admin/agents/add/agentinstalllocation.webp)
...
![Windows Agent Settings](/images/activitymonitor/7.1/admin/agents/add/enablewindowsfileactivitymonitoring.webp)
...
![Multiple Agents Installed](/images/activitymonitor/7.1/admin/agents/add/adagentinstalled.webp)
