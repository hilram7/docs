...
![API Server Tab for Agent Properties](/images/activitymonitor/7.1/admin/agents/properties/apiservertab.webp)
...
![Add or Edit API Client popup window](/images/activitymonitor/7.1/admin/agents/properties/addoreditapiclient.webp)
