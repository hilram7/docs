...
![Choose Agent window](/images/activitymonitor/7.1/admin/monitoredhosts/add/chooseagent.webp)

**Step 2 –** On the Choose Agent page, select the **Agent** to monitor the storage device.

![Add Host window with Dell Unity selected](/images/activitymonitor/7.1/admin/monitoredhosts/add/addnewhostemcunity.webp)
...
![Protocol Monitoring Page](/images/activitymonitor/7.1/admin/monitoredhosts/add/isilonprotocols.webp)
...
![Activity Monitor with Dell Unity host added](/images/activitymonitor/7.1/admin/monitoredhosts/add/activitymonitoremcunity.webp)
