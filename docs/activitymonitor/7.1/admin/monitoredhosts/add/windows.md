...
![Add Host page with Windows selected](/images/activitymonitor/7.1/admin/monitoredhosts/add/addhostwindows.webp)
...
![Protocols page](/images/activitymonitor/7.1/admin/monitoredhosts/add/protocolspage.webp)
...
![Configure Operations page for Windows host](/images/activitymonitor/7.1/admin/monitoredhosts/add/configureoperationswindows.webp)
...
![Configure Basic Options page for Windows](/images/activitymonitor/7.1/admin/monitoredhosts/add/configurebasicoptionswindows.webp)
...
![Where to log activity page](/images/activitymonitor/7.1/admin/monitoredhosts/add/wheretologgeneric.webp)
...
![File Output page](/images/activitymonitor/7.1/admin/monitoredhosts/add/fileouputpage.webp)
...
![Activity Monitor with Windows Host added](/images/activitymonitor/7.1/admin/monitoredhosts/add/activitymonitorwindows.webp)
