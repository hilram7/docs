...
![linux](/images/activitymonitor/7.1/admin/outputs/linux.webp)
...
![Host Properties - Azure AD Operations tab](/images/activitymonitor/7.1/admin/outputs/azureadoperationstab.webp)
...
![operations](/images/activitymonitor/7.1/admin/outputs/operations.webp)
...
![qumulooutputproperties](/images/activitymonitor/7.1/admin/outputs/qumulooutputproperties.webp)
...
![Operations Tab for SharePoint](/images/activitymonitor/7.1/admin/outputs/sp.webp)
...
![sql](/images/activitymonitor/7.1/admin/outputs/sql.webp)
...
![Operations Tab for File System](/images/activitymonitor/7.1/admin/outputs/fs.webp)
