...
![pathfilteringtab](/images/activitymonitor/7.1/admin/outputs/pathfilteringtab.webp)

- Add – Opens the Add or Edit Path window to add a new path to the list. See the
  [Add or Edit Path Window](/docs/activitymonitor/7.1/admin/outputs/pathfiltering/addeditpath.md)
...
![Host Properties - Path Filtering Tab](/images/activitymonitor/7.1/admin/outputs/pathfilteringtab.webp)
...
![Path Filtering Tab for SharePoint Hosts](/images/activitymonitor/7.1/admin/outputs/pathfilteringsharepointhosts.webp)
