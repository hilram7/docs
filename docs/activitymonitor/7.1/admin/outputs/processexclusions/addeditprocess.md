...
description: "Add or Edit Process Window"
sidebar_position: 10
---
...
![Add or Edit Process popup window](/images/activitymonitor/7.1/admin/outputs/window/addoreditprocessprocessexclusions.webp)
