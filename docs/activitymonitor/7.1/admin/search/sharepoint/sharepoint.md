...
![SharePoint New Search Tab](/images/activitymonitor/7.1/admin/search/query/sharepointnewsearchtab.webp)
...
![General Category - SharePoint](/images/activitymonitor/7.1/admin/search/query/generalfilters.webp)
...
![SharePoint Search - Audit filter section](/images/activitymonitor/7.1/admin/search/query/auditmask.webp)
...
![SharePoint Search Query - Move/Delete/Copy/Checkin Filters](/images/activitymonitor/7.1/admin/search/query/movedeletecopycheckinfilters.webp)
...
![SharePoint Search Query - Delete FIlters](/images/activitymonitor/7.1/admin/search/query/delete.webp)
...
![SharePoint Search Query - Search Filters](/images/activitymonitor/7.1/admin/search/query/searchfilters.webp)
...
![SharePoint Search Query - Permissions Filters](/images/activitymonitor/7.1/admin/search/query/permissionsfilters.webp)
