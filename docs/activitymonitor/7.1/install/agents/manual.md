...
![Activity Monitor Agent Setup Wizard - Welcome Page](/images/activitymonitor/7.1/install/agent/welcome_1.webp)

**Step 4 –** On the welcome page click **Next**.

![End-User License Agreement Page](/images/activitymonitor/7.1/install/agent/eula.webp)
...
![Ready to install Netwrix Activity Monitor Agent 64-bit Page](/images/activitymonitor/7.1/install/agent/readyinstall.webp)
...
![Completion Page](/images/activitymonitor/7.1/install/agent/complete.webp)
...
![Agent Port Configuration](/images/activitymonitor/7.1/install/agent/portdefault.webp)
...
![Activity Monitor Agent Installed](/images/activitymonitor/7.1/install/agent/consolewithagent.webp)
