...
![StealthINTERCEPT Windows Agent Setup wizard on the Welcome page](/images/activitymonitor/7.1/install/agent/welcome_1.webp)

**Step 2 –** On the Welcome page, click **Install**. The Setup Progress page is displayed, followed
by another Welcome page.

![Threat Prevention Windows Agent - Welcome Page](/images/activitymonitor/7.1/install/agent/welcome.webp)

**Step 3 –** Click **Next**.

![End-User License Agreement Page](/images/activitymonitor/7.1/install/agent/license.webp)

**Step 4 –** On the End-User License Agreement page, check the **I accept the terms in the License
Agreement** box and click **Next**.

![Destination Folder Page](/images/activitymonitor/7.1/install/agent/destinationfolder_1.webp)
...
![Change Destination Folder Page](/images/activitymonitor/7.1/install/agent/changedestination.webp)
...
![CA Certificate Configiration Page](/images/activitymonitor/7.1/install/agent/cacertconfig.webp)
...
![Enterprise Manager Location Information Page](/images/activitymonitor/7.1/install/agent/enterprisemanageram.webp)
...
![Select Event Sources Page](/images/activitymonitor/7.1/install/agent/eventsourcesad.webp)
...
![Windows Agent Setup wizard on the Ready page](/images/activitymonitor/7.1/install/agent/readytoinstall.webp)
...
![Windows Agent Setup wizard on the Operation successful page](/images/activitymonitor/7.1/install/agent/success.webp)
...
![Specify Agent Port](/images/activitymonitor/7.1/install/agent/specifyport.webp)
...
![Active Directory Connection](/images/activitymonitor/7.1/install/agent/adconnection.webp)
...
![Domains to Monitor](/images/activitymonitor/7.1/install/agent/domains.webp)

**Step 7 –** Select the domain of the domain controller(s) where the agent is installed. Click
**Next**.

![Domain Controllers to Deploy Agent](/images/activitymonitor/7.1/install/agent/domaincontroller.webp)
...
![Windows Agent Settings](/images/activitymonitor/7.1/install/agent/windowsagent.webp)
