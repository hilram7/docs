...
![pscp Command](/images/activitymonitor/7.1/install/agent/screen1.webp)
...
![Install Linux Agent RPM Package on the Linux server](/images/activitymonitor/7.1/install/agent/screen2.webp)
...
![Generate the Activity Monitor Agent Client Certificate](/images/activitymonitor/7.1/install/agent/screen3.webp)
...
![Specify Agent Port](/images/activitymonitor/7.1/install/agent/specifyagentport.webp)

**Step 4 –** Specify the port to be used for the agent. Click **Next**.

![Credentials to Connect to Server.](/images/activitymonitor/7.1/install/agent/credentials.webp)
...
![Linux Agent Options](/images/activitymonitor/7.1/install/agent/linuxagentoptions.webp)
...
![Server Properties](/images/activitymonitor/7.1/install/agent/properties.webp)
