...
domain and are compatible with Netwrix Enterprise Auditor and Netwrix Threat Manager, feeding them
AD activity data.
...
![nam_admodule](/images/activitymonitor/7.1/requirements/nam_admodule.webp)
...
![ntp](/images/activitymonitor/7.1/requirements/ntp.webp)
...
See the
[Active Directory Activity Auditing Configuration](/docs/activitymonitor/7.1/requirements/adagent/activity/activity.md)
