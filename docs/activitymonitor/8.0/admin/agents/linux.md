...
![Install New Agent page of the Add New Agent(s) Wizard](/images/activitymonitor/8.0/install/agent/installnew.webp)
...
![Credentials to Connect](/images/activitymonitor/8.0/admin/agents/add/credentialsservers.webp)
...
![Public Key Credentials](/images/activitymonitor/8.0/admin/agents/add/publickey.webp)
...
![Client Certificate Credentials](/images/activitymonitor/8.0/admin/agents/add/clientcertificate.webp)
...
![Linux Agent Options](/images/activitymonitor/8.0/admin/agents/add/linuxagentoptions.webp)
...
![Linux Agent Installed](/images/activitymonitor/8.0/admin/agents/add/activitymonitorwithlinuxagentinstalled.webp)
