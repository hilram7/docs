...
![Add Host - Choose Agent](/images/activitymonitor/8.0/admin/monitoredhosts/add/chooseagent.webp)

**Step 2 –** On the Choose Agent page, select the Agent to monitor the storage device.

![Add Host Page](/images/activitymonitor/8.0/admin/monitoredhosts/add/addexchangeonline.webp)
...
![Azure AD Connection - Exchange Online](/images/activitymonitor/8.0/admin/monitoredhosts/add/connection.webp)
...
![operations](/images/activitymonitor/8.0/admin/monitoredhosts/add/operations.webp)
...
![Mailboxes to Exclude](/images/activitymonitor/8.0/admin/monitoredhosts/add/mailboxesexclude.webp)
...
![usersexclude](/images/activitymonitor/8.0/admin/monitoredhosts/add/usersexclude.webp)
...
![Where to log activity - Exchange Online](/images/activitymonitor/8.0/admin/monitoredhosts/add/wheretologactivity.webp)

**Step 8 –** On the Where To Log The Activity page, select whether to send the activity to either a
**Log File** or **Syslog Server**.

![File Output - Exchange Online](/images/activitymonitor/8.0/admin/monitoredhosts/add/fileoutput.webp)
...
![Syslog Output - Exchange Online](/images/activitymonitor/8.0/admin/monitoredhosts/add/syslogoutput.webp)
...
![Exchange Online in Activity Monitor](/images/activitymonitor/8.0/admin/monitoredhosts/add/exchangeonline.webp)
