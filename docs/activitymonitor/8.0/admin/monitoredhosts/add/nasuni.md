...
![Add Host page with Nasuni selected](/images/activitymonitor/8.0/admin/monitoredhosts/add/addhostnasuni.webp)
...
![Nasuni Options page](/images/activitymonitor/8.0/admin/monitoredhosts/add/nasunioptions.webp)
