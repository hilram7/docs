...
![Add New Host - Choose Agent page](/images/activitymonitor/8.0/admin/monitoredhosts/add/chooseagent.webp)

**Step 2 –** On the Choose Agent page, select the Agent to monitor the storage device. Click
**Next**.

![Add New Host - Add Host page with NetApp selected](/images/activitymonitor/8.0/admin/monitoredhosts/add/addhostnetapp.webp)
...
![NetApp Host Connection Page](/images/activitymonitor/8.0/admin/monitoredhosts/add/netappconnection.webp)
...
![NetApp FPolicy Configuration page](/images/activitymonitor/8.0/admin/monitoredhosts/add/netappfpolicyconfiguration.webp)
...
![NetApp FPolicy Enable and Connect window](/images/activitymonitor/8.0/admin/monitoredhosts/add/netappfpolicyenableconnect.webp)
...
![protocolspage](/images/activitymonitor/8.0/admin/monitoredhosts/add/protocolspage.webp)
...
![Configure Operations window for NetApp](/images/activitymonitor/8.0/admin/monitoredhosts/add/configureoperationsnetapp.webp)
...
![Configure Basic Options page for NetApp](/images/activitymonitor/8.0/admin/monitoredhosts/add/configurebasicoptionsnetapp.webp)
...
![fileoutput](/images/activitymonitor/8.0/admin/monitoredhosts/add/fileoutput.webp)
...
![syslogoutput](/images/activitymonitor/8.0/admin/monitoredhosts/add/syslogoutput.webp)
...
![Activity Monitor with NetApp Host added](/images/activitymonitor/8.0/admin/monitoredhosts/add/activitymonitornetapp.webp)
...
![NetApp Host Properties FPolicy Tab](/images/activitymonitor/8.0/admin/monitoredhosts/add/netappfpolicytab.webp)
...
For information on the other options for this tab, see the [FPolicy Tab](/docs/activitymonitor/8.0/admin/monitoredhosts/properties/fpolicy.md)
section.
...
- [NetApp Tab](/docs/activitymonitor/8.0/admin/monitoredhosts/properties/netapp.md)
- [FPolicy Tab](/docs/activitymonitor/8.0/admin/monitoredhosts/properties/fpolicy.md)
