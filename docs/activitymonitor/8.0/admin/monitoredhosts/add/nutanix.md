...
![nutanixnetworkadapter](/images/activitymonitor/8.0/admin/monitoredhosts/add/nutanixnetworkadapter.webp)
...
[Network Tab](/docs/activitymonitor/8.0/admin/agents/properties/network.md) topic for additional information.
...
![Choose Agent](/images/activitymonitor/8.0/admin/monitoredhosts/add/addagent01.webp)

**Step 2 –** On the Choose Agent page, select the Agent to monitor the file server from the
drop-down list. Click **Next**.

![Add Host](/images/activitymonitor/8.0/admin/monitoredhosts/add/addhost02.webp)

**Step 3 –** On the Add Host page, select the **Nutanix Files** radio button and enter the file
server name. Click **Next**.

![Nutanix Options](/images/activitymonitor/8.0/admin/monitoredhosts/add/nutanixoptions_04.webp)
...
![Configure Operations](/images/activitymonitor/8.0/admin/monitoredhosts/add/nutanixoptions_05.webp)
...
![Configure Operations](/images/activitymonitor/8.0/admin/monitoredhosts/add/nutanixoptions_06.webp)
...
![Where to log the activity](/images/activitymonitor/8.0/admin/monitoredhosts/add/nutanixoptions_07.webp)
...
![File Output](/images/activitymonitor/8.0/admin/monitoredhosts/add/nutanixoptions_08.webp)
...
![Syslog Output](/images/activitymonitor/8.0/admin/monitoredhosts/add/nutanixoptions_09.webp)
...
![nutanixoptions_10](/images/activitymonitor/8.0/admin/monitoredhosts/add/nutanixoptions_10.webp)
...
- [Nutanix Tab](/docs/activitymonitor/8.0/admin/monitoredhosts/properties/nutanix.md)
