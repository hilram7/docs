...
![Add Host page with SharePoint Online selected](/images/activitymonitor/8.0/admin/monitoredhosts/add/addhost.webp)
...
![Add New Host - Azure AD Connection for SharePoint Online](/images/activitymonitor/8.0/admin/monitoredhosts/add/azureadconnection.webp)
...
![SharePoint Online Operations page](/images/activitymonitor/8.0/admin/monitoredhosts/add/fileandpagetab.webp)
...
![Activity Monitor with SharePoint Online host added](/images/activitymonitor/8.0/admin/monitoredhosts/add/sharepointonline.webp)
