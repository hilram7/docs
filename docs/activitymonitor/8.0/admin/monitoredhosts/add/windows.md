...
![Add Host page with Windows selected](/images/activitymonitor/8.0/admin/monitoredhosts/add/addhostwindows.webp)
...
![Configure Operations page for Windows host](/images/activitymonitor/8.0/admin/monitoredhosts/add/configureoperationswindows.webp)
...
![Where to log activity page](/images/activitymonitor/8.0/admin/monitoredhosts/add/wheretologgeneric.webp)
...
![File Output page](/images/activitymonitor/8.0/admin/monitoredhosts/add/fileouputpage.webp)
...
- [Windows Tab](/docs/activitymonitor/8.0/admin/monitoredhosts/properties/windows.md)
