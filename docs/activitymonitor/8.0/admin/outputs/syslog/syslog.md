...
![syslogactivedirectory](/images/activitymonitor/8.0/admin/outputs/syslogactivedirectory.webp)
...
- Syslog message template – Template that controls what data is sent in the event stream. The
  ...
  [Message Template Window](/docs/activitymonitor/8.0/admin/outputs/syslog/messagetemplate.md) topic for additional information.
...
![sysloglinux](/images/activitymonitor/8.0/admin/outputs/sysloglinux.webp)
...
![syslogentraid](/images/activitymonitor/8.0/admin/outputs/syslogentraid.webp)
...
![syslognas](/images/activitymonitor/8.0/admin/outputs/syslognas.webp)
...
![syslogwindows](/images/activitymonitor/8.0/admin/outputs/syslogwindows.webp)
