...
![SQL Server Search Query](/images/activitymonitor/8.0/admin/search/query/sqlsearchquerytoolbar.webp)
...
![General Filters](/images/activitymonitor/8.0/admin/search/query/generalfilter.webp)
...
![userfilter](/images/activitymonitor/8.0/admin/search/query/userfilter.webp)
...
![SQL Filters](/images/activitymonitor/8.0/admin/search/query/sqlfilters.webp)
