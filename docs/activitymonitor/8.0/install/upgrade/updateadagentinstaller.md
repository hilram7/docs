...
description: "Update AD Agent Installer"
sidebar_position: 10
---
...
![Update Agent Installer](/images/activitymonitor/8.0/install/updateagentinstaller.webp)

**Step 2 –** Navigate to the location of the latest AD Agent installation package. Select the
installer and click **Open**.

![Confirmation Window](/images/activitymonitor/8.0/install/updateagentinstallerpopup.webp)
