...
![settings](/images/activitymonitor/8.0/config/dellpowerscale/settings.webp)
...
![eventforwarding](/images/activitymonitor/8.0/config/dellpowerscale/eventforwarding.webp)
...
:::note
To use the Activity Monitor with Access Analyzer for Activity Auditing (FSAC) scans, the
