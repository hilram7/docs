...
same share location in order for Access Analyzer to collect the AD Activity data.
...
- The **User name** and **User password** fields only need to be filled in if the account used to
  install the agent does not have access to this share.
    ...
    Administrator account. This is typically the credential that will be used in the Netwrix Access
