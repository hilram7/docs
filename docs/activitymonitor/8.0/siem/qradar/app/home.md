...
![Home Dashboard for Stealthbits Activivty Monitor App for QRadar](/images/activitymonitor/8.0/siem/qradar/dashboard/homedashboard.webp)
...
- Open Offenses – Number of ransomware offenses detected within QRadar from the file activity event
  data
    ...
    - The value for this card is a hyperlink to the [Ransomware Dashboard](/docs/activitymonitor/8.0/siem/qradar/app/ransomware.md).
