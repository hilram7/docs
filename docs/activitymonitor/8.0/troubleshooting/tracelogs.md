...
![Collect Logs button](/images/activitymonitor/8.0/troubleshooting/collectlogsbutton.webp)
...
![Copying the log files popup window](/images/activitymonitor/8.0/troubleshooting/collectlogswindow.webp)
