...
[Notification Options](/docs/auditor/10.6/accessreviews/admin/configuration/notifications.md#notification-options)
...
![Access Information Center Login page](/images/auditor/10.6/access/reviews/admin/login.webp)
...
[Enable Console Users](/docs/auditor/10.6/accessreviews/accessreviews.md#enable-console-users)
topic for additional information.
...
![Resource Owners interface as the landing page for an Administrator user](/images/auditor/10.6/access/reviews/admin/landingadmin.webp)
...
![Resource Owners interface as the landing page for a Security Team user](/images/auditor/10.6/access/reviews/admin/landingsecurityteam.webp)
