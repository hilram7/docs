...
See the
[Manage Reviews Page](/docs/auditor/10.6/accessreviews/entitlementreviews/interface/interface.md#manage-reviews-page)
topic for additional information.

![Create Review wizard](/images/auditor/10.6/access/reviews/entitlementreviews/wizard/createreviewreviewtype.webp)
...
![Create Review wizard showing the Review Type page](/images/auditor/10.6/access/reviews/entitlementreviews/wizard/createreviewreviewtype.webp)
...
![Create Review wizrd showing the Resources page](/images/auditor/10.6/access/reviews/entitlementreviews/wizard/createreviewresources.webp)
...
- Select the desired resource(s) and click **Add**. The **View Selections** button indicates how
  ...
  [Selected Resources Window](/docs/auditor/10.6/accessreviews/entitlementreviews/interface/selectedresources.md)
  topic for additional information.
- Once the desired resources have been selected, click **Next**.

![Create Review wizard showing the Summary page](/images/auditor/10.6/access/reviews/entitlementreviews/wizard/createreviewsummary.webp)
