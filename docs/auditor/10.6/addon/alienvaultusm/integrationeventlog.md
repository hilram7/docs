...
[Reference for Creating Activity Records](/docs/auditor/10.6/api/activityrecordreference.md)topic.

| Event log field name | Filled in with value                                                        | Details                                                                                                                                                             |
| -------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Source               | **NA__**`{Data Source Name}`** -OR- **Netwrix_Auditor_Integration_API__ | Depending on _SetDataSourceAsEventSource_ in-script parameter.                                                                                                      |
...
See the [Define Parameters](/docs/auditor/10.6/addon/alienvaultusm/parameters.md)
...
![eventlogexample](/images/auditor/10.6/addon/solarwinds/eventlogexample.webp)
