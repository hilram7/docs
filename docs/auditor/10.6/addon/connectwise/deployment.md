...
1. In the Auditor settings, enable Integration API and specify connection port. See the
   [Integrations](/docs/auditor/10.6/admin/settings/integrations.md) topic for
...
[Configure ConnectWise ](/docs/auditor/10.6/addon/connectwise/configure.md)topic
for additional information.

**Step 6 –** (optional) To adjust the add-on operation and data flow settings, edit the
ITSMSettings.xml file. See the
[Operational Settings](/docs/auditor/10.6/addon/connectwise/operationalsettings.md)
