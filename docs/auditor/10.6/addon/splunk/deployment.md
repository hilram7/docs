...
![config](/images/auditor/10.6/addon/splunk/config.webp)

- When on any other screen, you can expand the drop-down list at the top panel and choose Manage
  Apps:

    ![searchreporting](/images/auditor/10.6/addon/splunk/searchreporting.webp)

**Step 3 –** On the **Apps** screen, click Install app from file:

![installapp](/images/auditor/10.6/addon/splunk/installapp.webp)
...
![uploadapp](/images/auditor/10.6/addon/splunk/uploadapp.webp)
...
![searchreportingapp](/images/auditor/10.6/addon/splunk/searchreportingapp.webp)
...
![configuration](/images/auditor/10.6/addon/splunk/configuration.webp)

**Step 2 –** Configure the account:

1. On the Configuration page, open the Account section.

    ![addaccount](/images/auditor/10.6/addon/splunk/addaccount.webp)
...
3. Click the Add button. The added account should appear in the list:
    ...
    ![configurationaccount](/images/auditor/10.6/addon/splunk/configurationaccount.webp)
...
1. On the Configuration page open the Add-on Settings section:
    ...
    ![configurationaddonsettings](/images/auditor/10.6/addon/splunk/configurationaddonsettings.webp)
...
1. Open Netwrix Auditor add-on for Splunk and go to the **Inputs** section.
    ...
    ![inputs](/images/auditor/10.6/addon/splunk/inputs.webp)

2. Click Create New Input.

    ![addapi](/images/auditor/10.6/addon/splunk/addapi.webp)
