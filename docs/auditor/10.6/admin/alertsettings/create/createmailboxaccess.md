...
[Event Log Manager](/docs/auditor/10.6/tools/eventlogmanager/eventlogmanager.md) topic for
...
![eventmessageopen](/images/auditor/10.6/admin/alertsettings/eventmessageopen.webp)
