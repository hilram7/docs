...
- See the[Manage Alerts](/docs/auditor/10.6/admin/alertsettings/manage.md) topic
...
- See the [Create Alerts](/docs/auditor/10.6/admin/alertsettings/create/create.md) topic
...
- If you need to be alerted on specific events in your Event Logs or non-owner mailbox access
  attempts, see the
  [Create Alerts for Event Log](/docs/auditor/10.6/admin/alertsettings/create/createeventlog.md)
  and
  [Create Alerts for Non-Owner Mailbox Access Events](/docs/auditor/10.6/admin/alertsettings/create/createmailboxaccess.md)
