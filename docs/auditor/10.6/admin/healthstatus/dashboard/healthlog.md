...
![healthlog](/images/auditor/10.6/admin/healthstatus/dashboard/healthlog.webp)
...
- Configure alerts triggered by specific events in the product's health log.
  [Create Alerts on Health Status](/docs/auditor/10.6/admin/alertsettings/create/createhealthstatus.md)
...
![healthlogfilters](/images/auditor/10.6/admin/healthstatus/dashboard/healthlogfilters.webp)
