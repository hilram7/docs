...
- The Health log chart—Shows the statistics on the events written in the Netwrix Auditor health log
  ...
  [Netwrix Auditor Health Log](/docs/auditor/10.6/admin/healthstatus/dashboard/healthlog.md)
  topic for additional information.
- The Database statistics widget—Helps you to estimate database capacity on the default SQL Server
  ...
  [Database Statistics](/docs/auditor/10.6/admin/healthstatus/dashboard/databasestatistics.md)
  topic for additional information.
- The Long-Term Archive widget—Helps you to estimate the capacity of the Long-Term Archive
  ...
  this widget. See the
  [System Health](/docs/auditor/10.6/requirements/longtermarchive.md#system-health)
  topic for additional information.
...
![healthstatusdashboard](/images/auditor/10.6/admin/healthstatus/dashboard/healthstatusdashboard.webp)
...
[Notifications](/docs/auditor/10.6/admin/settings/notifications.md) topic.
