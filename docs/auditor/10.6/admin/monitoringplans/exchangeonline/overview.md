...
| Configure audit settings                           | See the [Exchange Online](/docs/auditor/10.6/configuration/microsoft365/exchangeonline/overview.md) configuration topic for additional information about audit settings required to collect comprehensive audit data and the instructions on how to configure them.      |
