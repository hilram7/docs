...
![hiw_diagram_oracle](/images/auditor/10.6/admin/monitoringplans/oracle/hiw_diagram_oracle.webp)
...
1. Oracle administrator prepares a dedicated service account with sufficient permissions to collect
   ...
   [Permissions for Oracle Database Auditing](/docs/auditor/10.6/configuration/oracle/permissions.md)
   topic for additional information.
2. Netwrix administrator does the following:
    ...
    - Configures alerts related to Oracle data source. Current version does not include predefined
      ...
      [Create Alerts](/docs/auditor/10.6/admin/alertsettings/create/create.md) section to
