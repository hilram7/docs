...
![scenario_reports_1](/images/auditor/10.6/admin/navigation/scenario_reports_1.webp)
...
![scenario_reports_2](/images/auditor/10.6/admin/navigation/scenario_reports_2.webp)
...
[IT Risk Assessment Overview ](/docs/auditor/10.6/admin/riskassessment/overview.md)
topic for additional information.
...
3. Search the group of risks you want to pin to the home page (in this case, the "_Permissions_"
   risks group):
    ...
    ![scenario_risks](/images/auditor/10.6/admin/navigation/scenario_risks.webp)
