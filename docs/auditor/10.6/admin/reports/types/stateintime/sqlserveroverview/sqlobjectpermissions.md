...
[SQL Server](/docs/auditor/10.6/configuration/sqlserver/overview.md) section.

![objectpermissionssqlserver](/images/auditor/10.6/admin/reports/types/stateintime/objectpermissionssqlserver.webp)
...
- **Object type** — monitored object type; for the full list of supported object types, refer to
  [SQL Server](/docs/auditor/10.6/configuration/sqlserver/overview.md) topic.
...
- Clicking a Means granted link opens
  the[SQL Server Means Granted](/docs/auditor/10.6/admin/reports/types/stateintime/sqlserveroverview/sqlmeansgranted.md)
  report.
