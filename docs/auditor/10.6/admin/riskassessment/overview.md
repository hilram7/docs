...
[IT Risk Assessment Dashboard](/docs/auditor/10.6/admin/riskassessment/dashboard.md).
...
3. Go to the Audit Database section and make sure that Disable security intelligence ... checkbox is
   ...
   database:
   ![edit_mp_store_data_to_db](/images/auditor/10.6/admin/riskassessment/edit_mp_store_data_to_db.webp)
...
5. Select the data source you need (for example, Active Directory) and click Edit data source from
   ...
   ![edit_mp_open_ds_settings](/images/auditor/10.6/admin/riskassessment/edit_mp_open_ds_settings.webp)
6. Make sure that:
...
![edit_data_source_sit](/images/auditor/10.6/admin/riskassessment/edit_data_source_sit.webp)
