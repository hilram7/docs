...
| Action | Filter data by action type (Added, Removed, etc.) Select an action type from the list (Added, Removed, Modified, Read). For additional actions, navigate to the Advanced mode. See the [Use Filters in Advanced Mode](/docs/auditor/10.6/admin/search/filteradvanced.md) topic for additional information.                                                                                                                                                                      |
...
![Account specification](/images/auditor/10.6/admin/search/add.webp)
...
![Filter](/images/auditor/10.6/admin/search/addsuggestions.webp)
...
| To...         | Do...                                                                                                                                                                                                                                                                                                     |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Modify filter | Double-click the filter and type a new value. ![Filter new value](/images/auditor/10.6/admin/search/search_modify_filter.webp) If you need to modify the When filter, delete it and add a new value, or navigate to the Advanced mode (Simple mode does not support its modification). |
