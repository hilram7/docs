...
- Netwrix Data Classification. See
  [Sensitive Data Discovery ](/docs/auditor/10.6/admin/settings/sensitivedatadiscovery.md)for
  more information.
...
Archive. See [Investigations](/docs/auditor/10.6/admin/settings/investigations.md)
topic for additional information.

## Browsing Your Audit Data

On the main Netwrix Auditor page, click
![search_tile](/images/auditor/10.6/admin/search/search_tile.webp) on the left.
...
- To pre-configure your search query before you click Search, you can add filters. Then the search
  ...
  for details.
    ...
    filter fields and conditions). See
    [Use Filters in Advanced Mode](/docs/auditor/10.6/admin/search/filteradvanced.md)
    for details.

    ![search_filter](/images/auditor/10.6/admin/search/search_filter.webp)
...
![search_nofilter_1](/images/auditor/10.6/admin/search/search_nofilter_1.webp)
...
3. You can instruct Netwrix Auditor to include or exclude this activity record from the search query
   results, as described in the [Include and Exclude Data ](#include-and-exclude-data)
