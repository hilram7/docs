...
![sensitivedatadiscovery](/images/auditor/10.6/admin/settings/sensitivedatadiscovery.webp)
...
[Data Discovery and Classification Reports](/docs/auditor/10.6/admin/reports/types/datadiscoveryclassification.md).
