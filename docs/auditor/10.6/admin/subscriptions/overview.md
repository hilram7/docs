...
- [Create Subscriptions](/docs/auditor/10.6/admin/subscriptions/create.md)how to
  create new subscriptions.
- [Review and Manage Subscriptions](/docs/auditor/10.6/admin/subscriptions/manage.md)how
