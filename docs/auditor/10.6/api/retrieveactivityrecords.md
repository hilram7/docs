...
| POST   | `https://{host:port}/netwrix/api/v1/activity_records/enum{?format=json}{&count=Number}` | [Continuation Mark](/docs/auditor/10.6/api/postdata/continuationmark.md) |
...
[Continuation Mark](/docs/auditor/10.6/api/postdata/continuationmark.md) topic for
