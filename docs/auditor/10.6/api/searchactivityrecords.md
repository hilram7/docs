...
and [View and Search Collected Data](/docs/auditor/10.6/admin/search/overview.md)
...
[Search Parameters](/docs/auditor/10.6/api/postdata/searchparameters.md) topic for
...
| ------ | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| `POST` | `https://{host:port}/netwrix/api/v1/activity_records/search{?format=json}{&count=Number}` | [Search Parameters](/docs/auditor/10.6/api/postdata/searchparameters.md) |
...
[Continuation Mark](/docs/auditor/10.6/api/postdata/continuationmark.md)
