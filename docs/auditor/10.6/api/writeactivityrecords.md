...
[/netwrix/api/v1/activity_records/search](/docs/auditor/10.6/api/searchactivityrecords.md)
and
[/netwrix/api/v1/activity_records/enum](/docs/auditor/10.6/api/retrieveactivityrecords.md)
endpoints.

| Method | Endpoint                                                             | POST Data                                                                                |
| ------ | -------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `POST` | `https://{host:port}/netwrix/api/v1/activity_records/{?format=json}` | [Activity Records](/docs/auditor/10.6/api/postdata/activityrecords.md) |
...
[Activity Records](/docs/auditor/10.6/api/postdata/activityrecords.md) For
example:
...
__Step 4 –__ Check that posted data is now available in the Audit Database. Run a search request to [/netwrix/api/v1/activity_records/search](/docs/auditor/10.6/api/searchactivityrecords.md) endpoint or use interactive search in the Netwrix Auditor client. For example:

![apiactivity](/images/auditor/10.6/api/apiactivity.webp)
