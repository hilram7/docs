...
See the [Software Requirements](/docs/auditor/10.6/requirements/software.md) topic
...
- Automatically through a monitoring plan – This is a recommended method. If you select to
  ...
  checked on each data collection and adjusted if necessary. See the
  [Configure AD FS farm audit settings automatically](#configure-ad-fs-farm-audit-settings-automatically)
  ...
  configure them manually:
    ...
    - Adjust log size and retention settings for **Security** log and for **AD FS Admin** log (under
      **Applications and Service logs**). See
      [Adjusting Event Log Size and Retention Settings](/docs/auditor/10.6/configuration/windowsserver/eventlog.md)
      for details.
...
![mp_adfs_listing](/images/auditor/10.6/configuration/activedirectoryfederatedservices/mp_adfs_listing.webp)

**Step 2 –** In the **Configure audit settings** section, select **Adjust audit settings
automatically** check box.

![mp_data_source_ad_fs](/images/auditor/10.6/configuration/activedirectoryfederatedservices/mp_data_source_ad_fs.webp)ringplans/mp_data_source_ad_fs.webp)
...
- Configure Data Collecting Account as described in the
  [Permissions for AD FS Auditing](/docs/auditor/10.6/configuration/activedirectoryfederatedservices/permissions.md)
  topic.
