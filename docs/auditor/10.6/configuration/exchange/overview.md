  ...
  configure them manually:
    ...
    - In the Exchange environment:
        ...
        - If you want to track non-owner access, configure mailbox monitoring. See the
          [Configure Exchange for Monitoring Mailbox Access](/docs/auditor/10.6/configuration/exchange/mailboxacccess.md)
          topic for additional information.
...
2. Configure required protocols and ports, as described in the
   [Exchange Ports](/docs/auditor/10.6/configuration/exchange/ports.md) topic.
