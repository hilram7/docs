...
- [Configure Basic Domain Audit Policies](/docs/auditor/10.6/configuration/logonactivity/basicpolicy.md)
- [Configure Advanced Audit Policies](/docs/auditor/10.6/configuration/logonactivity/advancedpolicy.md)
- [Configure Security Event Log Size and Retention Settings](/docs/auditor/10.6/configuration/logonactivity/securityeventlog.md)
