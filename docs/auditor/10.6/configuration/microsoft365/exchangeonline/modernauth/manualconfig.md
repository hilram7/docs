...
pre-configuration. See the
[Configure Exchange Online Modern Authentication Manually](#configure-exchange-online-modern-authentication-manually)section
...
(Netwrix*Auditor_MFA*`<your_tenant_name>`).
