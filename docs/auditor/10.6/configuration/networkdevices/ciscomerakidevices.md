...
![nand_meraki_network](/images/auditor/10.6/configuration/networkdevices/nand_meraki_network.webp)

**Step 3 –** Locate the Reporting section and click Add a syslog server.

![nand_meraki_server](/images/auditor/10.6/configuration/networkdevices/nand_meraki_server.webp)
...
| Port      | Provide the port configured in your monitoring plan for Network Devices (514 by default). See the[Network Devices](/docs/auditor/10.6/admin/monitoringplans/networkdevices.md) topic for additional information. |
