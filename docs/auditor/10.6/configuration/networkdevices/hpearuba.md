...
3. Navigate to Configuration → System → Logging and click + to add a new Syslog Server.
    ...
    ![nand_aruba_logging](/images/auditor/10.6/configuration/networkdevices/nand_aruba_logging.webp)
...
9. If the configuration is correct, you will see the following wizard:
    ...
    ![nand_aruba_status](/images/auditor/10.6/configuration/networkdevices/nand_aruba_status.webp)
