...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  configure them manually:
    ...
    - [Configure Events Auditing Settings](#configure-events-auditing-settings) on your SharePoint
      farm.
    - [Enable SharePoint Administration Service](#enable-sharepoint-administration-service) on the
      computer where SharePoint Central Administration is installed and where you intend to deploy
