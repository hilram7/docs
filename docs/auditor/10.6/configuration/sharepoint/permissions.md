...
[Use Group Managed Service Account (gMSA)](/docs/auditor/10.6/requirements/gmsa.md)[Microsoft documentation](https://docs.microsoft.com/en-us/windows-server/security/group-managed-service-accounts/group-managed-service-accounts-overview).
...
1. On the SharePoint server where the Netwrix Auditor Core Service will be deployed: the account
   ...
   [Installation](/docs/auditor/10.6/install/overview.md) topic.
2. On the SQL Server hosting SharePoint database: the SharePoint_Shell_Access role.  
   See the [Assigning 'SharePoint_Shell_Access' Role](#assigning-sharepoint_shell_access-role) topic
