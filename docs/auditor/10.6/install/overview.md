...
- [Install Client via Group Policy](/docs/auditor/10.6/install/viagrouppolicy.md)
- [Install in Silent Mode](/docs/auditor/10.6/install/silentmode.md)

## Install Netwrix Auditor

For instructions on upgrade procedures, refer to
[Upgrade to the Latest Version](/docs/auditor/10.6/install/upgrade.md).
...
![installationscreen](/images/auditor/10.6/install/installationscreen.webp)
...
[About Netwrix Auditor](/docs/auditor/10.6/admin/settings/about.md) topic for
...
[First Launch](/docs/auditor/10.6/install/firstlaunch.md) topic for additional
information on the product navigation.

![welcome_screen](/images/auditor/10.6/install/welcome_screen.webp)
