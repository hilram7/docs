...
- The SharePoint Administration (SPAdminV4) service is started on the target computer. See
  [SharePoint](/docs/auditor/10.6/configuration/sharepoint/overview.md) for more
  information.
...
folder%\SharePoint Auditing__\SharePointPackage_ and copy SpaPackage_`<version>`.msi to the
