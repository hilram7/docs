...
[Software Requirements](/docs/auditor/10.6/requirements/software.md) topic.
...
[Activity Records](/docs/auditor/10.6/api/postdata/activityrecords.md)[Activity Records](/docs/auditor/10.6/api/postdata/activityrecords.md)
for more details.
...
- [Working Folder](/docs/auditor/10.6/requirements/workingfolder.md)
...
[Sample Deployment Scenarios](/docs/auditor/10.6/requirements/deploymentscenarios.md)
topic.
