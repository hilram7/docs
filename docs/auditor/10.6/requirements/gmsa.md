...
- As a data collecting account for the following data sources: Active Directory (also for Group
  Policy and Logon Activity), Windows Server, File Server (currently for Windows File Servers), SQL
  Server, SharePoint. See the
...
- As an account for accessing Long-Term archive. See the
  [File-Based Repository for Long-Term Archive](/docs/auditor/10.6/requirements/longtermarchive.md)
  topic for additional information.
...
- If you are going to use a gMSA as a data collecting account in Auditor, add this account to the
  ...
  depending on the data source you want to collect data from:
    ...
    - [Permissions for Windows File Server Auditing](/docs/auditor/10.6/configuration/fileservers/windows/permissions.md)
    - [Permissions for SharePoint Auditing](/docs/auditor/10.6/configuration/sharepoint/permissions.md)
    - [Permissions for SQL Server Auditing ](/docs/auditor/10.6/configuration/sqlserver/permissions.md)
    - [Permissions for Windows Server Auditing ](/docs/auditor/10.6/configuration/windowsserver/permissions.md)
...
- If you are going to use a gMSA as a data collection accoun for User Activity Video Recording,
  refer to the following topics:

    - [User Activity](/docs/auditor/10.6/configuration/useractivity/overview.md)
    - [Configure Video Recordings Playback Settings](/docs/auditor/10.6/configuration/useractivity/videorecordings.md)
...
![item_general_gmsa](/images/auditor/10.6/requirements/item_general_gmsa.webp)
