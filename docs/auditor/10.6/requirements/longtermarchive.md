...
![archive_modify_settings](/images/auditor/10.6/requirements/archive_modify_settings.webp)
...
![healthstatusdashboard](/images/auditor/10.6/admin/healthstatus/dashboard/healthstatusdashboard.webp)hboard.webp)
...
- On the file shares where report subscriptions are saved:
    ...
    [Subscriptions](/docs/auditor/10.6/admin/subscriptions/overview.md) topic for
