...
- [Hardware Requirements](/docs/auditor/10.6/requirements/console.md)
- [Software Requirements](/docs/auditor/10.6/requirements/software.md)
...
- Netwrix Auditor collects audit data from the specified data source (application, server, storage
  system, and so on).
    ...
    - To provide a coherent picture of changes that occurred in the audited systems, the product can
      ...
      Integration API.
    - See the [Integration API](/docs/auditor/10.6/api/overview.md) topic for
