...
See the
[Active Directory](/docs/auditor/10.6/configuration/activedirectory/overview.md)
...
See the
[AD FS](/docs/auditor/10.6/configuration/activedirectoryfederatedservices/overview.md)
topic for additional information.
...
See the [Exchange](/docs/auditor/10.6/configuration/exchange/overview.md) topic
...
See the
[Dell Isilon/PowerScale](/docs/auditor/10.6/configuration/fileservers/dellisilon/overview.md)
topic for additional information.
...
See the
[NetApp Data ONTAP](/docs/auditor/10.6/configuration/fileservers/netappcmode/overview.md)
topic for additional information.
...
See the
[Nutanix](/docs/auditor/10.6/configuration/fileservers/nutanix/overview.md) topic
for additional information.
...
See the [Qumulo](/docs/auditor/10.6/configuration/fileservers/qumulo/overview.md)
topic for additional information.
...
See the
[Synology](/docs/auditor/10.6/configuration/fileservers/synology/overview.md)
topic for additional information.
...
See the
[Windows File Servers](/docs/auditor/10.6/configuration/fileservers/windows/overview.md)
topic for additional information.
...
See the [Group Policy](/docs/auditor/10.6/configuration/grouppolicy/overview.md)
topic for additional information.
...
See the
[Logon Activity](/docs/auditor/10.6/configuration/logonactivity/overview.md) topic
for additional information.
...
See the
[Exchange Online](/docs/auditor/10.6/configuration/microsoft365/exchangeonline/overview.md)
topic for additional information.
...
See the
[MS Teams](/docs/auditor/10.6/configuration/microsoft365/teams/overview.md) topic
for additional information.
...
See the
[SharePoint Online](/docs/auditor/10.6/configuration/microsoft365/sharepointonline/overview.md)
topic for additional information.
...
See the
[Configure Cisco ASA Devices](/docs/auditor/10.6/configuration/networkdevices/ciscoasa.md)
topic for additional information.
...
See the
[Configure Cisco IOS Devices](/docs/auditor/10.6/configuration/networkdevices/ciscoios.md)
topic for additional information.
...
See the
[Cisco Meraki Dashboard ](/docs/auditor/10.6/configuration/networkdevices/ciscomerakidashboard.md)
topic for additional information.
...
See the
[Configure Fortinet FortiGate Devices](/docs/auditor/10.6/configuration/networkdevices/fortinetfortigate.md)
topic for additional information.
...
See the
[Configure Pulse Secure Devices](/docs/auditor/10.6/configuration/networkdevices/pulsesecure.md)
topic for additional information.
...
See the
[Configure Juniper Devices](/docs/auditor/10.6/configuration/networkdevices/juniper.md)
topic for additional information.
...
See the
[Configure PaloAlto Devices](/docs/auditor/10.6/configuration/networkdevices/paloalto.md)
topic for additional information.
...
See the
[Configure SonicWall Devices](/docs/auditor/10.6/configuration/networkdevices/sonicwall.md)
topic for additional information.
...
- Database 11g, limited support
    ...
    **NOTE:** See the
    [Considerations for Oracle Database 11g](/docs/auditor/10.6/configuration/oracle/overview.md#considerations-for-oracle-database-11g)
    topic for additional information.

- Oracle Database Cloud Service (Enterprise Edition)

See the [Oracle Database](/docs/auditor/10.6/configuration/oracle/overview.md)
topic for additional information.
...
See the [SharePoint](/docs/auditor/10.6/configuration/sharepoint/overview.md)
topic for additional information.
...
See the [SQL Server](/docs/auditor/10.6/configuration/sqlserver/overview.md) topic
for additional information.
...
See the [User Activity](/docs/auditor/10.6/configuration/useractivity/overview.md)
topic for additional information.
...
See the [VMware](/docs/auditor/10.6/configuration/vmware/overview.md) topic for
...
See the
[Windows Server](/docs/auditor/10.6/configuration/windowsserver/overview.md) topic
for additional information.
...
- [Active Directory](/docs/auditor/10.6/configuration/activedirectory/overview.md)
- [AD FS](/docs/auditor/10.6/configuration/activedirectoryfederatedservices/overview.md)
- [Exchange](/docs/auditor/10.6/configuration/exchange/overview.md)
- [File Servers](/docs/auditor/10.6/configuration/fileservers/overview.md)

    - [Dell Data Storage](/docs/auditor/10.6/configuration/fileservers/delldatastorage/overview.md)
    - [Dell Isilon/PowerScale](/docs/auditor/10.6/configuration/fileservers/dellisilon/overview.md)
    - [NetApp Data ONTAP](/docs/auditor/10.6/configuration/fileservers/netappcmode/overview.md)
    - [Nutanix](/docs/auditor/10.6/configuration/fileservers/nutanix/overview.md)
    - [Qumulo](/docs/auditor/10.6/configuration/fileservers/qumulo/overview.md)
    - [Synology](/docs/auditor/10.6/configuration/fileservers/synology/overview.md)
    - [Windows File Servers](/docs/auditor/10.6/configuration/fileservers/windows/overview.md)
...
- [Microsoft 365](/docs/auditor/10.6/configuration/microsoft365/overview.md)
...
- [Network Devices](/docs/auditor/10.6/configuration/networkdevices/overview.md)
- [Oracle Database](/docs/auditor/10.6/configuration/oracle/overview.md)
- [SharePoint](/docs/auditor/10.6/configuration/sharepoint/overview.md)
- [SQL Server](/docs/auditor/10.6/configuration/sqlserver/overview.md)
- [User Activity](/docs/auditor/10.6/configuration/useractivity/overview.md)
- [VMware](/docs/auditor/10.6/configuration/vmware/overview.md)
