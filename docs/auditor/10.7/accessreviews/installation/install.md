...
**NOTE:** See the [Database Page](/docs/auditor/10.7/accessreviews/admin/configuration/database.md) topic for additional
information.
...
the [First Launch](/docs/auditor/10.7/accessreviews/admin/firstlaunch.md) topic for next steps.
