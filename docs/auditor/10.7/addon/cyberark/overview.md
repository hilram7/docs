...
2. On the CyberArk server, the administrator opens the **dbparam.ini** file and specifies the
   ...
   of events to be monitored, etc.
    ...
    See the [Monitored Events](/docs/auditor/10.7/addon/cyberark/monitoredevents.md) topic for additional information on the events
...
- If you are using Netwrix Auditor for Network Devices, the 514 UDP port may be already in use, and
  ...
  [Deploy the Add-On](/docs/auditor/10.7/addon/cyberark/deployment.md) and [Add-On Parameters](/docs/auditor/10.7/addon/cyberark/parameters.md) topics for additional
