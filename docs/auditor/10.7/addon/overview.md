...
Refer to [Security](/docs/auditor/10.7/api/security.md) for detailed instructions on how to assign a new certificate
...
![api_thumb_0_0](/images/auditor/10.7/addon/api_thumb_0_0.webp)
