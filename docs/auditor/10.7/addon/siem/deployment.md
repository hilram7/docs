...
[Configuration](/docs/auditor/10.7/addon/siem/configure.md) topic for additional information.
...
[Configure a Response Action for Alert](/docs/auditor/10.7/admin/alertsettings/responseaction.md) topic for
