...
- Risk score by top 5 users – Shows potentially harmful users for the selected time period (7 days
  ...
  [Behavior Anomalies](/docs/auditor/10.7/admin/behavioranomalies/overview.md) topic for additional information.
...
[Review User Profiles and Process Anomalies](/docs/auditor/10.7/admin/behavioranomalies/userprofile.md) topic for
