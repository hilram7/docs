...
[Notifications](/docs/auditor/10.7/admin/settings/notifications.md) settings. Email content is very similar to data
presented in the [Health Status Dashboard](/docs/auditor/10.7/admin/healthstatus/dashboard/overview.md).
