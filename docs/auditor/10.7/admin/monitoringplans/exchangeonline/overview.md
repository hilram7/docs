...
- [Exchange Online](/docs/auditor/10.7/configuration/microsoft365/exchangeonline/overview.md) – Configure data
...
| Configure audit settings                           | See the [Exchange Online](/docs/auditor/10.7/configuration/microsoft365/exchangeonline/overview.md) configuration topic for additional information about audit settings required to collect comprehensive audit data and the instructions on how to configure them. |
...
See the [Microsoft 365](/docs/auditor/10.7/configuration/microsoft365/overview.md) topic for additional
information.
