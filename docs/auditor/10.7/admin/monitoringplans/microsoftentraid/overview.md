...
- [Microsoft Entra ID](/docs/auditor/10.7/configuration/microsoft365/microsoftentraid/overview.md) – Configure
...
- Integration with the Netwrix Privilege Secure. See the
  [Netwrix Privilege Secure](/docs/auditor/10.7/admin/settings/privilegesecure.md) and How to Add Microsoft Entra ID
