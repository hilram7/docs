...
To learn how to subscribe to a report, see [Create Subscriptions](/docs/auditor/10.7/admin/subscriptions/create.md).
...
2. For SSRS-based reports - verify that SSRS (SQL Server Reporting Services) settings are configured
   properly. See the [Audit Database](/docs/auditor/10.7/admin/settings/auditdatabase.md) topic for additional
   information.
