...
- For the existing monitoring plan, modify data collection settings for Active Directory data
  ...
  See the [Manage Data Sources](/docs/auditor/10.7/admin/monitoringplans/datasources.md) and
  [Active Directory](/docs/auditor/10.7/admin/monitoringplans/activedirectory/overview.md) topics for additional
  information.
- For both new and existing monitoring plans, you can click **Launch Audit Configuration Assistant**
  ...
  [Audit Configuration Assistant](/docs/auditor/10.7/tools/auditconfigurationassistant.md) topic for additional
  information.
