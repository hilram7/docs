...
- [Configure Audit Settings for CIFS File Shares](/docs/auditor/10.7/configuration/fileservers/netappcmode/cifs.md)
...
[Configure Audit Settings for CIFS File Shares](/docs/auditor/10.7/configuration/fileservers/netappcmode/cifs.md) topic for additional information.
