...
- The **Manage auditing and security log** and Backup files and directories policies must be defined
  ...
  [Permissions for Active Directory Auditing](/docs/auditor/10.7/configuration/activedirectory/permissions.md) and topics for
...
- [Use Group Managed Service Account (gMSA)](/docs/auditor/10.7/requirements/gmsa.md)
