...
- [Oracle Database](/docs/auditor/10.8/configuration/oracle/overview.md) – Configure data source as required
  to be monitored
...
2. Netwrix administrator does the following:
    ...
    - Configures alerts related to Oracle data source. Current version does not include predefined
      alerts for that data source, so follow the [Create Alerts](/docs/auditor/10.8/admin/alertsettings/create/create.md)
