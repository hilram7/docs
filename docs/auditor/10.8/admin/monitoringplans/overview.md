...
- [Supported Data Sources](/docs/auditor/10.8/requirements/supporteddatasources/supporteddatasources.md) – Configure data source as
...
example, see [VMware](/docs/auditor/10.8/admin/monitoringplans/vmware/overview.md)).
...
See the [Role-Based Access and Delegation](/docs/auditor/10.8/admin/monitoringplans/delegation.md) topic for additional information.
