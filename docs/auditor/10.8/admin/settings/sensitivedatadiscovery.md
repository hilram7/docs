...
[Data Discovery and Classification Reports](/docs/auditor/10.8/admin/reports/types/datadiscoveryclassification.md).
...
- Use filtering capabilities to narrow your search results. See the
  [Use Filters in Advanced Mode](/docs/auditor/10.8/admin/search/filteradvanced.md) topic for additional information.
...
[Alerts](/docs/auditor/10.8/admin/alertsettings/overview.md) topic for additional information.
