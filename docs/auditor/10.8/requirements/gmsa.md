...
- As a data collecting account for the following data sources:
    ...
    See the [Data Collecting Account](/docs/auditor/10.8/admin/monitoringplans/dataaccounts.md) topic for additional
...
- As an account for accessing Long-Term archive. See the
  [File-Based Repository for Long-Term Archive](/docs/auditor/10.8/requirements/longtermarchive.md) topic for additional
  information.
...
- If you are going to use a gMSA as a data collecting account in Auditor, add this account to the
  ...
  depending on the data source you want to collect data from:
    ...
    - [Permissions for Windows Server Auditing ](/docs/auditor/10.8/configuration/windowsserver/permissions.md)
...
[Long-Term Archive](/docs/auditor/10.8/admin/settings/longtermarchive.md) topic for additional information.
...
the [Fine-Tune Your Plan and Edit Settings](/docs/auditor/10.8/admin/monitoringplans/finetune.md) topic for
