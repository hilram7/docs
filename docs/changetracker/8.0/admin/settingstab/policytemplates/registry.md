...
![PolicyTemplateRegistry](/images/changetracker/8.0/admin/settings/policytemplates/policytemplateregistry.webp)
...
the[Registry Inclusion/Exclusion Match Rules ](/docs/changetracker/8.0/admin/matchrules/registryrules.md)
