...
acknowledged then used to create new Planned Change rules.

**Step 1 –** Select a Device Group or All Devices then check any Devices to view events.

**Step 2 –** Make sure the ‘**Device Group**’ selector, found in the top left-hand corner of the
screen shows ‘All Devices’ and check the ‘**Automatically refresh page**’ box.

**Step 3 –** Click **Filter** to precisely focus on events of interest – specify time range,
...
report or re-useable query for users. See the [Reports Tab](/docs/changetracker/8.1/admin/reportstab/reportstab.md) topic for additional
information.
