...
![ConfigTemplatesFIMFiles](/images/changetracker/8.1/admin/settings/policytemplates/configtemplatesfimfiles.webp)
...
:::note
For Advanced Options: see [Appendix B](/docs/changetracker/8.1/admin/matchrulesoverview/filefolderrules.md) for more
information.
