...
- [Installing Express Agent for Solaris (SPARC and Intel) ](/docs/changetracker/8.1/install/agent/solaris.md)
- [Installing Express Agent for AIX](/docs/changetracker/8.1/install/agent/aix.md)
- [ Agent First Run](/docs/changetracker/8.1/install/agent/firstrun.md)
