...
![Software Requirements](/images/changetracker/8.1/requirements/performancecheckbox.webp)
...
- See the [Installation](/docs/changetracker/8.1/install/overview.md) topic for additional information on the
