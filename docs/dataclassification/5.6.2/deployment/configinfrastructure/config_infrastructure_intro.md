...
description: "Configure IT Infrastructure"
sidebar_position: 70
---
...
- [Configure Dropbox for Crawling](/docs/dataclassification/5.6.2/deployment/configinfrastructure/config_dropbox.md)
- [Configure Microsoft Exchange for Crawling and Classification](/docs/dataclassification/5.6.2/deployment/configinfrastructure/configureexchange/configure_exchange.md)
