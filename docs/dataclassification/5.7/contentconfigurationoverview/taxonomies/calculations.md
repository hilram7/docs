...
3. Select Browse.
    ...
    ![calculationscalculatoricon](/images/dataclassification/5.7/admin/taxonomies/calculationscalculatoricon.webp)

4. On the classified file, click the Calculator icon. You shall see how the classification scores
   are calculated.

    ![calculations](/images/dataclassification/5.7/admin/taxonomies/calculations.webp)
