...
![workflow_step3_condition](/images/dataclassification/5.7/admin/workflows/workflow_step3_condition.webp)
...
![workflow_step3_filter_blue_thumb_0_0](/images/dataclassification/5.7/admin/workflows/workflow_step3_filter_blue_thumb_0_0.webp)

- Excluding filters (i.e. instructing to include documents without classification tag you selected)
  are colored red:

![workflow_step3_filter_red_thumb_0_0](/images/dataclassification/5.7/admin/workflows/workflow_step3_filter_red_thumb_0_0.webp)
...
![workflow_step3_example_thumb_0_0](/images/dataclassification/5.7/admin/workflows/workflow_step3_example_thumb_0_0.webp)
