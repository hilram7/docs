...
![sensitive_dashboard_thumb_0_0](/images/dataclassification/5.7/admin/reporting/sensitive_dashboard_thumb_0_0.webp)
...
- Locate the Data Analysis top level menu and select Reports:
    ...
    ![switch_dashboard](/images/dataclassification/5.7/admin/reporting/switch_dashboard.webp)
...
1. Select Custom view in the upper left corner of the dashboard.
    ...
    ![dashboard_filters_thumb_0_0](/images/dataclassification/5.7/admin/reporting/dashboard_filters_thumb_0_0.webp)
