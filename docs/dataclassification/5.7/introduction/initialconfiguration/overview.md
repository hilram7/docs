...
description: "Initial Product Configuration"
sidebar_position: 80
---
...
![initial_config](/images/dataclassification/5.7/install/initialconfiguration/initial_config.webp)

Click Next to proceed. See also:

- [Select Processing Mode](/docs/dataclassification/5.7/introduction/initialconfiguration/modes.md)
- [Processing Settings](/docs/dataclassification/5.7/introduction/initialconfiguration/processingsettings.md)
- [Add Taxonomy](/docs/dataclassification/5.7/introduction/initialconfiguration/taxonomies.md)
