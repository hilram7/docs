...
![run_cleaner_thumb_0_0](/images/dataclassification/5.7/admin/utilities/run_cleaner_thumb_0_0.webp)

See next:

- [Step 1: Maintenance Operation](/docs/dataclassification/5.7/systemconfigurationoverview/administration/indexmaintenance/step1.md)
