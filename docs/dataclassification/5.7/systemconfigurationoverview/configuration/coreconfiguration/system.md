...
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| **General settings**             |                                                                                                                                                                                                        |                                                                                                            |
| Log Level                        | Defines logging level that should be persisted to the log targets. Possible options: <ul><li>**Errors**</li><li>**Errors & Warnings**</li><li>**Errors Warnings & Info**</li><li>**Verbose**</li></ul> |                                                                                                            |
