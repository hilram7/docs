...
[File Server Details ](/docs/directorymanager/11.0/signin/entitlement/manage.md#file-server-details)
...
store. Refer to the
[Search File Servers ](/docs/directorymanager/11.0/signin/entitlement/manage.md#search-file-servers)
