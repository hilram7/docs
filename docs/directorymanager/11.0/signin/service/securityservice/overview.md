...
See [Data Service](/docs/directorymanager/11.0/signin/service/dataservice/overview.md)
topic.

## Why Create Multiple Security Services?

See the
[Why Create Multiple Data Services?](/docs/directorymanager/11.0/signin/service/dataservice/overview.md#why-create-multiple-data-services)
