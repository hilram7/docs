...
See the
[What Happens When a Group is Deleted](/docs/directorymanager/11.0/signin/identitystore/configure/groupexpirydeletion.md#what-happens-when-a-group-is-deleted)
