...
1. [Directory Search](/docs/directorymanager/11.0/welcome/generalfeatures/search.md) the group(s) you
   want to join.
...
1. In GroupID portal, click **Groups** in the left navigation pane, select Groups.
    ...
    [Directory Search](/docs/directorymanager/11.0/welcome/generalfeatures/search.md) the group(s)
    you want to leave.
