...
4. On the
   ...
   the **Owner** box displays the group's primary owner.
    ...
    [Find Dialog Box](/docs/directorymanager/11.0/welcome/generalfeatures/find.md), where you can
...
5. Enter a search string to locate the object to add as an additional owner, or click **Advanced**
   to use the [Find Dialog Box](/docs/directorymanager/11.0/welcome/generalfeatures/find.md) for
   performing a search.
...
1. In GroupID portal, click **Groups** in the left navigation pane, select **My Groups**.
    ...
    [Directory Search](/docs/directorymanager/11.0/welcome/generalfeatures/search.md) a group to
...
4. See
   [Import Additional Owners](/docs/directorymanager/11.0/welcome/group/properties/importadditionalowners.md)
