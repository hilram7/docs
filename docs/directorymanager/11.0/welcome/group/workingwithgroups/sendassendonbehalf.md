...
[Group Properties](/docs/directorymanager/11.0/welcome/group/properties/overview.md). They
are displayed as:

![sendassendon](/images/directorymanager/11.0/portal/group/manage/sendassendon.webp)
