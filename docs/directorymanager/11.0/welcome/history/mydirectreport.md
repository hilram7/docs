...
pages i.e.[My History](/docs/directorymanager/11.0/welcome/history/myhistory.md), My Direct
Reports' History and
[My Groups' History](/docs/directorymanager/11.0/welcome/history/mydirectorygroup.md) pages.
