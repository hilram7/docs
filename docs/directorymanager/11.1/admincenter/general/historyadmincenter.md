...
page. Refer to the [Filter History Data](/docs/directorymanager/11.1/admincenter/identitystore/view/view.md#filter-history-data) topic
...
[Navigate Through History Items](/docs/directorymanager/11.1/admincenter/identitystore/view/view.md#navigate-through-history-items)
topic for help.
...
2. On the **Admin Center History** page, click a history item and proceed to add a note. See the
   [Annotate History Items](/docs/directorymanager/11.1/admincenter/identitystore/view/details.md#annotate-history-items) topic for
   details.
