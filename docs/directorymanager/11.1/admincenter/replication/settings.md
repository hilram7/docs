...
2. On the **Replication** page, click **Elasticsearch Health Monitor**.
    ...
    ![es_health_monitor](/images/directorymanager/11.1/admincenter/replication/es_health_monitor.webp)
...
4. Click a cluster name to view it in detail.
    ...
    ![cluster_info](/images/directorymanager/11.1/admincenter/replication/cluster_info.webp)
...
[Manage Local Replication Settings](/docs/directorymanager/11.1/admincenter/identitystore/replication.md) topic.
