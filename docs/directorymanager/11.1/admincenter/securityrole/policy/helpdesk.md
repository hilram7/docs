...
in Directory Manager. Moreover, they can view the actions that users perform in the identity store,
...
- To change the container – Click **Modify Container** and use the **Add Container** dialog box to
