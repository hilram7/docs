...
[Register an Application (Service Provider) in Directory Manager](/docs/directorymanager/11.1/authenticate/asidentityprovider/register.md) topic for additional
information.
