...
![App registeration page](/images/directorymanager/11.1/configureentraid/register/app_registeration.webp)
...
![Register an application](/images/directorymanager/11.1/configureentraid/register/register_an_application.webp)

Step 4 – The **Overview** page is displayed. Copy the Application (client) ID and keep it safe.

![Overview page](/images/directorymanager/11.1/configureentraid/register/app_registeration_overview.webp)

Step 5 – Go to the **Authentication** node and set it as follows:

![Authenticate node](/images/directorymanager/11.1/configureentraid/register/authenticate_node.webp)
...
[Certificate for Entra ID Authentication ](/docs/directorymanager/11.1/configureentraid/register/modauth.md)topic for additional information.

![Certificate & secrets page](/images/directorymanager/11.1/configureentraid/register/pfxcertifupload.webp)
...
![Roles and Administration page](/images/directorymanager/11.1/configureentraid/register/roles_and_administration.webp)
...
- **Global administrator**: For Global administrator, type global to filter out the Global
  administrator role. Click **Global administrator**.
    ...
    ![All roles page](/images/directorymanager/11.1/configureentraid/register/all_roles.webp)
    ...
    ![Add assignment page](/images/directorymanager/11.1/configureentraid/register/add_assignment.webp)
...
![API Permission page](/images/directorymanager/11.1/configureentraid/register/add_a_permission.webp)

Step 13 – The Request API permissions page opens. Click the **Microsoft Graph** API tab.

![Request API permissions page](/images/directorymanager/11.1/configureentraid/register/request_api_permissions.webp)
...
![Office 365 Exchange Online API](/images/directorymanager/11.1/configureentraid/register/office365_permission.webp)
...
![SharePoint API card](/images/directorymanager/11.1/configureentraid/register/sharepoint_api_card.webp)

Step 17 – Select the **Delegated permissions** tab:

![SharePoint Delegated permissions](/images/directorymanager/11.1/configureentraid/register/sharepoint_delegated_permissions.webp)
