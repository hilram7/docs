...
- [Add-GroupMember](/docs/directorymanager/11.1/managementshell/membership/addgroupmember.md) – adds objects to the membership of a group.
- [Get-GroupMember](/docs/directorymanager/11.1/managementshell/membership/getgroupmember.md) – retrieves members of a group.
