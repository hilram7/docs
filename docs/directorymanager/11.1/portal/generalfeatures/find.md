...
From the search results, select the required objects and click the right-arrow to move them to the
Selected Results list.

Step 7 – The Selected Results section displays the objects that you have selected from the **Search
Results** list.
