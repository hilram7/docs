...
deleted groups, select the [Expired Groups](/docs/directorymanager/11.1/portal/group/allgroups/allexpiredgroups.md) or
[Deleted Groups](/docs/directorymanager/11.1/portal/group/recyclebin/overview.md) respectively.
