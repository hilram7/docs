...
[Modify alias and display name templates](/docs/directorymanager/11.1/portal/group/workingwithgroups/dynastyfunction.md#modify-alias-and-display-name-templates).
