...
member, or click **Advance** to use the [Find Dialog Box](/docs/directorymanager/11.1/portal/generalfeatures/find.md) for performing a
search.
...
[Import Group Members](/docs/directorymanager/11.1/portal/group/properties/importmembers.md) for information and instructions.
...
[Export group members](/docs/directorymanager/11.1/portal/group/workingwithgroups/groupmembershipfunction.md#export-group-members).
