...
1. On the left navigation bar, click **Groups** and then select the **My Groups** tab.
    ...
    You can also [Directory Search](/docs/directorymanager/11.1/portal/generalfeatures/search.md) the Organizational, Organizational, or
...
1. On the left navigation bar, click **Groups** and then select the **My Groups** tab.
    ...
    You can also [Directory Search](/docs/directorymanager/11.1/portal/generalfeatures/search.md) the Managerial Dynasty you want to
    restructure.
...
1. On the left navigation bar, click **Groups** and then select the **My Groups** tab.
    ...
    You can also [Directory Search](/docs/directorymanager/11.1/portal/generalfeatures/search.md) the Dynasty you want to change the
...
1. On the left navigation bar, click **Groups** and then select the **My Groups** tab.
    ...
    You can also [Directory Search](/docs/directorymanager/11.1/portal/generalfeatures/search.md) the Dynasty you want to change the alias
...
3. On the **Dynasty Options** tab, use the **Alias Template** and **Display Name Template** boxes to
   modify the respective templates.
    ...
    For details, see [Alias Template](/docs/directorymanager/11.1/portal/group/properties/dynastyoptions.md) and
    [Display Name Template](/docs/directorymanager/11.1/portal/group/properties/dynastyoptions.md) for an
