...
Step 1 – Click **My History Grid Filter** to specify a criteria for filtering history data.
...
Step 6 – Click **Reset Filter** to remove all the filters.
...
Step 8 – On the Add Note dialog box, write a note and click **Add Note** to save it.
