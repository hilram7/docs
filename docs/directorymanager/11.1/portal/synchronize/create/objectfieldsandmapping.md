   ...
   **Add Now** to select a messaging system you want to use with this job. You need to select from
   the two options:
    ...
    - **Add New Provider**
        ...
        - [Google Workspace Subscription](/docs/directorymanager/11.1/portal/synchronize/create/messagingsystemoverview/googleapp.md)

            Add connection details for Google Workspace.

        - [Office 365 Subscription](/docs/directorymanager/11.1/portal/synchronize/create/messagingsystemoverview/office365.md)

            Add Connection details for Office 365.

        - [Exchange Subscription](/docs/directorymanager/11.1/portal/synchronize/create/messagingsystemoverview/exchange.md)
...
3. In the **Script Language** section, specify the scripting language you want to use. Select one of
   the following language:
    ...
    - [Visual Basic .NET for Directory Manager (formerly GroupID)](/docs/directorymanager/11.1/portal/synchronize/dtmscript/visualbasicnetbasic.md)
...
4. The Global Script Editor allows the script author to extend the functionality of Synchronize by
   ...
   verified by compiling the script. Click on **Edit Global Script,**and follow these steps:
    ...
    7. The toolbar displays various actions that you can perform on your script:
        ...
        | Icon                                                                                                           | Description                                            |
        | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
        | ![undo](/images/directorymanager/11.1/portal/synchronize/job/undo.webp)             | Reverses the last change.                              |
        | ![redo](/images/directorymanager/11.1/portal/synchronize/job/redo.webp)             | Re-applies a change reversed using the Undo action.    |
        | ![indent](/images/directorymanager/11.1/portal/synchronize/job/indent.webp)         | Increases the indenting of the current text selection. |
        | ![outdent](/images/directorymanager/11.1/portal/synchronize/job/outdent.webp)       | Decreases the indenting of the current text selection. |
        | ![comment](/images/directorymanager/11.1/portal/synchronize/job/comment.webp)       | Comments the current text selection.                   |
        | ![uncomment](/images/directorymanager/11.1/portal/synchronize/job/uncomment.webp)   | Uncomments the current text selection.                 |
        | ![uppercase](/images/directorymanager/11.1/portal/synchronize/job/uppercase.webp)   | Converts the current text selection to uppercase.      |
        | ![lowercase](/images/directorymanager/11.1/portal/synchronize/job/lowercase.webp)   | Converts the current text selection to lowercase.      |
        | ![darktheme](/images/directorymanager/11.1/portal/synchronize/job/darktheme.webp)   | Switch the theme of the script editor to dark.         |
        | ![lighttheme](/images/directorymanager/11.1/portal/synchronize/job/lighttheme.webp) | Switch the theme of the script editor to light.        |
        | ![selectall](/images/directorymanager/11.1/portal/synchronize/job/selectall.webp)   | Selects all the text in the editor.                    |
...
6. Use the **Map Field** section to map the source and destination fields and to apply
   transformations:
    ...
    1. In the **Key** column, select at least one field to be a unique identifier.
        ...
        - [Map Fields](/docs/directorymanager/11.1/portal/synchronize/create/mappingfield.md)

            In the Source column of each destination item, select the source fields that contribute
            the data for the destination.

        - **Apply a [Transform](/docs/directorymanager/11.1/portal/synchronize/transformation/overview.md)**
