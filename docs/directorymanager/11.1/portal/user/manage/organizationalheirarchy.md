...
organizational hierarchy you want to view on the [Directory Search](/docs/directorymanager/11.1/portal/generalfeatures/search.md) dialog
box.
...
On the [Find Dialog Box](/docs/directorymanager/11.1/portal/generalfeatures/find.md), search and select the required user and click
