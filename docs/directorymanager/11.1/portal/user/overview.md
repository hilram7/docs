...
- Delegate user management to end users by enabling them to:
    ...
    - Create and manage users, contacts, and mailboxes in the directory. See the
      [ Create User Objects](/docs/directorymanager/11.1/portal/user/create/overview.md) topic.
    - Manage their direct reports. See the [Update your Direct Reports](/docs/directorymanager/11.1/portal/user/manage/directreport.md)
      topic.
