...
[license key](/docs/identitymanager/6.1/integration-guide/network-configuration/server-configuration/general-purpose/index.md)
provided by NETWRIX.
...
[roles](/docs/identitymanager/6.1/installation-guide/requirements/database-requirements/index.md),
including necessarily either `sysadmin` or `securityadmin`.

For more information, see the
[server installation procedure](/docs/identitymanager/6.1/installation-guide/production-ready/server/index.md).
...
[The on-premise SSL certificate must be set up in IIS](/docs/identitymanager/6.1/installation-guide/production-ready/server/index.md).
