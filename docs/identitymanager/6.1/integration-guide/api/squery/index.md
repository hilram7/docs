...
optionally specified by the squery parameter.

### Grammar

Here's the query language's formal description. See the
[EBNF syntax ](https://en.wikipedia.org/wiki/Extended_Backus%E2%80%93Naur_form)for additional
information.
...
Provides information about data stored in Usercube at any point in time, rather than only the data
