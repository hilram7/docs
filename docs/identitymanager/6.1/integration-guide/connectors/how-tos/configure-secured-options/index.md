...
1. Among a connection's parameters, identify the secured option:
    ...
    - for a simple field:
        ...
        ![AD creation](/images/identitymanager/6.1/integration-guide/connectors/how-tos/configure-secured-options/securedoptions_adlogin_v603.webp)

    - for multiple key-value fields:

        ![SQL connection string](/images/identitymanager/6.1/integration-guide/connectors/how-tos/configure-secured-options/securedoptions_keyvalue_v603.webp)
...
2. Fill the field(s) and, if needed, click on the eye icon to make the content visible.
    ...
    > hidden with ??????:
    >
    > ![Login Secured Options Hidden](/images/identitymanager/6.1/integration-guide/connectors/how-tos/configure-secured-options/securedoptions_adexample_v603.webp)
    >
    > ![Login Secured Options Revealed](/images/identitymanager/6.1/integration-guide/connectors/how-tos/configure-secured-options/securedoptions_adexamplevisible_v603.webp)
    ...
    >
    > ![SQL connection string](/images/identitymanager/6.1/integration-guide/connectors/how-tos/configure-secured-options/securedoptions_sqlexample1_v603.webp)
    >
    > In this example, the database name and the minimal pool size are secured options:
    >
    > ![SQL Secured option filled](/images/identitymanager/6.1/integration-guide/connectors/how-tos/configure-secured-options/securedoptions_sqlexample2_v603.webp)

    > Another example of multiple key-value fields in a Powershell connection:
    >
    > ![Powershell Secured option hidden](/images/identitymanager/6.1/integration-guide/connectors/how-tos/configure-secured-options/securedoptions_powershellexample_v603.webp)
