...
- A list of users, accessible by clicking on **Users** at the top of the page. It is possible to add
  a user by clicking on **Create New User**.
    ...
    ![Users list](/images/identitymanager/6.1/integration-guide/connectors/how-tos/demoapp-banking/demoapps_banking_userslist.webp)
...
- A user's details page for each user, accessible by clicking on **Details** on a user in the users
  list.
    ...
    ![User details](/images/identitymanager/6.1/integration-guide/connectors/how-tos/demoapp-banking/demoapps_banking_userdetails.webp)
