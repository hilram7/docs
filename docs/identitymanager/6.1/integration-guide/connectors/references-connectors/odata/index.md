...
This page is about
[Custom/OData](/docs/identitymanager/6.1/integration-guide/connectors/references-packages/odata/index.md).

![Package: Custom/OData](/images/identitymanager/6.1/integration-guide/connectors/references-connectors/odata/packages_odata_v603.webp)
...
- an
  [entity type mapping](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/connectors/entitytypemapping/index.md):
...
- an
  [entity association mapping](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/connectors/entityassociationmapping/index.md):
