...
![okta](/images/identitymanager/6.1/integration-guide/connectors/references-connectors/okta/okta.webp)
...
**Step 1 –** Create a new user for Netwrix Usercube.
...
**Step 3 –** Generate a Token for the Netwrix Usercube user.
