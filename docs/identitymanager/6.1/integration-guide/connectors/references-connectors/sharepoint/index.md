...
![Package: Storage/SharePoint](/images/identitymanager/6.1/integration-guide/connectors/references-connectors/sharepoint/packages_sharepoint_v603.webp)
...
(ListItem) with the account [account.example@usercube.com](mailto:account.example@usercube.com):
...
Usercube's fulfill functionality can add and remove members from existing SharePoint groups.
