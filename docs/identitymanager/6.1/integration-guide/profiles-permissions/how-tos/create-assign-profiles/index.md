...
## Configure the Usercube-Set-InternalUserProfiles Task
...
Here the TaskEntityType is the reference to connect to Usercube and the ResourceType is the same as
in the ProfileRuleContext. Once this configuration is done you can add the task in the job which
provisions the Connector AD.
