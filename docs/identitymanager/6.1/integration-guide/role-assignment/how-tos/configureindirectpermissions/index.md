...
[indirect permissions](/docs/identitymanager/6.1/integration-guide/role-assignment/indirectpermissions/index.md).
...
![Group Membership Schema](/images/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/indirectpermissionsadexample.webp)
...
![Single Role Configuration Example](/images/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/srconf_5.2.1.webp)

We will also create a test Composite Role to showcase indirect Composite Roles. We will name it ```TestCRoleAB```:

![Composite Role Configuration](/images/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/crconf_5.2.1.webp)
...
![Navigation Rule Example](/images/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/navrule_5.2.1.webp)

And finally, we need to add Single Role Rules to link our two previously created Single Roles to the new Composite Role:

![Single Role Rule Example](/images/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/srrule_5.2.1.webp)

Even if two rules of a kind are needed, only one is pictured. Do not forget the other one.

#### Indirect permission display

After running a [Compute Role Model](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index.md) task, Indirect Permissions should now appear for your test user.
...
![View Permissions Simplified](/images/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/viewpermissionssimplified_5.2.1.webp)

To display Indirect Permissions, you need to switch over to the ```Advanced view```. ```TestRoleA``` and ```TestRoleB``` should then appear:

![View Permissions Advanced](/images/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/viewpermissionsadvanced_5.2.1.webp)
...
![AD Assigned Resource Navigations](/images/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/adassignednavigations_5.2.1.webp)
