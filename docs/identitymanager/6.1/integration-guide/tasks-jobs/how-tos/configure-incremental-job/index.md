...
[See an example of a full incremental job](/docs/identitymanager/6.1/integration-guide/tasks-jobs/how-tos/jobfast/index.md).
...
2. Tag all changed resources by running
   [`SetRecentlyModifiedFlagTask`](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/jobs/tasks/server/setrecentlymodifiedflagtask/index.md)
