...
[See the details of the export executable `Usercube-Export-Configuration`](/docs/identitymanager/6.1/integration-guide/executables/references/export-configuration/index.md).
...
[See the details of the prepare-synchronization executable `Usercube-Prepare-Synchronization`](/docs/identitymanager/6.1/integration-guide/executables/references/prepare-synchronization/index.md).
...
When at least one
[synchronization threshold](/docs/identitymanager/6.1/integration-guide/synchronization/synchro-thresholds/index.md)
