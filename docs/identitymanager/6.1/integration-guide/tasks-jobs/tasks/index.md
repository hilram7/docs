...
> [See the list of all available tasks](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/jobs/tasks/index.md).

[See how to configure tasks](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/jobs/tasks/index.md).
