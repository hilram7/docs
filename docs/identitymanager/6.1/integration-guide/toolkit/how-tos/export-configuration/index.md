...
[See more details on configuration export](/docs/identitymanager/6.1/integration-guide/executables/references/export-configuration/index.md).

## Export the Configuration Locally

Export your configuration by using the
[`Export-Configuration` executable](/docs/identitymanager/6.1/integration-guide/executables/references/export-configuration/index.md)
