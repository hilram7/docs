...
- #### [Deploy the Configuration](/docs/identitymanager/6.1/integration-guide/toolkit/how-tos/deploy-configuration/index.md)
    Import the XML configuration to build and use the Usercube application.- ####
    [Export the Configuration](/docs/identitymanager/6.1/integration-guide/toolkit/how-tos/export-configuration/index.md)
