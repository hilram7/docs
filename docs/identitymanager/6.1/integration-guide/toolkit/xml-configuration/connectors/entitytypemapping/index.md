...
[See the example of a whole connector containing an entity type mapping](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/connectors/connector/index.md).
