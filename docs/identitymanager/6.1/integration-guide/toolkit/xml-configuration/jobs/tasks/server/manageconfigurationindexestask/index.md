...
tool[Usercube-Manage-ConfigurationDependantIndexes](/docs/identitymanager/6.1/integration-guide/executables/references/manage-configurationdependantindexes/index.md).
