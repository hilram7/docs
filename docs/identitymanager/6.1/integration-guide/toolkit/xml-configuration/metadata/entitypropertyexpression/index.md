...
[C#](/docs/identitymanager/6.1/integration-guide/toolkit/expressions/index.md) or
[literal](/docs/identitymanager/6.1/integration-guide/toolkit/expressions/index.md)
expressions.
...
| Expression optional       | **Type** String **Description** References the C# or literal expression used to compute the result. [See more details on C# expressions](/docs/identitymanager/6.1/integration-guide/toolkit/expressions/index.md). |
