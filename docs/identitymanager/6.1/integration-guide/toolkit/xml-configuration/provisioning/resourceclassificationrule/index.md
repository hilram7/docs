...
| TargetExpression optional                                  | **Type** String **Description** Defines the C# expression used to classify the resources. [See more details on C# expressions](/docs/identitymanager/6.1/integration-guide/toolkit/expressions/index.md). |
