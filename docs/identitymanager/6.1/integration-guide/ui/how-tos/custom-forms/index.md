...
[Read more about forms](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/user-interface/form/index.md).
...
- [View template](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/configuration/scaffoldings/templates/viewtemplate/index.md):
  Creates the display table, the default view and access rights to the entity.
- [Entity template:](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/configuration/scaffoldings/templates/viewtargetresourcetemplate/index.md)
...
- [MenuItem](/docs/identitymanager/6.1/integration-guide/ui/how-tos/create-menu-items/index.md)
- [Entity accessControl](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/configuration/scaffoldings/accesscontrolrules/resources/viewaccesscontrolrules/index.md)
...
[record filter](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/user-interface/form/index.md).
