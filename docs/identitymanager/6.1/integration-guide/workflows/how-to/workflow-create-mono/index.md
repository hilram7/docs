...
2. [`PersistOnlyResources`](/docs/identitymanager/6.1/integration-guide/workflows/activity-templates/index.md#persistonlyresources):
   saves the collected data to the repository without triggering provisioning.
3. [`ReviewWithFeedback`](/docs/identitymanager/6.1/integration-guide/workflows/activity-templates/index.md#reviewwithfeedback):
   reviews the creation request with the possibility of getting feedback from another user.
4. [`Persist`](/docs/identitymanager/6.1/integration-guide/workflows/activity-templates/index.md#persist):
...
[records](/docs/identitymanager/6.1/integration-guide/identity-management/joiners-movers-leavers/position-change/index.md)
...
![UI Form](/images/identitymanager/6.1/integration-guide/workflows/how-to/workflow-create-mono/howto_resourcecreationmono_form_v602.webp)
...
![UI Summary](/images/identitymanager/6.1/integration-guide/workflows/how-to/workflow-create-mono/howto_resourcecreationmono_summary_v602.webp)
...
![UI Homonym Detection](/images/identitymanager/6.1/integration-guide/workflows/how-to/workflow-create-multi/howto_resourcecreationmono_homonym_v603.webp)
