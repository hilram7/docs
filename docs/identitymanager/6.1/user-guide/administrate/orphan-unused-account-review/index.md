...
[reporting module](/docs/identitymanager/6.1/user-guide/administrate/reporting/index.md)
...
| Input                                                                                                        | Output                               |
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------ |
| [Categorization](/docs/identitymanager/6.1/user-guide/set-up/categorization/index.md) (required) | Removed orphaned and unused accounts |
