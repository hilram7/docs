...
read the [Introduction Guide](/docs/identitymanager/6.1/introduction-guide/index.md) in
...
[Integration Guide](/docs/identitymanager/6.1/integration-guide/index.md).
...
[global process](/docs/identitymanager/6.1/user-guide/global-process/index.md).
...
[global process](/docs/identitymanager/6.1/user-guide/global-process/index.md) that
