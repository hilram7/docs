...
[See troubleshooting instructions concerning connector jobs](/docs/identitymanager/6.1/integration-guide/tasks-jobs/how-tos/troubleshoot-connector-jobs/index.md).
...
| Input                                                                                                            | Output              |
| ---------------------------------------------------------------------------------------------------------------- | ------------------- |
| [Implemented system](/docs/identitymanager/6.1/user-guide/deploy/implementation/index.md) (required) | Working environment |
...
[See more details on synchronization thresholds](/docs/identitymanager/6.1/user-guide/set-up/synchronization/index.md).
