...
![Automation Concept](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_schema.webp)
...
NETWRIX recommends
[removing redundant assignments](/docs/identitymanager/6.1/user-guide/optimize/assignment-automation/remove-redundant-assignments/index.md)
...
[fulfilled](/docs/identitymanager/6.1/user-guide/administrate/provisioning/index.md)
...
- Errors can happen: human mistakes are expected in role distribution, even though largely mitigated
  by the
  [role review process](/docs/identitymanager/6.1/user-guide/administrate/non-conforming-assignment-review/role-reconciliation/index.md)
  and
  [certification campaigns](/docs/identitymanager/6.1/user-guide/administrate/access-certification/index.md).
...
![Optimal Cost Chart - Manual Assignments](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_optimalcost_manual.webp)
...
![Optimal Cost Chart - Automation Benefits](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_optimalcost_automationbenefits.webp)
...
[simulation](/docs/identitymanager/6.1/user-guide/optimize/simulation/index.md), or
...
![Optimal Cost Chart - Automation Limits](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_optimalcost_automationlimits.webp)
...
![Optimal Cost Chart](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_optimalcost.webp)
...
| Input                                                                                                                     | Output                       |
| ------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| [Role catalog](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/index.md) (required) | Ideally automated role model |

## Automate Entitlement Assignment

The process of assignment automation is the following:

1. [Perform Role Mining](/docs/identitymanager/6.1/user-guide/optimize/assignment-automation/role-mining/index.md)
   to approach the automation wall.
    ...
    ![Optimal Cost Chart - Role Mining](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_optimalcost_rolemining.webp)
...
2. Generate and analyze
   [reports](/docs/identitymanager/6.1/user-guide/administrate/reporting/index.md) with
   tools like
   [Power BI](/docs/identitymanager/6.1/user-guide/administrate/reporting/index.md) to
   assess the automation wall and identify improvement areas.
    ...
    >
    > ![Data Quality Example](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_dataquality_ex.webp)
    ...
    >
    > ![Data Quantity Example](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_dataquality_ex2.webp)
    ...
    >
    > ![Data Quality Example](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_dataquality_ex3.webp)
    ...
    >
    > ![Data Quality Example](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_dataquality_ex4.webp)
...
3. Improve data quality and quantity to move the automation wall.
    ...
    ![Optimal Cost Chart - Improved Data](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/automation_optimalcost_data.webp)
