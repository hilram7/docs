...
push the
[automation wall](/docs/identitymanager/6.1/user-guide/optimize/assignment-automation/index.md)
further.
...
[See more details about role mining](/docs/identitymanager/6.1/integration-guide/role-mining/index.md).
...
| Input                                                                                                                     | Output            |
| ------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| [Role catalog](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/index.md) (required) | Single role rules |
...
1. On the home page in the **Configuration** section, click on the **Role Mining** button.
    ...
    ![Home page - Connectors](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/role-mining/home_rolemining_v60.webp)
...
2. Click on the addition button at the top right and fill in the fields.
    ...
    ![New Mining Rule](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/role-mining/rolemining_miningrule_v602.webp)
...
4. Click on **Simulate** to perfom role mining in a
   [simulation](/docs/identitymanager/6.1/user-guide/optimize/simulation/index.md).
    ...
    ![Role Mining Jobs](/images/identitymanager/6.1/user-guide/optimize/assignment-automation/role-mining/rolemining_launchjob_v602.webp)
