...
inside a [connector](/docs/identitymanager/6.1/integration-guide/connectors/index.md)
...
| Input                                                                                                                                                                                                                                                                    | Output        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------- |
| [Connector container](/docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-declaration/index.md) (required) [Connector model](/docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/index.md) (required) | Connection(s) |
...
1. Click on the addition button in the **Connections** frame on the connector's summary page.
    ...
    ![Add a New Connection](/images/identitymanager/6.1/user-guide/set-up/connect-system/connection-creation/connection_newconnection_v602.webp)
...
2. Fill in the connection information fields on the left, then [select a package](#select-a-package)
   (AD, CSV, etc.) and fill the associated agent settings on the right.
    ...
    ![Connection Creation](/images/identitymanager/6.1/user-guide/set-up/connect-system/connection-creation/connectioncreation_connectioncreation_v602.webp)
...
- Do we need
  [incremental or complete](/docs/identitymanager/6.1/integration-guide/tasks-jobs/jobs/index.md)[synchronizations](/docs/identitymanager/6.1/user-guide/set-up/synchronization/index.md),
  or both?

    [Incremental synchronizations](/docs/identitymanager/6.1/integration-guide/synchronization/upward-data-sync/index.md),
    usually launched approximatively every two hours, are to be performed for real-time needs, while
    [complete synchronizations](/docs/identitymanager/6.1/integration-guide/synchronization/upward-data-sync/index.md),
...
[secured options](/docs/identitymanager/6.1/integration-guide/connectors/configuration-details/connections/index.md#secured-options)
...
1. click on **Check Connection** to ensure that Usercube can reach the managed system;
    ...
    ![Check Connection](/images/identitymanager/6.1/user-guide/set-up/connect-system/connection-creation/connectioncreation_checkconnection_v602.webp)

    Some connectors have both
    [incremental and complete](/docs/identitymanager/6.1/integration-guide/tasks-jobs/jobs/index.md)
...
![Schema Not Recovered](/images/identitymanager/6.1/user-guide/set-up/connect-system/connection-creation/connection_notrecovered_v523.webp)
