...
configuration:
[entity type creation](/docs/identitymanager/6.1/user-guide/set-up/connect-system/entity-type-creation/index.md).
...
[single role catalog creation](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/index.md).
...
5. Ensure the following guidelines' enforcement:
    ...
    **Keep it readable for most users**
    ...
    ([synchronization](/docs/identitymanager/6.1/user-guide/set-up/synchronization/index.md)/[provisioning](/docs/identitymanager/6.1/user-guide/administrate/provisioning/index.md)
...
![Schemas' Key](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_key.webp)
...
![User Model](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_user.webp)
...
[keys](/docs/identitymanager/6.1/user-guide/set-up/connect-system/entity-type-creation/index.md)
...
[resource type](/docs/identitymanager/6.1/user-guide/set-up/categorization/index.md) per
account type and map each one to a
[role](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/index.md)
for assignment and
[provisioning](/docs/identitymanager/6.1/user-guide/administrate/provisioning/index.md).
...
![User Model - Canteen Badges Example](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_user-canteen.webp)
...
![User Model - Mailboxes Example](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_user-mailbox.webp)
...
![User-Group Model](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_usergroup.webp)
...
![User-Group Example - SAB](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_sab.webp)
...
![User-Group Example - RACF](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_racf.webp)
...
![User-Group Example - TSS](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_tss.webp)
...
**Roles:** During the
[creation of the role catalog](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/index.md)
...
[navigation rules](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/index.md)
...
![User-Group Example - SDGE](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_sdge.webp)
...
![Account-Profile-Transaction Model](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_profiletransaction.webp)
...
![Profiles Example](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_profiles.webp)
...
![User-Group Example - TSS](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_tss-prof-trans.webp)
...
![Star Model](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_star.webp)
...
![Star Model Example](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_starmodel.webp)
...
![AD Example - Step 1](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_ad-step1.webp)

**Step 3: define useful data close to your reality.**

We shape these objects with the following attributes:

![AD Example - Step 2](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_ad.webp)
...
>
> ![AD_Entry Example](/images/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_adentry.webp)
