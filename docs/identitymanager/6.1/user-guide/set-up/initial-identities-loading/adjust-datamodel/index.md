...
| Input                                                                                                                                                                                                                                                                                        | Output                        |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
| [Usercube's server](/docs/identitymanager/6.1/user-guide/set-up/development-environment-installation/index.md) (required) [Initial workforce repository](/docs/identitymanager/6.1/user-guide/set-up/initial-identities-loading/load-identities/index.md) (required) | Adjusted workforce repository |
...
2. On the **Workforce** > **Data Model** page, click on the following icon to adjust the data model
   to your specific situation.
    ...
    ![Scan Data Model](/images/identitymanager/6.1/user-guide/set-up/initial-identities-loading/adjust-datamodel/iconscandatamodel_v602.svg)

    ![Scan Data Model](/images/identitymanager/6.1/user-guide/set-up/initial-identities-loading/adjust-datamodel/initialload_scandatamodel_v60.webp)
    ...
    ![Scan Data Model - Result](/images/identitymanager/6.1/user-guide/set-up/initial-identities-loading/adjust-datamodel/initialload_scandatamodel-result_v523.webp)
...
3. Observe the result and adjust manually the data model if needed, by clicking on the properties.
    ...
    [Modifications can be performed](/docs/identitymanager/6.1/user-guide/optimize/identity-datamodel-modification/index.md)
...
1. Choose a test field and note its displaying mode.
    ...
    >
    > ![Scan Data Model - Example](/images/identitymanager/6.1/user-guide/set-up/initial-identities-loading/adjust-datamodel/initialload_scan-example_v523.webp)
...
2. Navigate within Usercube to find a workflow using the test field. Observe the displaying mode in
   the UI.
    ...
    >
    > ![Scan Data Model - Example](/images/identitymanager/6.1/user-guide/set-up/initial-identities-loading/adjust-datamodel/initialload_scan-example2_v523.webp)
    >
    > ![Scan Data Model - Example](/images/identitymanager/6.1/user-guide/set-up/initial-identities-loading/adjust-datamodel/initialload_scan-example3_v523.webp)
