...
[roles](/docs/identitymanager/6.1/integration-guide/role-model/index.md#roles) needed by
...
- assign roles to users, by
  [requesting them manually](/docs/identitymanager/6.1/user-guide/administrate/manual-assignment-request/index.md),
  or using
  [rules that assign roles automatically](/docs/identitymanager/6.1/user-guide/optimize/assignment-automation/automate-role-assignment/index.md)
...
[connector modeling](/docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/index.md).
...
- a role is part of a policy which is a subgroup of the role model.
  [Read more about the concept of role model](/docs/identitymanager/6.1/introduction-guide/overview/entitlement-management/index.md).
...
- roles need to be structured so
  [categories](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/category-creation/index.md)
  are created to:
...
[model established](/docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/index.md)
...
[manually](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/role-manual-creation/index.md),
...
| Input                                                                                                                                                                                                                                                                                                                                                                                            | Output              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------- |
| [Connector's data model](/docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/index.md) (required) [Provisioning Rules](/docs/identitymanager/6.1/user-guide/set-up/provisioning-rule-creation/index.md) (required) [Classification](/docs/identitymanager/6.1/user-guide/set-up/categorization/classification/index.md) (required) | Single role catalog |
...
2. Complete the role catalog if needed by creating manually additional
   [categories](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/category-creation/index.md)
   and
   [single roles with their navigation rules](/docs/identitymanager/6.1/user-guide/set-up/single-roles-catalog-creation/role-manual-creation/index.md).
3. Add
   [composite roles](/docs/identitymanager/6.1/user-guide/optimize/composite-role-creation/index.md)
...
[role officer management](/docs/identitymanager/6.1/user-guide/set-up/role-officer-management/index.md).

The role catalog is also a prerequisite for
[risk management](/docs/identitymanager/6.1/user-guide/optimize/risk-management/index.md).
