...
- `Open Telnet Connection`: opens the Telnet connection to the external system using the login and
  ...
  [Robot Framework](/docs/identitymanager/6.2/integration-guide/connectors/references-connectors/robotframework/index.md) attribute in
