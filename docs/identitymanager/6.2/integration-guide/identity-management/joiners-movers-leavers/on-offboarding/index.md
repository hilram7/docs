...
synchronization to the HR system.
...
Hence, Identity Manager knows all the past and present entitlements of any identity.
...
Between the start and end dates, the identity is part of all of Identity Manager's calculations
(role model, etc.).
