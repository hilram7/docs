...
[Remove Redundant Assignments](/docs/identitymanager/6.2/user-guide/optimize/assignment-automation/remove-redundant-assignments/index.md) after any assignment rule is
created or updated.
...
- Delay can happen: on the day a worker joins an organization, they rely on a manual action to get
  ...
  the[Create Roles in the Role Catalog](/docs/identitymanager/6.2/user-guide/set-up/single-roles-catalog-creation/index.md) topic
  ...
  [Perform Access Certification](/docs/identitymanager/6.2/user-guide/administrate/access-certification/index.md). See the
...
1. [Perform Role Mining](/docs/identitymanager/6.2/user-guide/optimize/assignment-automation/role-mining/index.md) to approach the automation wall.
...
2. [Generate Reports](/docs/identitymanager/6.2/user-guide/administrate/reporting/index.md)and analyze them with tools like Power
