...
See the [References: Permissions](/docs/identitymanager/saas/integration-guide/profiles-permissions/permissions/index.md) topic for
additional information.

Each permission can be configured in an
[Access Control Rule](/docs/identitymanager/saas/integration-guide/toolkit/xml-configuration/access-control/accesscontrolrule/index.md) so
