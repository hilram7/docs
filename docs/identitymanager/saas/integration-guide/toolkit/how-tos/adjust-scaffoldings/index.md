...
1.  When working via the UI, start by exporting UI
...
3.  Add `ConsolidationMode` to the element's properties.
    ...
    - Set to `Merge`, the XML item generated by the scaffolding is completed with additional parent
      ...
      child elements defined in the scaffolding.
        ...
        >       }
        >
        >       return result;" TargetEntityType="AzureAD_DirectoryObject" TargetExpression="C#:azure_ad:
...
4.  [ Usercube-Deploy Configuration](/docs/identitymanager/saas/integration-guide/executables/references/deploy-configuration/index.md)
    again.
