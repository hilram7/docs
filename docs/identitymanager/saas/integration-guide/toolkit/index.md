...
according the Usercube schema. The [Recommendations](/docs/identitymanager/saas/integration-guide/toolkit/recommendations/index.md) part of this
...
The[Usercube-Export-Configuration](/docs/identitymanager/saas/integration-guide/executables/references/export-configuration/index.md) can be
