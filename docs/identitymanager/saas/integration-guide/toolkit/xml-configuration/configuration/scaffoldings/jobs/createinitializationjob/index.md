...
description: "Create Initialization Job"
sidebar_position: 80
---
...
- PrincipalDataConnector (optional) — Specifies the connector that contains the data for the
  fulfillment of external systems.
