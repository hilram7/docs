...
- [Update Identity Data](/docs/identitymanager/saas/user-guide/maintain/identity-data-modification/index.md)
    ...
    - [Update an Individual Identity](/docs/identitymanager/saas/user-guide/maintain/identity-data-modification/individual-update/index.md)

        How to perform changes in data for a single identity, through the UI.

    - [Update Multiple Identities](/docs/identitymanager/saas/user-guide/maintain/identity-data-modification/multiple-update/index.md)
