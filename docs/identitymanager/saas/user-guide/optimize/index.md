...
- [Create an HR Connector](/docs/identitymanager/saas/user-guide/optimize/hr-connector-creation/index.md)
...
- [Manage Risks](/docs/identitymanager/saas/user-guide/optimize/risk-management/index.md)
...
- [Create a Policy](/docs/identitymanager/saas/user-guide/optimize/policy-creation/index.md)
...
- [Automate Assignments](/docs/identitymanager/saas/user-guide/optimize/assignment-automation/index.md)
...
- [Perform Role Mining](/docs/identitymanager/saas/user-guide/optimize/assignment-automation/role-mining/index.md)
...
- [Remove Redundant Assignments](/docs/identitymanager/saas/user-guide/optimize/assignment-automation/remove-redundant-assignments/index.md)
...
- [Configure a Parametrized Role](/docs/identitymanager/saas/user-guide/optimize/parameterized-role/index.md)

    How to reduce the number of roles in the model by configuring roles with parameters.

- [Perform a Simulation](/docs/identitymanager/saas/user-guide/optimize/simulation/index.md)
