...
**Step 3 –** Select Netwrix Password Policy Enforcer to uninstall the PPE console.

**Step 4 –** Click **Uninstall**.

**Step 5 –** Select Netwrix Password Policy Client to uninstall the credential provider for version
10.2.
