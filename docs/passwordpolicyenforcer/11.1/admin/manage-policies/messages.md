...
- [LIVE_POLICY] – Password Policy Client (10.2 and above) messages can be configured to display live
  ...
  example of a live policy message.
    ...
    ![Messages](/images/passwordpolicyenforcer/11.1/administration/mesages2.webp)
...
![Set up messages](/images/passwordpolicyenforcer/11.1/administration/messages.webp)
...
![Use macros for your message](/images/passwordpolicyenforcer/11.1/administration/messagesmacros.webp)
