...
![Manual configuration of notifications](/images/passwordsecure/9.1/configuration/advanced_view/clientmodule/notifications/notifications_5-en.webp)
...
- [System tasks](/docs/passwordsecure/9.1/configuration/advancedview/mainmenufc/extras/systemtasks/system_tasks.md)s:
...
![Ribbon functions notifications](/images/passwordsecure/9.1/configuration/advanced_view/clientmodule/notifications/notifications_6-en.webp)
