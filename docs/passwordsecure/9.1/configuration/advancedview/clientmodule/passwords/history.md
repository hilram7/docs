...
![quick view history](/images/passwordsecure/9.1/configuration/advanced_view/clientmodule/passwords/history_2-en.webp)
...
![history list view](/images/passwordsecure/9.1/configuration/advanced_view/clientmodule/passwords/history_4-en.webp)
...
![comparison of history versions](/images/passwordsecure/9.1/configuration/advanced_view/clientmodule/passwords/history_5-en.webp)

If deviations exist between the two versions, these will be highlighted in color.

![difference between password history](/images/passwordsecure/9.1/configuration/advanced_view/clientmodule/passwords/history_6-en.webp)
