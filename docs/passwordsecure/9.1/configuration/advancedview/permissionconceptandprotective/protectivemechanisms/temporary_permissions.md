...
you can specify a temporary release for each role. The start date as well as the end date is
selected here. You can start the configuration using the **Extras** area in the ribbon.

![temporary permission](/images/passwordsecure/9.1/configuration/advanced_view/permissionconcept/predefining_rights/protective_mechanisms/temporary_permissions/temporary_permissions-en.webp)
