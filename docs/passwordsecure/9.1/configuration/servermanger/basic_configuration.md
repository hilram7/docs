...
![Baseconfig](/images/passwordsecure/9.1/configuration/server_manager/baseconfiguration/installation_with_parameters_189-en.webp)
...
:::warning
The defined service user **needs local administrator** rights to properly configure the
