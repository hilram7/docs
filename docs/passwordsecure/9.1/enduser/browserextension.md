...
![downloadextension](/images/passwordsecure/9.1/enduser/downloadextension.webp)
...
![getextension](/images/passwordsecure/9.1/enduser/getextension.webp)

Step 3 – After confirming a security question, it is installed, and an icon appears in the menu bar
to "add the extension".

![addextension](/images/passwordsecure/9.1/enduser/addextension.webp)
...
![extensionadded](/images/passwordsecure/9.1/enduser/extensionadded.webp)
