...
![selectou](/images/passwordsecure/9.1/enduser/selectou.webp)

- Choose a permission template to define who else can see your password.

![permissionstemplate](/images/passwordsecure/9.1/enduser/permissionstemplate.webp)

- Set a description for your stored password.

![description](/images/passwordsecure/9.1/enduser/description.webp)

- Enter the username or email address needed for login.

![username](/images/passwordsecure/9.1/enduser/username.webp)
...
![websiteurl](/images/passwordsecure/9.1/enduser/websiteurl.webp)
