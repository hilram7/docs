...
[Client configuration](/docs/passwordsecure/9.1/installation/requirements/client_configuration.md)
...
![installation wizard page 3](/images/passwordsecure/9.1/installation/installation_client/installation-client-4-en_339x265.webp)

The last step closes the setup and opens (if desired) the Client.

![installation wizard page 4](/images/passwordsecure/9.1/installation/installation_client/installation-client-5-en.webp)

## Installed applications

There are always several applications installed.

![client icon](/images/passwordsecure/9.1/installation/installation_client/cllient-en.webp)

This is the regular Client.

![offline client icon](/images/passwordsecure/9.1/installation/installation_client/psrofflineclient-en.webp)

The Offline Add-on allows access to the data without connection to Server Manager.

![icon_autofill_agent](/images/passwordsecure/9.1/installation/installation_client/icon_autofill_agent.webp)
...
![profil-registry](/images/passwordsecure/9.1/installation/installation_client/profil-registry-en.webp)
