...
![bin_2](/images/passwordsecure/9.2/configuration/advanced_view/clientmodule/passwords/bin_2.webp)

You will then be asked if you actually want to perform this action.

![bin_3](/images/passwordsecure/9.2/configuration/advanced_view/clientmodule/passwords/bin_3.webp)
