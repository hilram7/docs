...
![light-client-en](/images/passwordsecure/9.2/configuration/basic_view/light-client-en.webp)
...
![image1](/images/passwordsecure/9.2/configuration/basic_view/image1.webp)
...
[To do for Administration](/docs/passwordsecure/9.2/configuration/basicview/todoforadministration/to_do_for_administration.md).
