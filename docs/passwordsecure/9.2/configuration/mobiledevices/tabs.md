...
![actions mobile app](/images/passwordsecure/9.2/configuration/mobiledevices/tabs/actions-ma-en.webp)
...
![manage tabs](/images/passwordsecure/9.2/configuration/mobiledevices/tabs/all-passwords-ma-2-en.webp)

By clicking on the plus sign there is a possibility to add more tabs.

![add tabs](/images/passwordsecure/9.2/configuration/mobiledevices/tabs/add-tabs-ma.webp)
