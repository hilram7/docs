...
[Main menu](/docs/passwordsecure/9.2/configuration/advancedview/mainmenufc/main_menu_fc.md) on the client. This area can be used
independently of the currently selected module.

- [General settings](/docs/passwordsecure/9.2/configuration/servermanger/databaseproperties/general_settings_admin_client.md)
