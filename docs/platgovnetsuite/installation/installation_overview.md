...
1. [Installing Strongpoint](/docs/platgovnetsuite/installation/installing_strongpoint.md)
...
5. [Setting Access to the Strongpoint Tab](/docs/platgovnetsuite/installation/setting_strongpoint_tab_access.md)
