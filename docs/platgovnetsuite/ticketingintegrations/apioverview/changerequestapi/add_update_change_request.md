---
title: "Add/Update Customizations in a Change Request"
description: "Add/Update Customizations in a Change Request"
sidebar_position: 20
---
...
a constant value, in this case **addCustomization**.
:::
...
**"Customizations / proposed customizations added successfully."**: Successfully added or updated
customizations and/or proposed customizations to the change request.

**"No change detected."**: Customizations/Proposed Customizations are already attached to the change
request(for duplicate additions/updates).
