...
description: "Change Request API"
sidebar_position: 20
---
...
- [Get Impact Analysis](/docs/platgovnetsuite/ticketingintegrations/apioverview/changerequestapi/get_impact_analysis.md): returns the impact analysis data for each
  ...
  _Inactive_.
- [Push Change Request](/docs/platgovnetsuite/ticketingintegrations/apioverview/changerequestapi/push_change_request.md): pushes the external ticket details and creates an
