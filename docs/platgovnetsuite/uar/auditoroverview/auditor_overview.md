...
- **Owner List** displays all reviews with an assigned owner. Option to view reviews with no
  ...
  Administrator's [Owner List](/docs/platgovnetsuite/uar/adminoverview/admin_owner_list.md).
- **Global Access Reviews History** is the **[User Access Reviews History](/docs/platgovnetsuite/uar/adminoverview/uar_history.md)**.
