...
records can be restricted by role or user using standard NetSuite and Salesforce access controls. In
addition, Platform Governance for Salesforce supports a secondary level of audience management for
specific processes or objects.

All Platform Governance for Salesforce documentation can be printed, rendered as flat HTML or
...
Salesforce greatly reduces the amount of time to find information and identify interdependencies,
