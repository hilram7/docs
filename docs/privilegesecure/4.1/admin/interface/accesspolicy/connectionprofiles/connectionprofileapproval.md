...
![addapprovalworkflow](/images/privilegesecure/4.1/accessmanagement/admin/policy/add/addapprovalworkflow.webp)

**Step 3 –** In the Approval Workflow section, select Tiered and click Save.

![Add approval teir to workflow](/images/privilegesecure/4.1/accessmanagement/admin/policy/add/addapprovalteirtoworkflow.webp)

**Step 4 –** Once the policy has been created, click the Add Tier icon to add an Approval Tier.

![Tier 1 Escalation Options](/images/privilegesecure/4.1/accessmanagement/admin/policy/add/tier1escalationoptions.webp)
...
![tierescalation](/images/privilegesecure/4.1/accessmanagement/admin/policy/add/tierescalation.webp)
...
![Tier 1 Escalation Example](/images/privilegesecure/4.1/accessmanagement/admin/policy/add/tier1escalationexample.webp)

**Step 8 –** Click the Add Approvers icon to open the Add Users and Groups as Approvers window.

![Add Users and Groups as Approvers](/images/privilegesecure/4.1/accessmanagement/admin/policy/add/addusersandgroupsasapprovers.webp)
...
![Tier 1 Example](/images/privilegesecure/4.1/accessmanagement/admin/policy/add/tier1example.webp)
