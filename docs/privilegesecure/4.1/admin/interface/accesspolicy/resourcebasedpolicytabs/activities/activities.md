...
![Activities Tab for Resource based Policies](/images/privilegesecure/4.1/accessmanagement/admin/policy/tab/policyresource/activitiestab.webp)
...
- Add — Opens the Add Activities and Activity Groups window. See the
  [Add Activities and Activity Groups Window](/docs/privilegesecure/4.1/admin/interface/accesspolicy/resourcebasedpolicytabs/activities/addactivitiesandactivitygroups.md)
