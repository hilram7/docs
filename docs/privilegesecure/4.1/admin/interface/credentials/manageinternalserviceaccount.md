...
![No matching user found](/images/privilegesecure/4.1/accessmanagement/admin/policy/window/credentials/matchinguserfalse.webp)
...
![Manually Managed Account](/images/privilegesecure/4.1/accessmanagement/admin/policy/window/credentials/credentialsmanuallymanageaccount.webp)
