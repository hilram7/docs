...
![Admin Policy Interface](/images/privilegesecure/4.1/accessmanagement/admin/policy/interface.webp)
...
- [Users & Groups Page](/docs/privilegesecure/4.1/admin/interface/usersgroups/usersgroups.md)
  — Add or modify users, groups, and applications
    ...
    - [User and Group Collections Page](/docs/privilegesecure/4.1/admin/interface/usersgroups/usergroupcollections.md)
...
- [Resources Page](/docs/privilegesecure/4.1/admin/interface/resources/resources.md)
  — Add or modify resources
    ...
    - [Resource Groups Page](/docs/privilegesecure/4.1/admin/interface/resources/resourcegroups/resourcegroups.md)
...
- [Credentials Page](/docs/privilegesecure/4.1/admin/interface/credentials/credentials.md)
  — Add or modify credentials
    ...
    - [Credential Groups Page](/docs/privilegesecure/4.1/admin/interface/credentials/credentialgroups/credentialgroups.md)
