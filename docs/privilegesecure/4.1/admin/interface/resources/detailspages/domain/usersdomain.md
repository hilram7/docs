...
![Domian Users Tab](/images/privilegesecure/4.1/accessmanagement/admin/policy/tab/resources/usersdomain.webp)
...
- Password Reset Options — Customize password rotation options. This option is only available for
  ...
  [Password Reset Options Window](/docs/privilegesecure/4.1/admin/interface/resources/passwordresetoptions.md)
