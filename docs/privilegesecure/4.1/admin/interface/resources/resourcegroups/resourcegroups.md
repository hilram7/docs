...
![Resource Groups Details Page](/images/privilegesecure/4.1/accessmanagement/admin/policy/page/resourcegroupspage.webp)
...
- Blue + button — Create a resource group. See the
  [Add a Resource Group](/docs/privilegesecure/4.1/admin/interface/resources/resourcegroups/resourcegroup.md)
...
- Add — Opens the Add Resources window. See the
  [Add Resources Window for Resource Group](/docs/privilegesecure/4.1/admin/interface/resources/resourcegroups/addresourcestogroup.md)
  topic for additional information.
