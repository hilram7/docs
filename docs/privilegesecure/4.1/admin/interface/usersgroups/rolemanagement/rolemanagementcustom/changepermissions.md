...
![Custome Role Edit Permissions](/images/privilegesecure/4.1/accessmanagement/admin/policy/edit/customroleeditpermissions.webp)
...
**Step 4 –** (Optional) From the right-hand menu, check the boxes of one or more permissions to
