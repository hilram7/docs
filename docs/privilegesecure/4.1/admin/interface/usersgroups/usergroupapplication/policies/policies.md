...
![Policies Tab for Application Users](/images/privilegesecure/4.1/accessmanagement/admin/policy/tab/usersgroups/userpoliciestab.webp)
...
- Add — Opens the Add Account to Policies window. See
  [Add Account to Policies Window](/docs/privilegesecure/4.1/admin/interface/usersgroups/usergroupapplication/policies/addaccounttopolicies.md)
