...
![Dashboard interface showing an expiration banner and pointint to the User Options menu with the About page](/images/privilegesecure/4.1/accessmanagement/admin/expirationbanner.webp)
...
![About page showing trial license details](/images/privilegesecure/4.1/accessmanagement/admin/triallicensedetails.webp)
...
![About page showing successful upload of a license](/images/privilegesecure/4.1/accessmanagement/admin/licenseimportsuccess.webp)
