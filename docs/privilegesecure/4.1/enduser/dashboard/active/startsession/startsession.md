...
![Connecto to remote session](/images/privilegesecure/4.1/accessmanagement/enduser/dashboard/remotesessionlaunch.webp)
...
See the
[Configure DirectConnect for Remote Desktop Connection](/docs/privilegesecure/4.1/enduser/dashboard/active/startsession/rdcmanager.md)
