...
![Contents of the NPS.zip file download](/images/privilegesecure/4.1/accessmanagement/install/npszip.webp)
...
- The Extras folder – Contains additional standalone installers:
    ...
    - Enablement Toolkit.exe – Installs a utility that offers a GUI for common testing scenarios
      ...
      [Troubleshooting](/docs/privilegesecure/4.1/admin/troubleshooting.md)
    ...
    - SbPostgreSQL12.exe – Installs the PostgreSQL v12 database. By default, this installer is run
...
[Netwrix Setup Launcher](/docs/privilegesecure/4.1/install/components/setuplauncher.md)
...
[Application Silent Installer Option](/docs/privilegesecure/4.1/install/components/silent.md)
topic for additional information.
