...
![Netwrix Setup Launcher showing the Prequisites Setup with a green checkmark](/images/privilegesecure/4.1/accessmanagement/install/launcherstep2.webp)
...
:::note
If PostgreSQL v12 is already installed, a green checkmark is displayed to the left of the
Install PostgreSQL 12 button and you can install the Privilege Secure application.
:::


![Stealthbits PostgreSQL v12 Setup Wizard on the Install page](/images/privilegesecure/4.1/accessmanagement/install/install.webp)

**Step 2 –** On the Install page, click **Install**.

![Stealthbits PostgreSQL v12 Setup Wizard on the License Agreement page](/images/privilegesecure/4.1/accessmanagement/install/licenseagreement.webp)
...
![Stealthbits PostgreSQL v12 Setup Wizard on the Install and Data Folder page](/images/privilegesecure/4.1/accessmanagement/install/installfolder.webp)
...
![Stealthbits PostgreSQL v12 Setup Wizard on the Completed Successfully page](/images/privilegesecure/4.1/accessmanagement/install/completed.webp)
...
![Netwrix Setup Launcher showing the PostgreSQL Setup with a green checkmark](/images/privilegesecure/4.1/accessmanagement/install/launcherstep3.webp)
...
![Netwrix Privilege Secure Setup wizard on the License Agreement page](/images/privilegesecure/4.1/accessmanagement/install/licenseagreement_1.webp)
...
![Netwrix Privilege Secure Setup wizard on the Setup Options page](/images/privilegesecure/4.1/accessmanagement/install/setupoptions.webp)
...
![Netwrix Privilege Secure Setup wizard on the Completed Successfully page](/images/privilegesecure/4.1/accessmanagement/install/completed_1.webp)
