...
observed, either from the [Active Dashboard](/docs/privilegesecure/4.2/admin/dashboard/active/active.md), or the
[Live Session Viewer Window](/docs/privilegesecure/4.2/admin/dashboard/active/liveviewer.md).
...
![Lock User Session](/images/privilegesecure/4.2/accessmanagement/admin/dashboard/window/locksession.webp)
