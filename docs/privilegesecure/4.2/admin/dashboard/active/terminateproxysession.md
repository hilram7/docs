...
description: "Terminate Proxy Session Window"
sidebar_position: 40
---
...
![Terminate Session window](/images/privilegesecure/4.2/accessmanagement/admin/dashboard/window/terminatesession.webp)
