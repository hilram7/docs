...
description: "Users Tab for Credential Based Access Policies"
sidebar_position: 10
---
...
![Credential based policy users tab](/images/privilegesecure/4.2/accessmanagement/admin/policy/tab/policycredentials/userstabcredentials.webp)
