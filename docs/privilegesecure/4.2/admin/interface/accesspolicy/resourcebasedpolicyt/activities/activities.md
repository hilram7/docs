...
![Activities Tab for Resource based Policies](/images/privilegesecure/4.2/accessmanagement/admin/policy/tab/policyresource/activitiestab.webp)
...
- Add — Opens the Add Activities and Activity Groups window. See the
  [Add Activities and Activity Groups Window](/docs/privilegesecure/4.2/admin/interface/accesspolicy/resourcebasedpolicyt/activities/addactivitiesandactivitygroups.md)
