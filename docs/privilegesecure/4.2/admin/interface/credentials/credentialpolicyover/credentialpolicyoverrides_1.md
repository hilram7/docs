...
![Adding a credential policy override](/images/privilegesecure/4.2/accessmanagement/admin/policy/add/addcredentialpolicyoverride.webp)
...
- Scheduled Change Policy — Select a previously added schedule policy from the drop-down list. How
  ...
  [Credentials Dashboard](/docs/privilegesecure/4.2/admin/dashboard/credentials.md) and
...
![cpopageaddcredentials](/images/privilegesecure/4.2/accessmanagement/admin/policy/add/cpopageaddcredentials.webp)
...
[Add Credentials to a Policy Override](/docs/privilegesecure/4.2/admin/interface/credentials/credentialgroups/addcredentials.md#add-credentials-to-a-policy-override)
topic for additional information.

![Add credential to Credential Policy Override Window](/images/privilegesecure/4.2/accessmanagement/admin/policy/add/addcredentialtocpowindow.webp)
