...
- Change Policy (credential rotation) — How often the password of a managed account is changed. See
  the [Credentials Dashboard](/docs/privilegesecure/4.2/admin/dashboard/credentials.md) topic for additional information on
  managed accounts.
...
- Green + button — Create a new schedule policy. See the
  [Add Schedule Policy](/docs/privilegesecure/4.2/admin/interface/platforms/schedulepolicies/schedulepolicy.md) topic for additional information.
