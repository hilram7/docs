...
![Add Resources window showing the Import from AD option](/images/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/addresourcesonboardad.webp)
...
![Add Resources window showing the Import from CSV option](/images/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/addresourcesonboardcsv.webp)
...
![Add Resources window showing the Add Manually option](/images/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/addresourcesonboardmanually.webp)
