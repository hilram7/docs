...
![Domain Resource Computers Tab](/images/privilegesecure/4.2/accessmanagement/admin/policy/tab/resources/computersdomain.webp)
...
- Add as NPS Managed Resource — Opens the Enroll Hosts in Management window to onboards the selected
  resource. See
  [Enroll Hosts in Management Window](/docs/privilegesecure/4.2/admin/interface/resources/detailspages/domain/computersdomain/enrollhostsinmanagement.md) for
