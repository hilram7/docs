...
![Access Policies Tab Azure AD](/images/privilegesecure/4.2/accessmanagement/admin/policy/tab/resources/accesspoliciesazuread.webp)
...
- Name — Displays the name of the policy. See the [Access Policy Page](/docs/privilegesecure/4.2/admin/interface/accesspolicy/accesspolicy.md)
