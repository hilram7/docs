...
![Sessions Tab Entra ID](/images/privilegesecure/4.2/accessmanagement/admin/policy/tab/resources/sessionsazuread.webp)
...
- Requested By — User who requested the session. See the
...
- Activity — Displays the name of the activity. See the [Activities Page](/docs/privilegesecure/4.2/admin/interface/activities/activities.md)
