...
[Users & Groups Page](/docs/privilegesecure/4.2/admin/interface/usersgroups/usersgroups.md), this window is used to onboard users. From other
interfaces, this window is used to select onboarded users.

![Add Users and Groups to the console](/images/privilegesecure/4.2/accessmanagement/admin/policy/window/usersgroups/addusersgroupstoconsole.webp)
