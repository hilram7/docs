...
description: "Add Activities and Groups Window"
sidebar_position: 30
---
...
Activities are created in the [Activities Page](/docs/privilegesecure/4.2/admin/interface/activities/activities.md).

![Add activities and activity groups window](/images/privilegesecure/4.2/accessmanagement/admin/policy/window/usersgroups/addactivitiesandactivitygroups.webp)
