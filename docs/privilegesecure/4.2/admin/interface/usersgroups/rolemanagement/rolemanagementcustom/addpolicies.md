...
description: "Add Policies Window"
sidebar_position: 20
---
...
the [ Policy Interface](/docs/privilegesecure/4.2/admin/interface/interface.md).

![Add Policies to a Custom Role Window](/images/privilegesecure/4.2/accessmanagement/admin/policy/window/usersgroups/addaccounttopolicies.webp)
