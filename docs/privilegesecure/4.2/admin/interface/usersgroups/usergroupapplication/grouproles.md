...
![Group Roles Tab for User Groups](/images/privilegesecure/4.2/accessmanagement/admin/policy/tab/usersgroups/usergroupsgrouproletab.webp)
...
- Role — List of available roles. See the [Role Management Page](/docs/privilegesecure/4.2/admin/interface/usersgroups/rolemanagement/rolemanagement.md) topic
