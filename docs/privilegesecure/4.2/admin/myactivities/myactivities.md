...
description: "Access > My Activities Page"
sidebar_position: 30
---
...
[Create My Activity Session](/docs/privilegesecure/4.2/admin/myactivities/createsession.md) topic for additional information.
