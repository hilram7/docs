...
![Browser Extension Start Web Session](/images/privilegesecure/4.2/accessmanagement/enduser/browserextension/browserextensionstartsession.webp)
...
**Step 3 –** A notification is displayed to indicate that the session has ended. Click the **Close
Tab** button on the page or close the tab manually.

![Browser Extension End Session Message](/images/privilegesecure/4.2/accessmanagement/enduser/browserextension/browserextensionendsession.webp)
...
Activity. See the
[Settings Tab for Browser Extension](interface.md#settings-tab-for-browser-extension) topic for
