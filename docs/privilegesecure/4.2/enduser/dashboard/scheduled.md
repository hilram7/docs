...
![Scheduled Dashboard](/images/privilegesecure/4.2/accessmanagement/enduser/dashboard/scheduleddashboarduser.webp)
...
- Create Session — Open the Activity Request window. See the
  [Create Activity Session](/docs/privilegesecure/4.2/enduser/dashboard/active/createsession.md) topic for additional information.
