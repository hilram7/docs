...
- Interfaces:
    ...
    - Access — Grants access to the My Activities page. Activities are be displayed as individual
      ...
      [My Activities Page](/docs/privilegesecure/4.2/remoteaccessgateway/enduser/myactivities/myactivities.md) topic for additional information.
    - Dashboard — View summaries of recent activity logs and user sessions. See the
      [Dashboard Interface](/docs/privilegesecure/4.2/remoteaccessgateway/enduser/dashboard/overview.md) topic for additional information.
