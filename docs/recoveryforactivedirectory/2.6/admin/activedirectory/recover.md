...
Directory. You can recover these deleted Active Directory objects from the Recycle Bin.

Click **Active Directory** in the left pane to open the [Active Directory Page](/docs/recoveryforactivedirectory/2.6/admin/activedirectory/overview.md). Select
