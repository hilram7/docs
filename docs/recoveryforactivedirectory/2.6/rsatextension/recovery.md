...
- You must register the RSAT Extension on the Recovery Application Server to add the Rollback and
  ...
  [Register/Unregister the RSAT Extension](/docs/recoveryforactivedirectory/2.6/install/configurationutility.md#registerunregister-the-rsat-extension)
  topic for additional information.
- At least one backup of the domain must be available in the Recovery for Active Directory Console.
  See the [Domains Page](/docs/recoveryforactivedirectory/2.6/admin/configuration/domain.md) topic for additional information.
