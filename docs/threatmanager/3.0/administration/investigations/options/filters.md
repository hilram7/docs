...
- Source – This menu provides a list of all integrations with the application. If there is only one
  ...
  [Netwrix Integrations Page](/docs/threatmanager/3.0/administration/configuration/integrations/netwrixintegrations.md) topic for
...
- Integrations (category group header in the menu):
    ...
    - Policy – The set of rules or configurations applied within the integration., which may require
      ...
      the [Netwrix Integrations Page](/docs/threatmanager/3.0/administration/configuration/integrations/netwrixintegrations.md) page
