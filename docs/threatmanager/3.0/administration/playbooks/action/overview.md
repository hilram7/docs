...
- [Active Directory Target Actions](/docs/threatmanager/3.0/administration/playbooks/action/activedirectory.md)
- [Entra ID Target Actions](/docs/threatmanager/3.0/administration/playbooks/action/entraid.md)
- [Local Host Target Actions](/docs/threatmanager/3.0/administration/playbooks/action/localhost.md)
- [Tag Threat Actions](/docs/threatmanager/3.0/administration/playbooks/action/tag.md)
