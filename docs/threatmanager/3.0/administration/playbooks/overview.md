...
[Preconfigured Actions](/docs/threatmanager/3.0/administration/configuration/threatresponse.md#preconfigured-actions) topic for
...
- Action Type – The type of action to take for the threat response. Select the desired action from
  ...
  action selected. See the [Action Configuration for Playbook Steps](/docs/threatmanager/3.0/administration/playbooks/action/overview.md) topic for
  additional information.
