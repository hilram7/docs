...
![Log Level Configuration Window](/images/threatprevention/7.4/admin/agents/window/loglevelconfiguration.webp)
...
![Get Agent Log icon](/images/threatprevention/7.4/admin/agents/window/getagentlog.webp)

**Step 1 –** Click **Agents** in the left pane to launch the Agents interface. Select a server/Agent
and click **Get Agent Log** .

![Save As window for Agent logs](/images/threatprevention/7.4/admin/agents/window/saveaswindow.webp)
...
![Enterprise Manager Log File Location](/images/threatprevention/7.4/admin/agents/window/emlogs.webp)
...
![Administration Console Log File Location](/images/threatprevention/7.4/admin/agents/window/consolelogs.webp)
