...
![Deploy Agents wizard – Set Options page: Agent Install Path box](/images/threatprevention/7.4/admin/agents/deploy/installpath.webp)
...
![Update Agent Settings > Set Options page](/images/threatprevention/7.4/admin/agents/deploy/updatesetoptions.webp)
