...
See the [Breached Password Analytic Data Grid](#breached-password-analytic-data-grid) topic for
...
![Breached Password Analytic Type - Settings tab](/images/threatprevention/7.4/admin/analytics/breachedpasswordsettings.webp)
...
![Breached Password Analytic Type - Policy tab](/images/threatprevention/7.4/admin/analytics/policytab.webp)
...
![Breached Password Analytic Type window](/images/threatprevention/7.4/admin/analytics/breachedpassword.webp)
