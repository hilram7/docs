...
See the [Golden Tickets Analytic Data Grid](#golden-tickets-analytic-data-grid) topic for
...
![Golden Ticket Analytic Type - Settings tab](/images/threatprevention/7.4/admin/analytics/goldenticketsettings.webp)
...
![Golden Ticket Analytic Type - Policy tab](/images/threatprevention/7.4/admin/analytics/policytab.webp)
...
![Golden Ticket Analytic Type  window](/images/threatprevention/7.4/admin/analytics/goldenticket.webp)
