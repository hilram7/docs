...
See the [Impersonation Logins Analytic Data Grid](#impersonation-logins-analytic-data-grid) topic
for information on event data collected per incident.
...
![Impersonation Logins Analytic Type - Settings tab](/images/threatprevention/7.4/admin/analytics/concurrentloginssettings.webp)
...
![Impersonation Logins Analytic Type - Policy tab](/images/threatprevention/7.4/admin/analytics/policytab.webp)
...
![Impersonation Logins Analytic Type window](/images/threatprevention/7.4/admin/analytics/impersonationlogins.webp)
