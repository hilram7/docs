...
See the [User Account Hacking Analytic Data Grid](#user-account-hacking-analytic-data-grid) topic
...
![User Account Hacking Analytic Type - Settings tab](/images/threatprevention/7.4/admin/analytics/accounthackingsettings.webp)
...
![User Account Hacking Analytic Type - Policy tab](/images/threatprevention/7.4/admin/analytics/policytab.webp)
...
![User Account Hacking Analytic Type window](/images/threatprevention/7.4/admin/analytics/useraccounthacking.webp)
