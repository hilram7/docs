...
![List of Collections window](/images/threatprevention/7.4/admin/configuration/collectionmanager/listofcollections.webp)
...
![Add New Collections window](/images/threatprevention/7.4/admin/configuration/collectionmanager/addnewcollection.webp)
...
![Select window](/images/threatprevention/7.4/admin/configuration/collectionmanager/selectadobjects.webp)
...
![Expand Groups option on the Add New Collection window](/images/threatprevention/7.4/admin/configuration/collectionmanager/expandgroups.webp)
...
![Edit Collection Window](/images/threatprevention/7.4/admin/configuration/collectionmanager/editcollection.webp)

**Step 2 –** You can modify the name, description, and items in the collection. See the
[Add New Collection Window](#add-new-collection-window) topic for additional information on these
settings.
...
![Confirm Removal window](/images/threatprevention/7.4/admin/configuration/collectionmanager/confirmremoval.webp)
...
![Collection Dependencies Window](/images/threatprevention/7.4/admin/configuration/collectionmanager/dependencies.webp)
