...
![Threat Prevention WinConsole Warning window](/images/threatprevention/7.4/admin/configuration/databasemaintenance/warning.webp)
...
![Database Maintenance window](/images/threatprevention/7.4/admin/configuration/databasemaintenance/databasemaintenance.webp)
...
the options. See the
[Enable Database Maintenance](/docs/threatprevention/7.4/admin/configuration/databasemaintenance/enable.md)
topic for additional information.

**Step 3 –** On the Schedule tab, set the frequency and time when the database maintenance job runs.
See the
[Schedule Database Maintenance](/docs/threatprevention/7.4/admin/configuration/databasemaintenance/schedule.md)
topic for additional information.
...
![Database Maintenance window - Event Type tab](/images/threatprevention/7.4/admin/configuration/databasemaintenance/eventtype.webp)
...
![Database Maintenance window - Analytics tab](/images/threatprevention/7.4/admin/configuration/databasemaintenance/analytics.webp)
...
![Database Maintenance window - Policy tab](/images/threatprevention/7.4/admin/configuration/databasemaintenance/policy.webp)
