...
![Netwrix Threat Manager Configuration window - Event Sink tab](/images/threatprevention/7.4/admin/configuration/threatmanagerconfiguration.webp)
...
**Step 5 –** The Policies area lists all the policies that have been created in Threat Prevention.
...
![Netwrix Threat Manager Configuration Window - Honey Tokem tab](/images/threatprevention/7.4/admin/configuration/honeytoken.webp)
...
![Netwrix Threat Manager Configuration Window - Forged PAC tab](/images/threatprevention/7.4/admin/configuration/forgedpac.webp)
