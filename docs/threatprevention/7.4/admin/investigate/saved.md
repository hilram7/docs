...
![Investigate Interface - Save a Filtered View](/images/threatprevention/7.4/admin/investigate/saveview.webp)
...
![Filter Set Name window](/images/threatprevention/7.4/admin/investigate/filtersetname.webp)

**Step 3 –** Type a name for this filtered view and click **OK**.

![Saved filter view in the navigation pane](/images/threatprevention/7.4/admin/investigate/savedview.webp)
