...
![Data Grid Functionality pointers](/images/threatprevention/7.4/admin/navigation/datagridfunctionality.webp)
...
![Customization Window](/images/threatprevention/7.4/admin/navigation/customization.webp)
...
![Sort Data function in the data grid](/images/threatprevention/7.4/admin/navigation/sortdatafunction.webp)
...
![Filter Data functions in a Data Grid](/images/threatprevention/7.4/admin/navigation/filterdata.webp)
...
![Filter Editor](/images/threatprevention/7.4/admin/navigation/filtereditor.webp)
...
![Window with filtration options](/images/threatprevention/7.4/admin/navigation/valuesfilter.webp)
...
![Search function for data grid](/images/threatprevention/7.4/admin/navigation/searchfunction.webp)
...
![Search Results](/images/threatprevention/7.4/admin/navigation/searchresults.webp)
...
![Export window](/images/threatprevention/7.4/admin/navigation/export.webp)
