...
![Agents node - Right-click Menu](/images/threatprevention/7.4/admin/navigation/agentsmenu.webp)
...
![Saved ‘Filtered Investigate’ Nodes - Right-click Menu](/images/threatprevention/7.4/admin/navigation/savedinvestigateviewnode.webp)
...
![Policies and Templates Nodes - Right-click Menu](/images/threatprevention/7.4/admin/navigation/policiestemplatesnodes.webp)
...
![Folder Node - Right-click Menu](/images/threatprevention/7.4/admin/navigation/foldermenu.webp)
...
![`<Policy Name>` and `<Template Name>` Nodes - Right-click Menu](/images/threatprevention/7.4/admin/navigation/individualpolicytemplatenode.webp)
...
![Tags Node - Right-click menu](/images/threatprevention/7.4/admin/navigation/tagsnode.webp)
...
![`<Template Name>` Node under Tags - Right-click menu](/images/threatprevention/7.4/admin/navigation/templatenodeundertags.webp)
...
![Displays the data grid right-click menu. ](/images/threatprevention/7.4/admin/navigation/headerrightclickmenu.webp)
...
| Column Chooser                                                  | Opens the [Customization Window](/docs/threatprevention/7.4/admin/navigation/datagrid.md#customization-window) where you can add and remove columns from the data grid |
...
| Filter Editor                                                   | Opens the Filter Editor window (see the [Filter Data](/docs/threatprevention/7.4/admin/navigation/datagrid.md#filter-data) topic)                                      |
| Show / Hide Find Panel                                          | Shows or hides the Find Panel, which is the search feature (see the [Search Data](/docs/threatprevention/7.4/admin/navigation/datagrid.md#search-data) topic)          |
