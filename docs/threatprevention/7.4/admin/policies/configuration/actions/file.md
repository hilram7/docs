...
![Policy > Actions tab > Add Actions window](/images/threatprevention/7.4/admin/policies/actions/addactionwindow.webp)
...
![Actions tab - File action created](/images/threatprevention/7.4/admin/policies/actions/fileaction.webp)
