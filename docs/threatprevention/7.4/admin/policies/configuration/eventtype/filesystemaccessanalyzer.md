...
![Policy window - File System Enterprise Auditor Event Type](/images/threatprevention/7.4/admin/policies/eventtype/filesystemaccessanalyzer.webp)
...
are also available for consumption by Netwrix Access Analyzer (formerly Enterprise Auditor) if the
File System Enterprise Auditor event type is used by the same policy.
...
![Policy window - File System Enterprise Auditor filter](/images/threatprevention/7.4/admin/policies/eventtype/filesystemaccessanalyzer_1.webp)
...
![Paths filter - Sub Folder checkbox](/images/threatprevention/7.4/admin/policies/eventtype/subfolder.webp)
...
![Policy window - File System Agents filter](/images/threatprevention/7.4/admin/policies/eventtype/filesystemagents.webp)
...
![Policy window - Processes and Configuration filter](/images/threatprevention/7.4/admin/policies/eventtype/processesandconfiguration.webp)
...
![Policy window - Perpetrators to Exclude filter](/images/threatprevention/7.4/admin/policies/eventtype/perpetratorstoexclude.webp)
