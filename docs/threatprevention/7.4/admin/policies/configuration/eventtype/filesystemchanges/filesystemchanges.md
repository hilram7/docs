...
![Policy window - File System Changes Event Type](/images/threatprevention/7.4/admin/policies/eventtype/filesystemchanges.webp)
...
![Policy window - File System filter for monitoring](/images/threatprevention/7.4/admin/policies/eventtype/filesystem.webp)
...
![Policy window - Paths filter](/images/threatprevention/7.4/admin/policies/eventtype/paths.webp)
...
![Policy window - Additional Agents filter](/images/threatprevention/7.4/admin/policies/eventtype/additionalagents.webp)
