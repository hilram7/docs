...
![Policy window - FSMO Role Monitoring Event Type](/images/threatprevention/7.4/admin/policies/eventtype/fsmorolemonitoring.webp)
...
![Policy window - FSMO Operations filter](/images/threatprevention/7.4/admin/policies/eventtype/fsmooperations.webp)
...
![Policy window - FSMO Roles filter](/images/threatprevention/7.4/admin/policies/eventtype/fsmoroles.webp)
