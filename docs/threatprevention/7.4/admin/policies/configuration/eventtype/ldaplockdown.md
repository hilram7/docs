...
![Policy window - LDAP Lockdown Event Type](/images/threatprevention/7.4/admin/policies/eventtype/ldaplockdown.webp)
...
![Policy window - LDAP Query filter](/images/threatprevention/7.4/admin/policies/eventtype/ldapquerylockdown.webp)
...
![Policy window - Hosts (from) filter](/images/threatprevention/7.4/admin/policies/eventtype/hostsfromlockdown.webp)
