...
![Policy window - LDAP Monitoring Event Type](/images/threatprevention/7.4/admin/policies/eventtype/ldapmonitoring.webp)
...
![New Policy - LDAP filter](/images/threatprevention/7.4/admin/policies/eventtype/ldap.webp)
...
- LDAP Search – Use the LDAP Search operation to search for and identify activity that does not
  ...
  - This option displays additional filters for Secure configurations and Search scopes. See the
    [LDAP Search Operations Use Case](/docs/threatprevention/7.4/admin/policies/configuration/eventtype/ldapmonitoring/ldapsearch.md)
...
- LDAP Ping – LDAP Ping is a Microsoft Active Directory specific Lightweight Directory Access
  ...
  - See the
    [LDAP Ping Operations Use Case](/docs/threatprevention/7.4/admin/policies/configuration/eventtype/ldapmonitoring/ldapping.md)
    topic for additional information.
...
![Policy window - LDAP Runtime filter](/images/threatprevention/7.4/admin/policies/eventtype/ldapruntime.webp)
...
![Policy window - LDAP Query filter](/images/threatprevention/7.4/admin/policies/eventtype/ldapquery.webp)
...
![Policy window - LDAP Result filter](/images/threatprevention/7.4/admin/policies/eventtype/queryresult.webp)
...
![Policcy window - LDAP Attributes filter](/images/threatprevention/7.4/admin/policies/eventtype/ldapattributes.webp)
