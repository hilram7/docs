...
![honeytoken](/images/threatprevention/7.4/admin/policies/eventtype/usecase/honeytoken.webp)
...
![ldapfiltercopiedtoclipboard](/images/threatprevention/7.4/admin/policies/eventtype/usecase/ldapfiltercopiedtoclipboard.webp)
...
![Netwrix Threat Manager for AD LDAP template – Event Type tab with LDAP Query filter](/images/threatprevention/7.4/admin/policies/eventtype/usecase/ldapmonitoringfortm.webp)
