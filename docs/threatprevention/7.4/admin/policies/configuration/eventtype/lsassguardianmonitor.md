...
![Policy window - LSASS Guardian – Monitor Event Type](/images/threatprevention/7.4/admin/policies/eventtype/lsassmonitor.webp)
...
![Processes Monitoring filter](/images/threatprevention/7.4/admin/policies/eventtype/processesmonitoring.webp)
