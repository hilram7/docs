...
![Policy window - Password Enforcement Event Type](/images/threatprevention/7.4/admin/policies/eventtype/passwordenforcement.webp)
...
![Policy window - AD Account filter](/images/threatprevention/7.4/admin/policies/eventtype/adaccount.webp)
...
- Containers – The Containers Add (+) button opens the
  ...
  All user objects in the selected organizational unit(s) are subject to the applied rule.
...
![Policy window - Password Rules filter](/images/threatprevention/7.4/admin/policies/eventtype/passwordrules.webp)
