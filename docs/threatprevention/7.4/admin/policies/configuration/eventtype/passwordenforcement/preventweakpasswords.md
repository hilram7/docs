...
- Download the latest copy of the HaveIBeenPwned dictionary file. See the
  [Download and Configure the Have I Been Pwnd Hash List](/docs/threatprevention/7.4/admin/configuration/epesettings.md#download-and-configure-the-have-i-been-pwnd-hash-list)
  topic for additional information.
- Determine whether you want to deploy the dictionary to each domain controller or keep it locally
  ...
  [Considerations When Deploying the HIBP Database](/docs/threatprevention/7.4/admin/configuration/epesettings.md#considerations-when-deploying-the-hibp-database)
  topic for additional information.
- Modify the global password rules to customize the password dictionary, word list dictionary and
  ...
  [Rules](/docs/threatprevention/7.4/admin/configuration/epesettings.md#rules)
  topic for additional information.

**Step 2 –** Create a new policy with the Password Enforcement Event Type.

![New Prevent Weak Passwords Policy - General tab](/images/threatprevention/7.4/admin/policies/eventtype/usecase/newblockepepolicy.webp)
...
- On the Event Type tab, click the **Add** (+) button and select Password Enforcement on the
  [Event Selection Window](/docs/threatprevention/7.4/admin/policies/configuration/eventtype/overview.md#event-selection-window).

![Policy - Event Type tab with the Password Enforcement event selected](/images/threatprevention/7.4/admin/policies/eventtype/usecase/passwordrulesblock.webp)
...
![Recent Events Tab for weak password prevent](/images/threatprevention/7.4/admin/policies/eventtype/usecase/recenteventsprevent.webp)

## View Events in Investigate Interface

![Investigate Interface](/images/threatprevention/7.4/admin/policies/eventtype/usecase/invesitgatenodeblock.webp)
