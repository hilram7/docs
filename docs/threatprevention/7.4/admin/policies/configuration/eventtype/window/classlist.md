...
classes are added to the filter from where you clicked the **Add** (+) button to open this window.

![Class List Window](/images/threatprevention/7.4/admin/policies/eventtype/window/classlist.webp)
