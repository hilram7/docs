...
![Policy - General tab](/images/threatprevention/7.4/admin/policies/generaltab.webp)
...
![Policy - General tab > History section](/images/threatprevention/7.4/admin/policies/history.webp)
...
![Schedule section in a policy set to Always Active](/images/threatprevention/7.4/admin/policies/schedule.webp)
