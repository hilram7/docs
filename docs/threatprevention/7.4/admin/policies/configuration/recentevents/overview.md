...
![Policy - Recent Events tab](/images/threatprevention/7.4/admin/policies/recentevents/recenteventstab.webp)
...
![Recent Events tab - Additional Information for an event](/images/threatprevention/7.4/admin/policies/recentevents/recenteventdetails.webp)
...
![Recent Events tab - Right-Click menu](/images/threatprevention/7.4/admin/policies/recentevents/rightclickmenu.webp)
