...
- Export selected policies’ configuration from the list on the
...
![Export Policies and Templates window](/images/threatprevention/7.4/admin/policies/export.webp)
