...
imported later. See the [Import Templates](#import-templates) topic for additional information. Once
the templates are imported, they are available through an organized folder structure.
...
![Import window](/images/threatprevention/7.4/admin/templates/import.webp)
