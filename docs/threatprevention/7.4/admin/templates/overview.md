...
![Templates Interface](/images/threatprevention/7.4/admin/templates/templates.webp)
...
- You can also drag a template into a folder under the Policies node. This would be a Copy action,
  ...
  [Use a Template to Create a Policy](/docs/threatprevention/7.4/admin/templates/createpolicy.md)
  topic for additional information.
...
![Templates interface - Right-Click Menu](/images/threatprevention/7.4/admin/templates/rightclickmenu.webp)
