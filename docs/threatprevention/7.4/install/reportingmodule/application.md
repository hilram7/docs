...
![Netwrix Threat Mannager Reporting Setup wizard on the Install page](/images/threatprevention/7.4/install/reportingmodule/install.webp)

**Step 2 –** Click **Install**.

![Netwrix Threat Mannager Reporting Setup wizard on the End User License Agreement page](/images/threatprevention/7.4/install/reportingmodule/eula.webp)

**Step 3 –** Read the End User License Agreement and select the I accept the license agreement
checkbox. Click **Next**.

![Netwrix Threat Mannager Reporting Setup wizard on the Install Folder page](/images/threatprevention/7.4/install/reportingmodule/folder_1.webp)
...
![Netwrix Threat Mannager Reporting Setup wizard on the Database page](/images/threatprevention/7.4/install/reportingmodule/database.webp)
...
![Warning message that the database does not exist, Create?](/images/threatprevention/7.4/install/reportingmodule/databasecreatemessage.webp)
...
![Netwrix Threat Mannager Reporting Setup wizard on the Database page showing Ready for installation message](/images/threatprevention/7.4/install/reportingmodule/databaseready.webp)
...
![Netwrix Threat Mannager Reporting Setup wizard on the Firewall Rules page](/images/threatprevention/7.4/install/reportingmodule/firewallrules.webp)
...
![Netwrix Threat Mannager Reporting Setup wizard on the Completed page](/images/threatprevention/7.4/install/reportingmodule/completed_1.webp)
...
![Netwrix Setup Launcher showingThreat Manager Reporting Setup completed](/images/threatprevention/7.4/install/reportingmodule/applicationcheck.webp)
