...
![Integrations interface on the Active Directory Sync page](/images/threatprevention/7.4/reportingmodule/configuration/integrations/page.webp)
...
![Add New Integration window with Active Directory Sync type selected](/images/threatprevention/7.4/reportingmodule/configuration/integrations/activedirectorysync.webp)
...
![Active Directory Sync details page for a specific domain](/images/threatprevention/7.4/reportingmodule/configuration/integrations/details.webp)
...
- Domain Configuration – Displays the sync policy settings entered for the selected domain. These
  ...
  [Domain Configuration Tab](#domain-configuration-tab) topic for additional information.
- Sync History – Displays the information on each synchronization event. See the
  [Sync History Tab](#sync-history-tab) topic for additional information.
...
![Active Directory Sync details page for a specific domain showing the Domain Configuration tab](/images/threatprevention/7.4/reportingmodule/configuration/integrations/domainconfigurationtab.webp)
...
![Active Directory Sync details page for a specific domain showing the Sync History tab](/images/threatprevention/7.4/reportingmodule/configuration/integrations/synchistorytab.webp)
