...
**Step 7 –** On the Integrations interface, click **Credential Profile** in the navigation pane to
...
**Step 9 –** Use the gear icon in the upper right corner of the console to open the Configuration
menu. Then select **Integrations** to open the Integrations interface.

**Step 10 –** On the Integrations interface, click **Credential Profile** in the navigation pane to
view a list of the already created Credential Profiles, if any.

**Step 11 –** Select a Credential Profile from the table or the navigation pane.
...
**Step 14 –** To modify the profile description, type in the bottom field.
