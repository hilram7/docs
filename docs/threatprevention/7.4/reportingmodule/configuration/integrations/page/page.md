...
![Integrations interface on the Authentication Provider page](/images/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/page.webp)
...
![Add New Integration window with Authentication Provider type selected](/images/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/authenticationprovider.webp)
...
![Integrations interface displaying the details for an Authentication Provider with the type drop-down menu open](/images/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/type.webp)

The following authentication provider types are supported; you can configure an authentication
provider for any of these:

- RADIUS – See the
  [RADIUS Authentication Provider](/docs/threatprevention/7.4/reportingmodule/configuration/integrations/page/radius.md)
  topic for additional information.
- OpenID – See the
  [OpenID Authentication Provider](/docs/threatprevention/7.4/reportingmodule/configuration/integrations/page/openid.md)
  topic for additional information.
- SAML – See the
