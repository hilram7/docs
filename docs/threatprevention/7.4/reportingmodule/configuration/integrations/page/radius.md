...
[Add an Authentication Provider](/docs/threatprevention/7.4/reportingmodule/configuration/integrations/page/page.md#add-an-authentication-provider)topic,
...
![Integrations interface displaying the details for a Radius authneication provider](/images/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/radius.webp)
...
![Configuration tab for a RADIUS authneication provider](/images/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/configurationradius.webp)
...
![Customization tab for a Radius authneication provider](/images/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/customizationtab.webp)
...
![UserGroups tab for an authneication provider](/images/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/usersgroupstab.webp)
