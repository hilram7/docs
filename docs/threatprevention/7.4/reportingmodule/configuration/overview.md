...
![Configuration menu](/images/threatprevention/7.4/reportingmodule/configuration/menu.webp)

It contains the following options:

- Integrations – Allows you to configure integrations with a variety of Netwrix products and
  third-party systems and applications. See the
  [Integrations Interface](/docs/threatprevention/7.4/reportingmodule/configuration/integrations/overview.md)
...
- System Health – Provides access to the Services page, displays the services associated with the
  ...
  [System Health Interface](/docs/threatprevention/7.4/reportingmodule/configuration/systemhealth.md)
  topic for additional information.
