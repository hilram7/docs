...
![Filters section of an investigation](/images/threatprevention/7.4/reportingmodule/investigations/options/filters.webp)
...
- Timeframe – This menu provides several timeframe options as well as a clock and a calendar for
  ...
  your report is blank, it is likely due to the timeframe setting. See the [Timeframe](#timeframe)
  topic for additional information.
- Attribute – This menu provides a list of attributes that are available on events in the data
  source. See the [Filter Attribute Menu](#filter-attribute-menu) topic for additional information.
- Operator – This menu controls how the rule is evaluated by specifying the comparison between the
  Attribute and the Filter value. Options vary based on the selected attribute. See the
  [Filter Operator Menu](#filter-operator-menu) topic for additional information.
...
![Investigations Interface showing the Timeframe drop-down menu](/images/threatprevention/7.4/reportingmodule/investigations/options/timeframe.webp)
...
![Attribute drop-down menu in the Filters section](/images/threatprevention/7.4/reportingmodule/investigations/options/attrributemenu.webp)
...
![Operator Menu in the investigations Filters section](/images/threatprevention/7.4/reportingmodule/investigations/options/operatormenu.webp)
...
![filtersimple](/images/threatprevention/7.4/reportingmodule/investigations/options/filtersimple.webp)
