...
A report generated by an investigation query displays the following information:

- Event Details – Provides a view of all events matching the criteria specified for the
  investigation. See the [Events Details Tab](#events-details-tab) topic for additional information.
- Events Over Time – Provides a bar graph and pie chart for events matching the criteria specified
  for the investigation. See the [Events Over Time Tab](#events-over-time-tab) topic for additional
  information.
...
![Events Detaisl section of an investigation report](/images/threatprevention/7.4/reportingmodule/investigations/eventdetails.webp)
...
![Events Over Time section of an Investigations report](/images/threatprevention/7.4/reportingmodule/investigations/eventsovertime.webp)
...
![Top Resources section of an Investigations report](/images/threatprevention/7.4/reportingmodule/investigations/topresources.webp)
...
Click the link to view perpetrator details. See the
[User Details Page](/docs/threatprevention/7.4/reportingmodule/investigations/reports/user.md)
topic for additional information.
