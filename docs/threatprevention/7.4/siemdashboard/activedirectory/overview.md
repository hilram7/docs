...
- Ensure that Threat Prevention has been configured to send events to Splunk. See the
  [SIEM Tab](/docs/threatprevention/7.4/admin/configuration/systemalerting/siem.md)topic
...
required on the
[SIEM Tab](/docs/threatprevention/7.4/admin/configuration/systemalerting/siem.md),
where you configure Threat Prevention to send data to Splunk.
