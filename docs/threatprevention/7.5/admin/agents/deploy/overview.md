...
![Deploy Agents wizard – Select Computers page](/images/threatprevention/7.5/admin/agents/deploy/selectcomputers.webp)
...
tabs on the window. See the [Select Computers Window](/docs/threatprevention/7.5/admin/agents/deploy/selectcomputers.md) topic for additional
...
prerequisite check for the Agent. See the [Prerequisites Check Window](/docs/threatprevention/7.5/admin/agents/deploy/prerequisitescheck.md) topic
...
[Right-Click Menu](/docs/threatprevention/7.5/admin/agents/overview.md#right-click-menu). The Select Computers window opens.
...
[Select Computers Window](/docs/threatprevention/7.5/admin/agents/deploy/selectcomputers.md) topic for additional information. Click **Next**.
