...
![Deploy Agents wizard – Select Computers page: Add from AD tab](/images/threatprevention/7.5/admin/agents/deploy/addfromad.webp)
...
![Deploy Agents wizard – Select Computers page: Add from File tab](/images/threatprevention/7.5/admin/agents/deploy/addfromfile.webp)
