...
![Bad User ID (by User) Analytic Type - Settings tab](/images/threatprevention/7.5/admin/analytics/baduseridsettings.webp)
...
additional attempt for the same bad user account will be added to the total number of attempts
...
![Bad User ID (by User) Analytic Type - Policy tab](/images/threatprevention/7.5/admin/analytics/policytab.webp)
...
![Bad User ID (by User) Analytic Type  window](/images/threatprevention/7.5/admin/analytics/baduseriduser.webp)
