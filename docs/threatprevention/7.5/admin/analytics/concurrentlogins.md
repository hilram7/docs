...
![Concurrent Logins Analytic Type - Settings tab](/images/threatprevention/7.5/admin/analytics/concurrentloginssettings.webp)
...
![Concurrent Logins Analytic Type - Policy tab](/images/threatprevention/7.5/admin/analytics/policytab.webp)
...
![Concurrent Logins Analytic Type window](/images/threatprevention/7.5/admin/analytics/concurrentlogins.webp)
