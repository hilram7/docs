...
![File System Attacks (by User) Analytic Type - Settings tab](/images/threatprevention/7.5/admin/analytics/filesystemattackssettings.webp)
...
![File System Attacks (by User) Analytic Type - Policy tab for Monitoring Only](/images/threatprevention/7.5/admin/analytics/policytabfsmonitoring.webp)
...
![File System Attacks (by User) Analytic Type - Policy tab for Monitoring and Lockdown](/images/threatprevention/7.5/admin/analytics/policytabfsmonitoringlockdown.webp)
...
![File System Attacks (by User) Analytic Type window](/images/threatprevention/7.5/admin/analytics/fsattacks.webp)
