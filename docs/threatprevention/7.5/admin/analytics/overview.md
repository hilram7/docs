...
![Analytics interface](/images/threatprevention/7.5/admin/analytics/analyticsinterface.webp)
...
![Analytics node](/images/threatprevention/7.5/admin/analytics/analyticslist.webp)
...
- [Brute Force Attacks Analytic Type](/docs/threatprevention/7.5/admin/analytics/bruteforceattacks.md) – Reports on failed attempts from a
...
- [User Account Hacking Analytic Type](/docs/threatprevention/7.5/admin/analytics/useraccounthacking.md) – Reports on multiple bad passwords
...
- [Concurrent Logins Analytic Type](/docs/threatprevention/7.5/admin/analytics/concurrentlogins.md) – Reports on logins from multiple locations
  within a specified time frame
- [Impersonation Logins Analytic Type](/docs/threatprevention/7.5/admin/analytics/impersonationlogins.md) – Reports on multiple authenticated
  accounts from a single system within a specified time frame
- [Golden Ticket Analytic Type](/docs/threatprevention/7.5/admin/analytics/goldenticket.md) – Reports on Kerberos tickets that exceed the
  specified maximum lifetimes for a user ticket or maximum lifetimes for a user ticket renewal
- [File System Attacks (by User) Analytic Type](/docs/threatprevention/7.5/admin/analytics/filesystemattacksuser.md) – Reports on significant
