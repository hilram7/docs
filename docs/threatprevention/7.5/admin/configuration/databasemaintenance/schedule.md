...
![Database Maintenance job in Microsoft SQL Server Management Studio](/images/threatprevention/7.5/admin/configuration/databasemaintenance/dbmaintenancejob.webp)
