...
![Event Filtering Configuration Window](/images/threatprevention/7.5/admin/configuration/eventfiltering.webp)
...
![Edit Collection window - For Machine Accounts](/images/threatprevention/7.5/admin/configuration/editcollectionmachineaccounts.webp)
...
![Edit Collection window - For Hosts](/images/threatprevention/7.5/admin/configuration/editcollectionhosts.webp)
...
![Edit Collection window - For Selected Accounts](/images/threatprevention/7.5/admin/configuration/editcollectionaccounts_1.webp)
...
[Alerts Interface](/docs/threatprevention/7.5/admin/alerts/overview.md). Email or SIEM alerts can be generated by selecting the
