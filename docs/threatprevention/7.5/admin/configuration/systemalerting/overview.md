...
- All Analytics incidents are displayed on the [Analytics Interface](/docs/threatprevention/7.5/admin/analytics/overview.md).
- All Policies events are displayed on the [Investigate Interface](/docs/threatprevention/7.5/admin/investigate/overview.md).
