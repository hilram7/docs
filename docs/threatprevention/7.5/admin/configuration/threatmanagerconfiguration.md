...
[Forged PAC Analytic Type](/docs/threatprevention/7.5/admin/analytics/forgedpac.md) topic for additional information.
...
![Netwrix Threat Manager Configuration Window - Forged PAC tab](/images/threatprevention/7.5/admin/configuration/forgedpac.webp)
