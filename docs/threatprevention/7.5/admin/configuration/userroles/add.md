...
![Add User button on the Users and Groups window](/images/threatprevention/7.5/admin/configuration/userroles/addbutton.webp)
...
![Select Users or Groups window](/images/threatprevention/7.5/admin/configuration/userroles/selectusersorgroups.webp)
