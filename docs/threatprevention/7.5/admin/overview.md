...
![Threat Prevention Architecture Diagram](/images/threatprevention/7.5/admin/systemdiagram.webp)
...
every server being monitored. See the [Agent Information](/docs/threatprevention/7.5/install/agent/overview.md) topic for
information on where to deploy Agents and supported platforms. See the
[Agents Interface](/docs/threatprevention/7.5/admin/agents/overview.md) section for deployment procedures.
...
downloaded or emailed. See the [Reporting Module](/docs/threatprevention/7.5/reportingmodule/overview.md) topic for
...
[Analytics Interface](/docs/threatprevention/7.5/admin/analytics/overview.md) topic for additional information.
...
[Policy Configuration](/docs/threatprevention/7.5/admin/policies/configuration/configuration.md) topic for additional information.
...
See the [Pre-Created Templates](/docs/threatprevention/7.5/admin/templates/folder/overview.md) and
[Template Configuration](/docs/threatprevention/7.5/admin/templates/configuration/configuration.md) topics for additional information.
...
Manager. See the [Application Server Install](/docs/threatprevention/7.5/install/application.md) topic for additional
information.
