...
![Policy > Actions tab > Add Actions window for .Net Script](/images/threatprevention/7.5/admin/policies/actions/addactionwindowfornetscript.webp)
...
![Script Editor for .Net Scripts](/images/threatprevention/7.5/admin/policies/actions/scripteditorfornet.webp)
...
![Actions tab - .Net Script Action Created](/images/threatprevention/7.5/admin/policies/actions/netscriptaction.webp)
...
![Tools Menu in the Script Editor](/images/threatprevention/7.5/admin/policies/actions/toolsmenu.webp)
