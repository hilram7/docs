...
![addactionwindowforpowershell](/images/threatprevention/7.5/admin/policies/actions/addactionwindowforpowershell.webp)
...
[Threat Prevention Script Editor Tools](/docs/threatprevention/7.5/admin/policies/configuration/actions/netscript.md#threat-prevention-script-editor-tools) topic
