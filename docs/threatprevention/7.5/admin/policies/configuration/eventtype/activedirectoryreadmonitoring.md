...
![Policy window - Active Directory Read Monitoring Event Type](/images/threatprevention/7.5/admin/policies/eventtype/adreadmonitoring.webp)
...
![Policy window - AD Attributes Monitoring filter](/images/threatprevention/7.5/admin/policies/eventtype/adattributesmonitor.webp)
