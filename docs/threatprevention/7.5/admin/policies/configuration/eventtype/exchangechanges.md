...
![Policy window - Exchange Changes Event Type](/images/threatprevention/7.5/admin/policies/eventtype/exchangechanges.webp)
...
![Policy window - Exchange Event filter for monitoring](/images/threatprevention/7.5/admin/policies/eventtype/exchangeevent.webp)
...
- The **Add** (+) button opens the
  [Select Exchange Objects from Active Directory Window](/docs/threatprevention/7.5/admin/policies/configuration/eventtype/window/exchangeobjects.md).
...
![Policy window - Exchange Trustees filter](/images/threatprevention/7.5/admin/policies/eventtype/exchangetrustees.webp)
...
- The Trustees **Add** (+) button opens the
  [Select Active Directory Trustees Window](/docs/threatprevention/7.5/admin/policies/configuration/eventtype/window/trustees.md).
- The Collection button opens the
  [List of Collections Window](/docs/threatprevention/7.5/admin/configuration/collectionmanager/listcollections.md) to the
  appropriate Collection category.
- The Remove (x) button deletes the selected item(s) from that box.
