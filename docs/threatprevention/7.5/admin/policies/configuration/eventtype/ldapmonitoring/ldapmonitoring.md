...
![Policy window - LDAP Monitoring Event Type](/images/threatprevention/7.5/admin/policies/eventtype/ldapmonitoring.webp)
...
![Policy window - LDAP Runtime filter](/images/threatprevention/7.5/admin/policies/eventtype/ldapruntime.webp)
