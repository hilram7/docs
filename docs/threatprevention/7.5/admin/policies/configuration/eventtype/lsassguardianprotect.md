...
![Policy window - LSASS Guardian – Protect Event Type](/images/threatprevention/7.5/admin/policies/eventtype/lsassprotect.webp)
...
![Policy window - Processes filter](/images/threatprevention/7.5/admin/policies/eventtype/processesprotect.webp)
