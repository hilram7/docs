...
:::note
See the [Prevent Weak Passwords Use Case](/docs/threatprevention/7.5/admin/policies/configuration/eventtype/passwordenforcement/preventweakpasswords.md) topic for instructions
...
- Determine whether you want to deploy the dictionary to each domain controller or keep it locally
  ...
  [Considerations When Deploying the HIBP Database](/docs/threatprevention/7.5/admin/configuration/epesettings.md#considerations-when-deploying-the-hibp-database)
  topic for additional information.
- Modify the global password rules to customize the password dictionary, word list dictionary and
  character substitution map. See the [Rules](/docs/threatprevention/7.5/admin/configuration/epesettings.md#rules) topic for
...
![Recent Events Tab for weak password monitoring](/images/threatprevention/7.5/admin/policies/eventtype/usecase/recenteventsmonitor.webp)

On the Recent Events tab of the policy, set the Show options as desired and click the Refresh button
to view monitored events. See the [Recent Events Tab](/docs/threatprevention/7.5/admin/policies/configuration/recentevents/overview.md) topic for
additional information.

## View Events in Investigate Interface

![Investigate Interface](/images/threatprevention/7.5/admin/policies/eventtype/usecase/invesitgatenodemonitor.webp)
...
[Investigate Interface](/docs/threatprevention/7.5/admin/investigate/overview.md) topic for additional information.
...
See the [Investigations Interface](/docs/threatprevention/7.5/reportingmodule/investigations/overview.md) topic for
additional information.
