...
Refresh button to view blocked events. See the [Recent Events Tab](/docs/threatprevention/7.5/admin/policies/configuration/recentevents/overview.md)
topic for additional information.

![Recent Events Tab for weak password prevent](/images/threatprevention/7.5/admin/policies/eventtype/usecase/recenteventsprevent.webp)

## View Events in Investigate Interface

![Investigate Interface](/images/threatprevention/7.5/admin/policies/eventtype/usecase/invesitgatenodeblock.webp)
