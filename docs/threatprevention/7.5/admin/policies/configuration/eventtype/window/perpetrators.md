...
description: "Select Active Directory Perpetrators Window"
sidebar_position: 70
---
...
![Select Active Directory Perpetrators Window](/images/threatprevention/7.5/admin/policies/eventtype/window/adperpetrators.webp)
