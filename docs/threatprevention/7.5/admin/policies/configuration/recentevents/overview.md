...
![Policy - Recent Events tab](/images/threatprevention/7.5/admin/policies/recentevents/recenteventstab.webp)
...
- Export Data– Opens the Export Data window with export actions and options. See the
  [Export Data](/docs/threatprevention/7.5/admin/navigation/datagrid.md#export-data) topic for additional information.
...
See the [Event Tracker Window](/docs/threatprevention/7.5/admin/policies/configuration/recentevents/eventtracker.md) topic for additional information.
...
![Recent Events tab - Additional Information for an event](/images/threatprevention/7.5/admin/policies/recentevents/recenteventdetails.webp)
