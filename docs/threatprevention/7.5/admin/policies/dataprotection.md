...
![Select User window](/images/threatprevention/7.5/admin/policies/selectuser.webp)
...
[Users and Roles Window](/docs/threatprevention/7.5/admin/configuration/userroles/overview.md) are available in the list.
:::
