...
- Export selected policies’ configuration from the list on the [Policies Interface](/docs/threatprevention/7.5/admin/policies/overview.md)
...
**Step 1 –** When you click the Policies node or the Templates node in the Navigation pane, the
Policies interface or the Templates interface opens respectively.
...
![Export Policies and Templates window](/images/threatprevention/7.5/admin/policies/export.webp)
