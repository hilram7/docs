...
[Data Protection](/docs/threatprevention/7.5/admin/policies/dataprotection.md) topic for additional information.
...
- Templates can also be dragged from a template folder and dropped into a policy folder, which
  copies the template into a policy. See the [Templates Interface](/docs/threatprevention/7.5/admin/templates/overview.md) topic
