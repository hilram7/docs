...
![Template – General Tab](/images/threatprevention/7.5/admin/templates/generaltab.webp)
...
displayed for a template in the list on the [Templates Interface](/docs/threatprevention/7.5/admin/templates/overview.md).
...
the [Tags Node](/docs/threatprevention/7.5/admin/tags.md) topic for additional information.
