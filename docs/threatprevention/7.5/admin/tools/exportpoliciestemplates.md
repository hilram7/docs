...
- If opened via the keyboard shortcut (Alt+X) on the [Policies Interface](/docs/threatprevention/7.5/admin/policies/overview.md)
  or [Templates Interface](/docs/threatprevention/7.5/admin/templates/overview.md), it exports only what is within the selection.
- To export only a single policy or template, use the Export option on the right-click menu. See the
  [Export Policies and Templates Window](/docs/threatprevention/7.5/admin/policies/exportpoliciestemplates.md) topic for
  additional information.

![Export Policies and Templates Window](/images/threatprevention/7.5/admin/tools/exportpoliciestemplates.webp)
...
- Event Consumers and Alerts
  ...
  - Export Only Event Consumers and Alerts Used in Policies and Templates – Exports only event
    ...
    [Actions Tab](/docs/threatprevention/7.5/admin/policies/configuration/actions/overview.md) of enabled policies
- Options:
