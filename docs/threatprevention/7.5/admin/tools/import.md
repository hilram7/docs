...
[Export Policies and Templates Window](/docs/threatprevention/7.5/admin/tools/exportpoliciestemplates.md) topic for additional information
on export.
...
![Import Window](/images/threatprevention/7.5/admin/tools/import.webp)
