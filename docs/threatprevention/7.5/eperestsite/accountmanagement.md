...
![GET api/account/users](/images/threatprevention/7.5/eperestsite/users.webp)
...
![POST api/account/create](/images/threatprevention/7.5/eperestsite/create.webp)
...
![GET api/account/user/userId](/images/threatprevention/7.5/eperestsite/userid.webp)
...
![GET api/account/user/userName](/images/threatprevention/7.5/eperestsite/username.webp)
...
![DELETE api/account/delete?userName=username](/images/threatprevention/7.5/eperestsite/delete.webp)
