...
[Agent Information](/docs/threatprevention/7.5/install/agent/overview.md) topic for specifics on where to deploy.
...
See the [Agents Interface](/docs/threatprevention/7.5/admin/agents/overview.md) topic and the
[Deploy Agents](/docs/threatprevention/7.5/admin/agents/deploy/overview.md) topic for additional information to deploy
the Agent through the Administration Console.
...
the
[Enrollment Secret Configuration Window](/docs/threatprevention/7.5/admin/agents/agents-windows/enrollmentsecretconfiguration.md)
...
![Threat Prevention Windows Agent Setup wizard - End-User License Agreement page](/images/threatprevention/7.5/install/agent/license.webp)
...
![Threat Prevention Windows Agent Setup wizard - Enterprise Manager Location Information page](/images/threatprevention/7.5/install/agent/enterprisemanager.webp)
...
- In the **Address or Path** box, enter the following:
  ...
  :::note
  As a requirement for using custom managed certificates, you must provide the
...
![StealthINTERCEPT Windows Agent Setup wizard on the Certificates page](/images/threatprevention/7.5/install/agent/certificates.webp)
...
![Threat Prevention Windows Agent Setup wizard - Select Event Sources page](/images/threatprevention/7.5/install/agent/eventsources.webp)
...
[Create Custom Managed Certificates for Each Agent](/docs/threatprevention/7.5/install/agent/manual/customcert.md) topic for additional information.
