...
![Netwrix Threat Mannager Reporting Setup wizard on the End User License Agreement page](/images/threatprevention/7.5/install/reportingmodule/eula.webp)

**Step 3 –** Read the End User License Agreement and select the I accept the license agreement
checkbox. Click **Next**.

![Netwrix Threat Mannager Reporting Setup wizard on the Install Folder page](/images/threatprevention/7.5/install/reportingmodule/folder_1.webp)
...
![Netwrix Threat Mannager Reporting Setup wizard on the Database page](/images/threatprevention/7.5/install/reportingmodule/database.webp)
...
![Netwrix Setup Launcher showingThreat Manager Reporting Setup completed](/images/threatprevention/7.5/install/reportingmodule/applicationcheck.webp)
...
- [Secure the Reporting Module Console](/docs/threatprevention/7.5/install/reportingmodule/secure.md)
