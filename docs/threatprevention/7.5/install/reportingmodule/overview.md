...
- Click PostgreSQL Setup to install the database. See the
  [Install the PostgreSQL Database Application](/docs/threatprevention/7.5/install/reportingmodule/database.md) topic for additional information.
...
**Step 2 –** Log into the console for the first time. See the [First Launch](/docs/threatprevention/7.5/install/reportingmodule/firstlaunch.md) topic
