...
![Integrations interface displaying the details for a Radius authneication provider](/images/threatprevention/7.5/reportingmodule/configuration/integrations/authenticationprovider/radius.webp)
