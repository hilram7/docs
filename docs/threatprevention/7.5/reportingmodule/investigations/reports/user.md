...
Details and Top Resources sections (see the [Investigation Reports](/docs/threatprevention/7.5/reportingmodule/investigations/reports/reports.md) topic). Click a link
to land on the User Details page.

![userdetails](/images/threatprevention/7.5/reportingmodule/investigations/userdetails.webp)
