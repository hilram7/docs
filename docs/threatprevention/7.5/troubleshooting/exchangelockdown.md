...
![Delegates window](/images/threatprevention/7.5/troubleshooting/delegates.webp)
...
![warning](/images/threatprevention/7.5/troubleshooting/warning.webp)

The Active Directory Lockdown policy will block the Send on Behalf of permission changes.

![Inbox Properties window](/images/threatprevention/7.5/troubleshooting/inboxproperties.webp)

A message will appear as follows:

![permissionnotsaved](/images/threatprevention/7.5/troubleshooting/permissionnotsaved.webp)
